...
session_start();
	...
	if($_REQUEST['Complaint_no'])
	{
	    ...
	    {
	        $sql="select * from grievance_status_mst  where grievance_status_id  IN('12') order by grievance_status_id ASC";
	    }
	    else
	    {
	        $sql="select * from grievance_status_mst  where grievance_status_id NOT IN('1','9','2','12','11','13') order by grievance_status_id ASC";
	    }

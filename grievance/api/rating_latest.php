<?php
	...
	if($_REQUEST['generic_id'] !='' && $_REQUEST['ulbid'] !='' && $_REQUEST['imei_no'] !='' && $_REQUEST['rating_no'] !='0')
	{
    	...
    	if($rs=mysqli_query($conn,$sql))
    	{
    			    ...
    			    $ch = curl_init();
                                                    ...
                                                    $arr=json_decode($output,true);
                                                     if($arr['http_code']=='201')
                                                        ...
                                                        $data = array('status_code'=>'200','message'=>'Rating updated successfully');
    		...
    		$data = array('status_code'=>'100','message'=>'Error: Please try again');
	}
	else
	{
	    $data = array('status_code'=>'100','message'=>'Rating is required');
	}

         ...
         {*/
			...
			if (mysqli_query($conn, $sql)) {
				...
				if (mysqli_num_rows($rs1) > 0) {
					...
					$sql2 = "insert into grievances_transactions(grievance_id,transaction_id,emp_id,alloted_date,disposal_status,dept_id) values(" . $grievance_id_sel . ",1,'" . $row1['emp_id'] . "',now(),2,'" . $row1['dept_id'] . "')";

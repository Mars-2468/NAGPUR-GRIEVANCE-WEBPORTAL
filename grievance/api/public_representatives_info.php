...
error_reporting(0);
	...
	$sql="select name,designation,mobile,party,img_url,name_marathi,designation_marathi from council_mst where cid='2' and ulbid='".$_REQUEST['ulbid']."' and mobile='".$_REQUEST['mobile']."'";

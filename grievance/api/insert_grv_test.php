<?php
  ...
  $sql ="select grievance_id from grievances where 
	...
	values('1','".mysqli_real_escape_string($conn,$_POST['person_name'])."','-','".mysqli_real_escape_string($conn,$_POST['hno'])."',
	...
	//	$sql1="SELECT ward_id,cs_id,emp_id  FROM emp_map WHERE ward_id ='".$_POST['ward_id']."'  and cs_id ='".$_POST['cat3_id']."' and cs_type_id='1' and ulbid='".$_REQUEST['ulbid']."' and street_id='".$_POST['street_id']."'";
		...
		$sql2="insert into grievances_transactions(grievance_id,transaction_id,emp_id,alloted_date,disposal_status,dept_id) values(".$grievance_id_sel.",1,".$row1['emp_id'].",'".$today."',2,'".$row1['dept_id']."')";
			...
			if($swatchta_app_status_yn=='1')
				...
				$sms="Dear ".$emp_name_list[$row1['emp_id']].", A Grievance from ".$_POST['person_name']." (".$_POST['mobile']."),".$_POST['address']." regarding ".$_POST['comp_subject']." with Ref No : ".$grievance_id_sel." was alloted to you on ".$today." Regards - Grievance Monitoring Cell , ".$ulb_info['ulb_name'];
				 $mobile=$emp_mobile_list[$row1['emp_id']];
				
				
				
				$sms1="Dear ".$_POST['person_name'].", Your Grievance  regarding ".$_POST['comp_desc']." with Ref No : ".$grievance_id_sel." was alloted to ".$emp_name_list[$row1['emp_id']]." (".$mobile.") on ".$today." Regards - Grievance Monitoring Cell ".$ulb_info['ulb_name'];
			...
			else
			{
				...
				$sms2="Dear ".$_POST['person_name'].", Thank you for using online Grievance Redressal system. Your Complaint has been successfully registered with reference number : ".$grievance_id.". Regards - ".$ulb_info['ulb_name'];

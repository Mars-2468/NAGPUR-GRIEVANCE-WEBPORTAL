...
error_reporting(0);
	...
	cm.cat_id=c.cat_id and g.grievance_status_id=gsm.grievance_status_id and mobile like '".$_REQUEST['imei']."' and  g.ulbid='".$_REQUEST['ulbid']."' and g.grievance_status_id IN('3','8','9') and 

...
ini_set('display_errors',0);
	...
	if(mysqli_num_rows($rs)>0)
	{
    	...
    	if($row['ward_id']!="")
    	{
    	        ...
    	        $data11 =array('ward_id'=>$row['id']."-".$row['ward_id'],'ward_desc'=>$level1);
	...
	if($row['ward_id']!="")
	{
	        ...
	        $data22=array('ward_id'=>$row['id']."-".$row['ward_id'],'ward_desc'=>$level2);
	...
	if($rs)
	{
		...
		if(mysqli_num_rows($rs) > 0)
		{
            ...
            $response['data'] = array();
             ...
             array_push($response['data'],$data11);
             
             array_push($response['data'],$data22);

...
if (isset($_SESSION['uid'])) {
	...
	if ($_REQUEST['aptid'] == 1 && $_REQUEST['user_type'] == 'U') {
		...
		//05-06-24 if ($_REQUEST['status'] == 300) {
		//echo $date;
		/*if ($_REQUEST['status'] == 111 && $_REQUEST['sla'] == 0) {
			...
			app_type_id='1' and g.ulbid='" . $_SESSION['ulbid'] . "' and gt.is_escalated='1'";
			...
			gt.disposal_status=gsm.grievance_status_id and app_type_id='" . $_REQUEST['app_type_id'] . "' and g.ulbid='" . $_SESSION['ulbid'] . "' and gt.is_escalated='1'";
			...
			g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and g.ulbid='" . $_SESSION['ulbid'] . "' and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) and gt.disposal_status=9 ";
		...
		if ($_REQUEST['status'] == 111 && $_REQUEST['sla'] == 0) {
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				...
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and g.ulbid='" . $_SESSION['ulbid'] . "' and cat3_id !='0' and gt.disposal_status !=5 AND YEAR(date_regd) = '" . $selectedYear . "'";
				...
				//g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.mcat3_id = ss.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and DATE(ts) = '".$date."' and g.ulbid='" . $_SESSION['ulbid'] . "' and cat3_id !='0' and gt.disposal_status !=5 ";

				//$esca_sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and DATE(ts) = '".$date."' and g.ulbid='" . $_SESSION['ulbid'] . "' and cat3_id !='0'";
				...
				//and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and DATE(ts) = '".$date."' and g.ulbid='" . $_SESSION['ulbid'] . "' and g.ward_id=w.ward_id and g.street_id=s.street_id and gt.disposal_status !=5 and cat3_id !='0' ";

				//$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id, DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added  AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and
				//app_type_id='1' and g.ulbid='" . $_SESSION['ulbid'] . "' and DATE(ts) = '".$date."'";

				//$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id, DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added  AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss FROM grievances WHERE DATE(date_regd) = '".$date."' AND g.grievance_id=gt.grievance_id and app_type_id = '1' AND cat3_id != '0'";

				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where DATE(date_regd) = '" . $date . "' and g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and g.ulbid='" . $_SESSION['ulbid'] . "' and cat3_id !='0' and gt.disposal_status !=5 ";

				//$esca_sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and g.ulbid='" . $_SESSION['ulbid'] . "' and cat3_id !='0'";
				...
				//$sql = "SELECT * FROM grievances WHERE DATE(ts) = '".$date."' AND app_type_id = '1' AND cat3_id != '0'"; 
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				...
				//$query = "SELECT COUNT(DISTINCT grievance_id) AS num FROM grievances WHERE DATE(date_regd) = '".$date."' AND app_type_id = '1' AND cat3_id != '0'";
			}
		...
		g.cat3_id=ccm.cs_id and gt.emp_id=e.emp_id and app_type_id='1' and g.grievance_status_id IN('3','8','9') and sla_status=1 and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) ";
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				...
				$sql = "SELECT g.*,gt.emp_id,disposed_date,holidays_added as no_holidays, DATE_ADD(date_regd, INTERVAL ccm.cutt_off_time+holidays_added  DAY) as comp_date,ccm.cutt_off_time+holidays_added as target_days,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed FROM grievances g,grievances_transactions gt,comp_cutofdays_map ccm where g.grievance_id=gt.grievance_id and g.ulbid='" . $_SESSION['ulbid'] . "' and 
				...
				INTERVAL ccm.cutt_off_time+holidays_added DAY) as ComplaintToBeResolvedDate ,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS NumberOfdaysExceeded,emp_name as EmployeeName, emp_mobile as EmployeeMobile FROM grievances g, grievances_transactions gt,comp_cutofdays_map ccm,cs_mst c,grievance_status_mst gsm, emp_mst e,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id 
				...
				/*05-07-2024 $sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,g.eoffice_no as EofficeNo, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,grievance_status_desc as Status ,date_regd as ReceivedDate,date_regd as ComplaintRegisteredDate,disposed_date as ComplaintResolvedDate, ccm.cutt_off_time+holidays_added as DisposableDays,DATE_ADD(date_regd, INTERVAL ccm.cutt_off_time+holidays_added  DAY) as ComplaintToBeResolvedDate
				,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added  AS NumberOfdaysExceeded,emp_name as EmployeeName, emp_mobile as EmployeeMobile FROM grievances g,
				grievances_transactions gt,comp_cutofdays_map ccm,cs_mst c,grievance_status_mst gsm, emp_mst e where g.grievance_id=gt.grievance_id and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.ulbid='" . $_SESSION['ulbid'] . "' and 
	...
	if ($_REQUEST['aptid'] == 1 && $_REQUEST['user_type'] == 'E') {
		...
		//05-06-24 if ($_REQUEST['status'] == 300) {
		/*06-05-24 if ($_REQUEST['status'] == 111 && $_REQUEST['sla'] == 0) {
			...
			$sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,g.eoffice_no as EofficeNo, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and
			gt.disposal_status=gsm.grievance_status_id and app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.emp_id IN('" . $emplist . "') and gt.is_escalated='1'";
		...
		if ($_REQUEST['status'] == 111 && $_REQUEST['sla'] == 0) {
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				...
				$esca_sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where DATE(date_regd) = '" . $date . "' and g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and cat3_id !='0'";
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.grievance_status_id IN ('3','6','8','9','12') and gt.disposal_status !=5 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN ('3','6','8','9','12') and gsm.grievance_status_id IN ('3','6','8','9','12') and gt.disposal_status !=5 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				// echo $sql ="SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id, DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added  AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date  FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and

				//app_type_id='1' and g.mcat3_id=ss.cs_id and gt.emp_id IN('".$emplist."') and gt.disposal_status !=5 and gt.disposal_status=9 and gt.grievance_id not in(select gg.grievance_id from grievances gg where gg.grievance_status_id IN(13,12,11) and  gt.is_escalated='0')";

				/*old 20-02-24 $sql="SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id, DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added  AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date  FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and
				app_type_id='1' and g.mcat3_id=ss.cs_id and gt.emp_id IN('".$emplist."') and gt.disposal_status !=5 and app_type_id='1' and grievance_status_id IN('3','8','9')  and cat3_id !='0' and gt.grievance_id not in(select gg.grievance_id from grievances gg where gg.grievance_status_id IN(13,12,11) and  gt.is_escalated='0')";
				...
				gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and gt.emp_id IN('".$emplist."') and gt.disposal_status !=5 and app_type_id='1' and gsm.grievance_status_id IN('3','8','9')   and cat3_id !='0' and gt.grievance_id not in(select gg.grievance_id from grievances gg where gg.grievance_status_id IN(13,12,11) and  gt.is_escalated='0')";*/

				//echo $sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				//g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('".$emplist."') and gt.disposal_status IN('3','9','8') and g.grievance_status_id IN('3','9','8') and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null) ";


				/*$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and gt.disposal_status IN('3','9','8')  and cat3_id !='0' ";
				...
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.grievance_status_id IN('3','9','8') and gt.disposal_status IN('3','9','8') and gsm.grievance_status_id IN('3','8','9') and cat3_id !='0' and gt.disposal_status !=5 and g.ward_id=w.ward_id and g.street_id=s.street_id and gt.grievance_id not in(select gg.grievance_id from grievances gg where gg.grievance_status_id IN('13','12','11') and gt.is_escalated='0')";*/

				/*22-05-24 $sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.grievance_status_id IN ('3','6','8','9','12','13') and gt.disposal_status !=5 and cat3_id !='0' ";*/

				/*03-06-24 $sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.grievance_status_id IN ('3','6','8','9','12','13') and gt.disposal_status !=5 and cat3_id !='0' ";*/

				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.grievance_status_id IN ('3','6','8','9','12') and gt.disposal_status !=5 and cat3_id !='0' ";

				/*12-04-24 $sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as PersonName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.grievance_status_id IN ('3','6','8','9','12') and gt.disposal_status !=5 and gsm.grievance_status_id IN ('3','6','8','9','12') and cat3_id !='0' and gt.disposal_status !=5 and g.ward_id=w.ward_id and g.street_id=s.street_id and gt.grievance_id not in(select gg.grievance_id from grievances gg where gg.grievance_status_id IN('13','12','11') and gt.is_escalated='0')";*/

				/*22-05-24 $sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN ('3','6','8','9','12') and gsm.grievance_status_id IN ('3','6','8','9','12') and gt.disposal_status !=5 and cat3_id !='0' ";*/

				/*03-06-24 $sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN ('3','6','8','9','12','13') and gsm.grievance_status_id IN ('3','6','8','9','12','13') and gt.disposal_status !=5 and cat3_id !='0' ";*/
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				...
				//$query = "SELECT count(g.grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('".$emplist."') and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) and gt.disposal_status=9 ";
				...
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and gt.disposal_status IN('3','9','8') and g.grievance_status_id IN('3','9','8') and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null)";*/

				/*22-05-24 $query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where g.grievance_id=gt.grievance_id and 
				...
				/*03-06-24 $query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and gt.disposal_status!=5 and g.grievance_status_id IN ('3','6','8','9','12','13') and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null)";*/

				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and gt.disposal_status!=5 and g.grievance_status_id IN ('3','6','8','9','12') and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null)";

				//$query = "SELECT count(DISTINCT(g.grievance_id)) as num FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and gt.disposal_status !=5 and app_type_id='1' and grievance_status_id IN('3','6','8','9','12') and cat3_id !='0'; ";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and gt.disposal_status IN ('2','11') and gt.disposal_status !=5 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and gt.disposal_status IN('2','11') and cat3_id !='0' and gt.disposal_status !=5 and g.ward_id=w.ward_id and g.street_id=s.street_id AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				/*old 20-02-24 $sql ="SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id, DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added  AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date  FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and
				app_type_id='1' and g.mcat3_id=ss.cs_id and gt.emp_id IN('".$emplist."') and gt.disposal_status !=5 and gt.disposal_status=2 and  gt.is_escalated='0'";

				$sqlExcel ="SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,g.eoffice_no as EofficeNo, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and
				gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and gt.emp_id IN('".$emplist."') and (gt.disposal_status !=5 or (gt.disposal_status =5 and is_escalated=1)) and gt.disposal_status=2 ";*/

				/*$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id, DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added  AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('".$emplist."') and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) and g.grievance_status_id IN('2') and gt.disposal_status IN('2') and cat3_id !='0'";

				$sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate 
				FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s,comp_cutofdays_map ccm where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and g.ward_id=w.ward_id and g.street_id=s.street_id and gt.emp_id IN('".$emplist."') and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) and g.grievance_status_id IN('2') and gt.disposal_status IN('2') and cat3_id !='0'";*/

				/*29-02-24 $sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id, DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added  AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) and g.grievance_status_id IN('2','11') and cat3_id !='0'";

				$sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate 
				FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s,comp_cutofdays_map ccm where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and g.ward_id=w.ward_id and g.street_id=s.street_id and gt.emp_id IN('" . $emplist . "') and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) and g.grievance_status_id IN('2') and gt.disposal_status IN('2') and cat3_id !='0'";*/

				/*23-05-2024 $sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.grievance_status_id IN ('2','11') and gt.disposal_status IN ('2','11') and gt.disposal_status !=5 and cat3_id !='0' ";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.grievance_status_id IN('2','11') and gt.disposal_status IN('2','11') and cat3_id !='0' and gt.disposal_status !=5 and g.ward_id=w.ward_id and g.street_id=s.street_id ";*/

				/*24-05-24 $sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.grievance_status_id IN ('2','11') and gt.disposal_status !=5 and cat3_id !='0' ";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.grievance_status_id IN('2','11') and cat3_id !='0' and gt.disposal_status !=5 and g.ward_id=w.ward_id and g.street_id=s.street_id ";*/

				$sql = "SELECT g.*,gt.file_url as updated_image,gt.disposal_status, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and gt.disposal_status IN ('2','11') and gt.disposal_status !=5 and cat3_id !='0' ";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and gt.disposal_status IN('2','11') and cat3_id !='0' and gt.disposal_status !=5 and g.ward_id=w.ward_id and g.street_id=s.street_id ";

				/*12-04-24 $sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate FROM grievances g,cs_mst c,ulbmst u,grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and app_type_id='1' and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('2','11') and gt.disposal_status IN('2','11') and gt.disposal_status !=5";*/
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.emp_id IN ('" . $emplist . "') and gt.disposal_status IN('2','11') and gt.disposal_status !=5 and app_type_id='1' and g.grievance_status_id IN('2','11') AND gt.disposal_status !=5 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				/*old 20-02-24 $query = "SELECT count(g.grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('".$emplist."') and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) and gt.disposal_status=2 ";*/

				/*29/02/24 $query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('".$emplist."') and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) and g.grievance_status_id IN('2') and gt.disposal_status IN('2') and cat3_id !='0' ";*/

				//23-05-2024 $query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.emp_id IN ('" . $emplist . "') and gt.disposal_status !=5 and app_type_id='1' and g.grievance_status_id IN('2','11') AND gt.disposal_status IN('2','11') and cat3_id !='0'";

				//24-05-2024 $query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.emp_id IN ('" . $emplist . "') and gt.disposal_status !=5 and app_type_id='1' and g.grievance_status_id IN('2','11') AND gt.disposal_status !=5 and cat3_id !='0'";

				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.emp_id IN ('" . $emplist . "') and gt.disposal_status IN('2','11') and gt.disposal_status !=5 and app_type_id='1' and g.grievance_status_id IN('2','11') AND gt.disposal_status !=5 and cat3_id !='0'";
			}
			...
			/*$sql ="SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id, DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added  AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date  FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and
			app_type_id='1' and g.mcat3_id=ss.cs_id and gt.emp_id IN('".$emplist."') and gt.disposal_status !=5 ";

			$sqlExcel ="SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,g.eoffice_no as EofficeNo, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and
			gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and gt.emp_id IN('".$emplist."') and gt.disposal_status !=5 group by gt.grievance_id";
			...
			app_type_id='1' and gt.emp_id IN('".$emplist."') and gt.disposal_status =5 and gt.is_escalated=1";
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				...
				$esca_sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
				...
				$esca_sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and cat3_id !='0'";

				/*29-02-24 $sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate 
				FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "')
				and cat3_id !='0' and gt.disposal_status !=5 and g.ward_id=w.ward_id and g.street_id=s.street_id";*/

				/*12-04-24 $sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate FROM grievances g,cs_mst c,ulbmst u,grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and g.ward_id=w.ward_id and g.street_id=s.street_id and gt.disposal_status !=5 and cat3_id !='0'";*/
			...
			$sql = "select g.* from grievances g,cs_mst c,ulbmst u where g.cat3_id=c.cs_id and g.ulbid=u.ulbid and g.ulbid='" . $_SESSION['ulbid'] . "' and grievance_status_id='1' and app_type_id='1' and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null)";
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,cs_mst c,ulbmst u,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and gt.disposal_status !=5 
				...
				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('3','8','9') and sla_status=1 and gt.disposal_status !=5 and cat3_id !='0' and gt.is_escalated=0 AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				...
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and grievance_status_id IN('3','8','9') and sla_status=1 and gt.disposal_status !=5 and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null)";*/
				...
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('3','8','9') and sla_status=1 and gt.disposal_status !=5 and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null)";*/

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('3','8','9') and sla_status=1 and gt.disposal_status !=5 and cat3_id !='0' and gt.is_escalated=0 ";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				...
				/*13-04-24 $query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,cs_mst c,ulbmst u,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and g.grievance_status_id IN('3','8','9') and sla_status=1 and gt.disposal_status !=5 and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null)";*/

				$query = "SELECT count(DISTINCT(g.grievance_id)) as num FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and gt.disposal_status !=5 and app_type_id='1' and grievance_status_id IN('3','8','9') and sla_status=1 and gt.is_escalated=0 and cat3_id !='0' ";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$sql = "SELECT g.*,gt.file_url as updated_imag FROM grievances g,cs_mst c,ulbmst u,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and
				...
				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('3','8','9') and sla_status=2 and gt.disposal_status !=5 and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null) AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				// $sql="SELECT g.*,gt.file_url as updated_image FROM grievances g,cs_mst c,ulbmst u, grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id IN('".$emplist."') and 
				...
				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('3','8','9') and sla_status=2 and gt.disposal_status !=5 and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null)";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				...
				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('2') and sla_status=1 and gt.disposal_status !=5 and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null) AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				$sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,cs_mst c,ulbmst u, grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
				...
				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('2') and sla_status=1 and gt.disposal_status !=5 and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null)";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,category3_mst c,ulbmst u , grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and grievance_status_id IN('2') and sla_status=1 and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,category3_mst c,ulbmst u , grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and grievance_status_id IN('2') and sla_status=1 and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null)";
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$query = "SELECT count(DISTINCT g.grievance_id) as numFROM grievances g,cs_mst c,ulbmst u ,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and grievance_status_id IN('2') and sla_status=2 and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				$query = "SELECT count(DISTINCT g.grievance_id) as numFROM grievances g,cs_mst c,ulbmst u ,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and grievance_status_id IN('2') and sla_status=2 and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null)";
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				...
				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('13','11','12') and gt.disposal_status NOT IN('5','9') and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				$sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,cs_mst c,ulbmst u ,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
				...
				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('13','11','12') and gt.disposal_status NOT IN('5','9') and cat3_id !='0'";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				...
				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.ward_id=w.ward_id and g.street_id=s.street_id and gt.disposal_status !=5 and g.grievance_status_id IN('12') and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				$sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,cs_mst c,ulbmst u ,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				...
				/*29-02-24 $sql="SELECT g.*,gt.file_url as updated_image FROM grievances g,cs_mst c,ulbmst u ,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id IN('".$emplist."') and 
				...
				/*12-04-24 $sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,g.eoffice_no as EofficeNo, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,grievance_status_desc as Status ,date_regd as ReceivedDate FROM grievances g,cs_mst c,ulbmst u,grievances_transactions gt,grievance_status_mst gsm where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and app_type_id='1' and g.grievance_status_id IN('6') and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null)";*/
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$query = "SELECT count(DISTINCT g.grievance_id) as num from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and grievance_status_id='6' and app_type_id='1' and gt.disposal_status !=5 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				/*29/02/24 $query="SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,cs_mst c,ulbmst u ,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id IN('".$emplist."') and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and grievance_status_id IN('6')  and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null)";*/

				$query = "SELECT count(DISTINCT g.grievance_id) as num from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and grievance_status_id='6' and app_type_id='1' and gt.disposal_status !=5 and cat3_id !='0'";
			}
	...
	/*19-03-24 $targetpage = "tot_received.php"; 	//your file name  (the name of this file)

...
if (isset($_SESSION['uid'])) {
	...
	/*$sql ="select COUNT(DISTINCT gt.grievance_id) as count,emp_id,ward_id,street_id,g.date_regd from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id and
			g.ulbid='".$_SESSION['ulbid']."' and g.app_type_id='".$_REQUEST['app_type_id']."' and gt.disposal_status IN(2,9,8,4,6,10) and g.grievance_status_id IN(2,9,8,4,6,10,13,12,11) and g.cat3_id !='0' ";*/

	$sql = "select COUNT(DISTINCT gt.grievance_id) as count,emp_id,ward_id,street_id,g.date_regd from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id and
	g.ulbid='" . $_SESSION['ulbid'] . "' and g.app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.disposal_status IN(2,9,8,4,6,10) and g.grievance_status_id IN(2,9,8,4,6,10,13,12,11) and g.cat3_id !='0' ";

	if ($_REQUEST['f_date'] != '' && $_REQUEST['t_date'] != '') {
		$sql .= "and date(date_regd) between '" . $fdate . "' and '" . $tdate . "' group by emp_id";
	} else {
		$sql .= " group by emp_id";
	}

	/*$sql ="select COUNT(DISTINCT gt.grievance_id) as count,gt.emp_id,g.ward_id,g.street_id,g.date_regd,e.emp_name from grievances g, grievances_transactions gt, emp_mst e where g.grievance_id=gt.grievance_id and gt.emp_id=e.emp_id and
			g.ulbid='".$_SESSION['ulbid']."' and g.app_type_id='".$_REQUEST['app_type_id']."' and gt.disposal_status IN(2,9,8,4,6,10) and g.grievance_status_id IN(2,9,8,4,6,10,13,12,11) and g.cat3_id !='0' ";
			...
			if (isset($_POST['search'])) 
			{
				if ($_POST['emp_name'] != '') 
				{
					$sql . " and e.emp_name='" . $_POST['emp_name'] . "'";
				}
	...
	$sql21 = "SELECT count(DISTINCT g.grievance_id) as count1,emp_id,disposal_status FROM grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and ulbid='" . $_SESSION['ulbid'] . "' and 
	...
	$sql2 = "SELECT count(DISTINCT gt.grievance_id) as count2,emp_id  FROM grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and ulbid='" . $_SESSION['ulbid'] . "' and 
	...
	$sql31 = "SELECT count(DISTINCT g.grievance_id) as count1,emp_id,disposal_status FROM grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and ulbid='" . $_SESSION['ulbid'] . "' and 
	...
	$sql = "select COUNT(DISTINCT gt.grievance_id) as count,emp_id as emp_dept from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and cat3_id !='0' and g.app_type_id='1' and gt.disposal_status IN('13')  and g.grievance_status_id IN('13') and ulbid='" . $_SESSION['ulbid'] . "' ";
	...
	$sql = "select COUNT(DISTINCT g.grievance_id) as count,emp_id as emp_dept from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and cat3_id !='0' and g.app_type_id='1'  and gt.disposal_status IN('11') and g.grievance_status_id IN('11') and ulbid='" . $_SESSION['ulbid'] . "' ";
	...
	$sql = "select COUNT(DISTINCT g.grievance_id) as count,emp_id as emp_dept from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and cat3_id !='0' and g.app_type_id='1' and gt.disposal_status IN ('10') and g.grievance_status_id IN ('10') and gt.disposal_status!='5'  and ulbid='" . $_SESSION['ulbid'] . "' ";
	...
	$sql3 = "select COUNT(g.grievance_id) as count,emp_id as emp_dept from grievances g, grievances_transactions gt where 

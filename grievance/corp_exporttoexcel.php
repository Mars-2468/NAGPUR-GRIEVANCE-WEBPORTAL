...
if (isset($_POST['excel'])  && isset($_POST['status']) && isset($_POST['sla'])) {
  ...
  elseif ($status == 0 || $status == 100 && $sla == 0 || $status == 101 && $sla == 0 || $status == 102 && $sla == 0 || $status == 1000 && $sla == 0 && $user_type == 'P' ) {
    $filename = "ADMIN RECEIVED COMPLAINT"; // File Name
  }
  elseif ($status == 107 && $sla == 2 || $status == 800 && $sla == 0 || $status == 21 && $sla == 0 && $user_type == 'P' ){
  ...
  elseif ($status == 700 && $sla == 0 || $status == 701 && $sla == 0 || $status == 6 && $sla == 0 || $status == 60 && $sla == 0 || $status == 10 && $sla == 0 && $user_type == 'P' ) {
  ...
  elseif ($status == 302 && $sla == 0 || $status == 400 && $sla == 0 || $status == 401 && $sla == 0 || $status == 3 && $sla == 0 || $status == 4 && $sla == 0 || $status == 22 && $sla == 0 && $user_type == 'P' ) {
  ...
  elseif ($status == 200 && $sla == 0 || $status == 201 && $sla == 0 || $status == 202 && $sla == 0 || $status == 2 && $sla == 0 && $user_type == 'P' ) {
  ...
  //28-03-24 elseif ($status == 500 || $status == 501 || $status == 5 || $status == 9 && $sla == 0 && $user_type == 'P' ) {
    elseif ($status == 500 && $sla == 0 || $status == 501 && $sla == 0 || $status == 9 && $sla == 0 || $status == 23 && $sla == 0 && $user_type == 'P' ) {
  ...
  //12-03-24 elseif ($status == 3 || $status == 300 || $status == 8 && $sla == 0 && $user_type == 'P' ) {
    elseif ($status == 300 && $sla == 0 || $status == 301 && $sla == 0 || $status == 8 && $sla == 0 && $user_type == 'P' ) {
  ...
  elseif ($status == 105 && $sla == 0 || $status == 500 && $sla == 0 || $status == 502 && $sla == 0 && $user_type == 'P' ) {
  ...
  elseif ($status == 7 && $sla == 0 || $status == 600 && $sla == 0 || $status == 601 && $sla == 0 && $user_type == 'P' ){
  ...
  elseif ($status == 5 && $sla == 0 && $user_type == 'P' ) {
  ...
  elseif ($status == 111 && $sla == 0 && $user_type == 'P' ) {
  ...
  elseif ($status == 1 && $sla == 0 && $user_type == 'P' ) {
  ...
  elseif ($status == 4 && $sla == 0 && $user_type == 'P' ) {

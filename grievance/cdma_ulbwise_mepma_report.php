	...
	if(isset($_SESSION['uid']))
	{
		...
		if($_REQUEST['app_type_id']==1)
		{
        	    if($_REQUEST['status']==0)
        	    {
        	        ...
        	        {
        	            //$sql="select count(g.grievance_id) as count,g.ulbid from grievances g,ulbmst u,Districtmst d where g.ulbid=u.ulbid and u.distid=d.distid and app_type_id='1' and d.rdma='".$_SESSION['uid']."' and cat3_id !='0' group by g.ulbid order by ulbname";
        	            $sql="select count(g.grievance_id) as count,ulbid from grievances g,grievances_transactions gt  where g.grievance_id=gt.grievance_id and disposal_status !=5 and app_type_id='1' and cat3_id !='0' and cat3_id IN(105,106,107,108,109,110,111,114,119,122,123,125,126,127) group by ulbid";
        	        }
        	    }

 ...
 */
	...
	if($app_type_id!=''){
		$sql .= "  g.app_type_id='" . $app_type_id . "' ";
	}

	if($dept_id!=''){
		$sql .= "  gt.dept_id='" . $dept_id . "' ";
	}
	...
	if($app_type_id!=''){
		$sql1 .= "  g.app_type_id='" . $app_type_id . "' ";
	}

	if($dept_id!=''){
		$sql1 .= "  gt.dept_id='" . $dept_id . "' ";
	}
	...
	if($app_type_id!=''){
		$sql21 .= "  g.app_type_id='" . $app_type_id . "' ";
	}

	if($dept_id!=''){
		$sql21 .= "  gt.dept_id='" . $dept_id . "' ";
	}
	...
	if($app_type_id!=''){
		$sql3 .= "  g.app_type_id='" . $app_type_id . "' ";
	}

	if($dept_id!=''){
		$sql3 .= "  gt.dept_id='" . $dept_id . "' ";
	}

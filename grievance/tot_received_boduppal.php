	...
	$tpl=new Smarty();
	   ...
	   // session_regenerate_id();
	    ...
	    if($_REQUEST['aptid']==1 && $_REQUEST['user_type']=='E')
	    {
	        ...
	        {
	       $sql="SELECT g.* FROM grievances g,cs_mst c,ulbmst u,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id='".$_SESSION['emp_id']."' and 
	...
	$sqlExcel="SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,g.eoffice_no as EofficeNo, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,grievance_status_desc as Status ,date_regd as ReceivedDate FROM grievances g,cs_mst c,ulbmst u,grievances_transactions gt,grievance_status_mst gsm where g.grievance_id=gt.grievance_id and gt.emp_id='".$_SESSION['emp_id']."' and 
	  ...
	  ////////////////////////////////////////////////////////////////  employee services  
	    ...
	    if($_REQUEST['aptid']==2 && $_REQUEST['user_type']=='E')
	    {
	        ...
	        if($_REQUEST['status']==0 && $_REQUEST['sla']==0)
	        {
	            $sql ="SELECT g.* FROM grievances g,ulbmst u ,standard_services c,grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and 
	            g.mcat3_id=c.cs_id and app_type_id='2' and gt.emp_id='".$_SESSION['emp_id']."' and gt.disposal_status !=5";
	            ...
	            g.mcat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and app_type_id='2' and gt.emp_id='".$_SESSION['emp_id']."' and gt.disposal_status !=5";
	            ...
	            g.ulbid=u.ulbid and g.mcat3_id=c.cs_id and app_type_id='2' and gt.emp_id='".$_SESSION['emp_id']."' and gt.disposal_status !=5 and is_reopened_yn='0'";
	        ...
	        else if($_REQUEST['status']==1 && $_REQUEST['sla']==0)
	        {
	            ...
	            $query="select count(grievance_id) as num from grievances g,standard_services c,ulbmst u where 
		                    g.mcat3_id=c.cs_id and g.ulbid=u.ulbid and g.ulbid='".$_SESSION['ulbid']."' and grievance_status_id='1' and app_type_id='2' and gt.disposal_status !=5 and is_reopened_yn='0'";
	        ...
	        {
	             $sql="SELECT g.* FROM grievances g,standard_services c,ulbmst u,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id='".$_SESSION['emp_id']."' and 
				 g.ulbid=u.ulbid and g.mcat3_id=c.cs_id and app_type_id='2' and grievance_status_id IN('3','8','9') and sla_status=1 and gt.disposal_status !=5 and is_reopened_yn='0'";
				 ...
				 g.ulbid=u.ulbid and g.mcat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and app_type_id='2' and g.grievance_status_id IN('3','8','9') and sla_status=1 and gt.disposal_status !=5 and is_reopened_yn='0'";
	            ...
	            $query="SELECT count(g.grievance_id) as num FROM grievances g,standard_services c,ulbmst u,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id='".$_SESSION['emp_id']."' and 
				 g.ulbid=u.ulbid and g.mcat3_id=c.cs_id and app_type_id='2' and grievance_status_id IN('3','8','9') and sla_status=1 and gt.disposal_status !=5 and is_reopened_yn='0'";
	        ...
	        {
	             $sql="SELECT g.* FROM grievances g,standard_services c,ulbmst u, grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id='".$_SESSION['emp_id']."' and 
				 g.ulbid=u.ulbid and g.mcat3_id=c.cs_id and app_type_id='2' and grievance_status_id IN('3','8','9') and sla_status=2 and gt.disposal_status !=5 and is_reopened_yn='0'";
		 ...
		 $sqlExcel="SELECT c.comp_desc as CategoryName,g.grievance_id as RefrenceNo,g.eoffice_no as EofficeNo, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,grievance_status_desc as Status ,date_regd as ReceivedDate FROM grievances g,standard_services c,ulbmst u, grievances_transactions gt,grievance_status_desc gsm where g.grievance_id=gt.grievance_id and gt.emp_id='".$_SESSION['emp_id']."' and 
				 g.ulbid=u.ulbid and g.mcat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and app_type_id='2' and g.grievance_status_id IN('2') and sla_status=1 and gt.disposal_status !=5 and is_reopened_yn='0'";		 
	        ...
	        {
	             $sql="SELECT g.* FROM grievances g,standard_services c,ulbmst u ,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id='".$_SESSION['emp_id']."' and 
				 g.ulbid=u.ulbid and g.mcat3_id=c.cs_id and app_type_id='2' and grievance_status_id IN('2') and sla_status=2 and gt.disposal_status !=5 and is_reopened_yn='0'";
				 
				 
				 $sqlExcel="SELECT c.comp_desc as CategoryName,g.grievance_id as RefrenceNo,g.eoffice_no as EofficeNo, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,grievance_status_desc as Status ,date_regd as ReceivedDate FROM grievances g,standard_services c,ulbmst u, grievances_transactions gt,grievance_status_desc gsm where g.grievance_id=gt.grievance_id and gt.emp_id='".$_SESSION['emp_id']."' and 
				 g.ulbid=u.ulbid and g.mcat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and app_type_id='2' and g.grievance_status_id IN('2') and sla_status=2 and gt.disposal_status !=5 and is_reopened_yn='0'";	
	         ...
	         else if($_REQUEST['status']==6)
	        {
		        ...
		        $sql="SELECT g.* FROM grievances g,standard_services c,ulbmst u .grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id='".$_SESSION['emp_id']."' and 
				 ...
				 $sqlExcel="SELECT c.comp_desc as CategoryName,g.grievance_id as RefrenceNo,g.eoffice_no as EofficeNo, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,grievance_status_desc as Status ,date_regd as ReceivedDate FROM grievances g,standard_services c,ulbmst u,grievances_transactions gt,grievance_status_mst gsm where g.grievance_id=gt.grievance_id and gt.emp_id='".$_SESSION['emp_id']."' and 
				 g.ulbid=u.ulbid and g.mcat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and app_type_id='2' and g.grievance_status_id ='6' and gt.disposal_status !=5 and is_reopened_yn='0'";
			...
			if(isset($_POST['search']))
        	{
	            ...
	            $query="SELECT count(g.grievance_id) num FROM grievances g,standard_services c,ulbmst u ,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id='".$_SESSION['emp_id']."' and 
				 g.ulbid=u.ulbid and g.mcat3_id=c.cs_id and app_type_id='2' and grievance_status_id IN('6')  and gt.disposal_status !=5 and is_reopened_yn='0'";
		...
		$sqlExcel="SELECT c.comp_desc as CategoryName,g.grievance_id as RefrenceNo,g.eoffice_no as EofficeNo, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,grievance_status_desc as Status ,date_regd as ReceivedDate FROM grievances g,standard_services c,ulbmst u,grievances_transactions gt,grievance_status_mst gsm where g.grievance_id=gt.grievance_id and gt.emp_id='".$_SESSION['emp_id']."' and 
				 g.ulbid=u.ulbid and g.mcat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and app_type_id='2' and g.grievance_status_id ='10' and gt.disposal_status !=5 and is_reopened_yn='0'";		 
	       ...
	       if(isset($_POST['search']))
	            ...
	            $query="SELECT count(g.grievance_id) num FROM grievances g,standard_services c,ulbmst u ,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id='".$_SESSION['emp_id']."' and 
				 g.ulbid=u.ulbid and g.mcat3_id=c.cs_id and app_type_id='2' and grievance_status_id IN('10')  and gt.disposal_status !=5 and is_reopened_yn='0'";
	        ...
	        else if($_REQUEST['status']==11)
	        {
	            ...
	            $sql="SELECT g.* FROM grievances g,cs_mst c,standard_services u ,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id='".$_SESSION['emp_id']."' and 
				 g.ulbid=u.ulbid and g.mcat3_id=c.cs_id and app_type_id='2' and grievance_status_id IN('4')  and gt.disposal_status !=5";
				 
				$sqlExcel="SELECT c.comp_desc as CategoryName,g.grievance_id as RefrenceNo,g.eoffice_no as EofficeNo, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,grievance_status_desc as Status ,date_regd as ReceivedDate FROM grievances g,standard_services c,ulbmst u,grievances_transactions gt,grievance_status_mst gsm where g.grievance_id=gt.grievance_id and gt.emp_id='".$_SESSION['emp_id']."' and 
				 g.ulbid=u.ulbid and g.mcat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and app_type_id='2' and g.grievance_status_id ='4' and gt.disposal_status !=5 and is_reopened_yn='0'"; 
	            ...
	            $query="SELECT count(g.grievance_id) as num FROM grievances g,standard_services c,ulbmst u ,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id='".$_SESSION['emp_id']."' and 
				 g.ulbid=u.ulbid and g.mcat3_id=c.cs_id and app_type_id='2' and grievance_status_id IN('4')  and gt.disposal_status !=5 and is_reopened_yn='0'";
		...
		if(isset($_POST['search']))
	      ...
	      /* $sql="SELECT * FROM grievances g,category3_mst c,ulbmst u where g.ulbid='".$_SESSION['ulbid']."' and 
	       ...
	       /*$sql="SELECT * FROM grievances g,category3_mst c,ulbmst u where g.ulbid='".$_SESSION['ulbid']."' and 
	            ...
	            DATE_ADD(date_regd, INTERVAL c.cutt_off_time DAY) as comp_date from grievances g,grievances_transactions gt ,standard_services c,ulbmst u
	            where g.mcat3_id=c.cs_id  and g.grievance_id=gt.grievance_id and
        		g.ulbid=u.ulbid and g.ulbid='".$_SESSION['ulbid']."' and grievance_status_id IN('2') and app_type_id='2' and sla_status=1 and gt.disposal_status !=5 and is_reopened_yn='0'";
        		...
        		$sqlExcel="select c.comp_desc as CategoryName,g.grievance_id as RefrenceNo,g.eoffice_no as EofficeNo, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.comp_desc as ComplaintDetails,grievance_status_desc as Status ,date_regd as ReceivedDate,c.cutt_off_time as DisposableDays,DATE_ADD(date_regd, INTERVAL c.cutt_off_time DAY) as ToBeCompletedDate,DATEDIFF(NOW(),date_regd)-c.cutt_off_time  AS DaysExceeded
	             from grievances g,grievances_transactions gt ,standard_services c,ulbmst u,grievance_status_mst gsm
	            where g.mcat3_id=c.cs_id  and g.grievance_id=gt.grievance_id and
        		g.ulbid=u.ulbid and g.grievance_status_id=gsm.grievance_status_id and g.ulbid='".$_SESSION['ulbid']."' and g.grievance_status_id IN('2') and app_type_id='2' and sla_status=1 and gt.disposal_status !=5 and is_reopened_yn='0'";
	      ...
	      /* $sql="SELECT * FROM grievances g,category3_mst c,ulbmst u where g.ulbid='".$_SESSION['ulbid']."' and 
        		...
        		$sqlExcel="select c.comp_desc as CategoryName,g.grievance_id as RefrenceNo,g.eoffice_no as EofficeNo, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.comp_desc as ComplaintDetails,grievance_status_desc as Status ,date_regd as ReceivedDate,c.cutt_off_time as DisposableDays,DATE_ADD(date_regd, INTERVAL c.cutt_off_time DAY) as ToBeCompletedDate,DATEDIFF(NOW(),date_regd)-c.cutt_off_time  AS DaysExceeded
	             from grievances g,grievances_transactions gt ,standard_services c,ulbmst u,grievance_status_mst gsm
	            where g.mcat3_id=c.cs_id  and g.grievance_id=gt.grievance_id and
        		 g.ulbid=u.ulbid and g.grievance_status_id=gsm.grievance_status_id and g.ulbid='".$_SESSION['ulbid']."' and g.grievance_status_id IN('2') and app_type_id='2' and sla_status=2 and gt.disposal_status !=5 and is_reopened_yn='0'";
		...
		*/
		...
		$tpl->display('tot_received_boduppal.tpl');

...
// exit;
    ...
    $name = sanitize_input($_POST[ 'person_name' ]); //$_POST[ 'person_name' ];
    ...
    //validation for hno
    $hno = sanitize_input($_POST[ 'hno' ]); // $_POST[ 'hno' ];
    if ( $hno == '' ) {
        //$_SESSION[ 'hno' ] = 'Hno Required';
        //header( "Location: complaint_form.php?id={$ulb_id}" );
    } else if ( !preg_match("/^[0-9]+([A-Za-z0-9\/-]+)?$/", $hno ) ) {
        $_SESSION[ 'hno' ] = 'Invalid House Number';
        header( "Location: web_register_form.php?id=250" );
		exit();
    ...
    $address = sanitize_input($_POST[ 'address' ]); // $_POST[ 'address' ];
    if ( $address == '' ) {
        //$_SESSION[ 'address' ] = 'Address Required';
        //header( "Location: complaint_form.php?id={$ulb_id}" );

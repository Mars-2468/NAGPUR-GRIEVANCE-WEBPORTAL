...
if ($rs) {
	...
	$sql ="select c.cs_id,c.chbot_comp_desc as comp_desc,c.chbot_comp_mr_desc from  cs_mst c,complaint_ulbmap cu where c.cs_id=cu.cs_id and cu.ulbid='".$ulbid."' and c.cs_id in(4,11,12,23,27,60) and cu.flag='1'";
	...
	if($rs=mysqli_query($conn,$sql))
	{
		...
		{
			$complaint_types[]=array('cs_id'=>$row['cs_id'],'cs_desc'=>$row['comp_desc']."/".$row['chbot_comp_mr_desc']);
		}
	}
	else
			...
			<form action="save_public_comp.php" id="myForm" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
					...
					<div id="form">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<input type="text" name="person_name" id="person_name" placeholder="Name of Person " value="<?php echo $row['user_name']; ?>" class="form-control mytext" readonly1 required>
							...
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<input type="text" name="mobile" id="mobile" placeholder="Mobile No" value="<?php echo (isset($_SESSION['com_reg_mobile'])) ? $_SESSION['com_reg_mobile'] : '' ?>" class="form-control num mytext" minlength="10" maxlength="10"  readonly1 required>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group col-md-12">
									<label>Zone Name / झोनचे नाव <span class="merror">*</span></label>
							...
							<div class="col-md-4">
								...
								<div class="form-group col-md-12">
									...
									<select name="sub_id" id="sub_id" class="form-control dropdown" onchange="get_csdesc123(this.value)" required>
...
-->
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									oninput="updateSubCountdown()" required>
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group col-md-12">
									...
									<textarea name="comp_desc" id="comp_desc" placeholder="Description" class="form-control mytext" rows="5" maxlength="1500"
									oninput="updateCountdown()" required></textarea>

	...
	if ($_SESSION['user_type'] == 'A') {
		...
		if ($_SESSION['ulbid'] == (int)$mergedulbs) {
			...
			if ($selectedYear) {
				...
				$sql = "SELECT COUNT(DISTINCT grievance_id) AS count,app_type_id FROM grievances WHERE date_format(date_regd,'%Y-%m-%d') = '" . $date . "' and ulbid='" . strip_tags($_SESSION['ulbid']) . "' and app_type_id='1' and cat3_id !='0' ";
				$sql .= " and date_format(date_regd,'%Y') = '" . $selectedYear . "' ";

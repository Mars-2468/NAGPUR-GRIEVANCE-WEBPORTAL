							...
							<form action="check_login.php" id="login-form" class="panel-body" method="post" autocomplete="off" onsubmit="return validateForm()">
								...
								<div class="form-group">
								  ...
								  <div class="">
									...
									<input type="hidden" name="captcha_code" id="captcha_code" value="<?php echo $_SESSION['captcha_code']; ?>">
								...
								<button type="submit" class="form-control bg-success"  style="display:block;" id="signInBtn">Sign in</button>
								...
								<div id="otpSection" style="display:none;" >																		
									...
									<input type="text" class="form-control" name="otp"  id="otp" placeholder="Enter otp" value="1234" minlength="4" maxlength="4" readonly required="required" style="border-radius:3px;margin-bottom:15px;" pattern="[0-9]{1,4}" title="Only numbers, up to 4 digits" onpaste="return false;" data-type="dotp" onkeyup="funInputFielTypes(this)" >
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script>
  -->
   <script src="js/bootstrap-fte.bundle.min.js" ></script>
<link href="<?php echo $bsurl; ?>/grievance/css/bootstrap-fts.min.css" rel="stylesheet" />

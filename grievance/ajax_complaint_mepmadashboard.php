<?php
		...
		$mergedulbs = 900;
		$sql="SELECT count(g.grievance_id) as date_regd,app_type_id FROM grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.disposal_status !=5 and app_type_id='1' and cat3_id !='0' and cat3_id IN(105,106,107,108,109,110,111,114,119,122,123,125,126,127)";
				...
				if($_SESSION['user_type']=='A')
		          {
		            ...
		            else if($_SESSION['user_type']=='U')
		            {
		                 if($_SESSION['ulbid']==(int)$mergedulbs)
            				 {
            				     $sql3 ="select IFNULL(count(gt.grievance_id),0) as count,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and ulbid IN('208','210') and gt.disposal_status IN('9','12') and is_reopened_yn='1'  and g.grievance_status_id IN('13') group by app_type_id";
        				         $sql4 ="select IFNULL(count(g.grievance_id),0) as count,disposal_status as grievance_status_id,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.disposal_status IN('11','12') and ulbid IN('208','210') group by app_type_id, grievance_status_id";
            				 }
            				 else
            				 {
        		               
        		             $sql3 ="select IFNULL(count(gt.grievance_id),0) as count,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and ulbid='".$_SESSION['ulbid']."' and gt.disposal_status IN('9','12') and is_reopened_yn='1'  and g.grievance_status_id IN('13') group by app_type_id";
        				     $sql4 ="select IFNULL(count(g.grievance_id),0) as count,disposal_status as grievance_status_id,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.disposal_status IN('11','12') and ulbid='".$_SESSION['ulbid']."' group by app_type_id, grievance_status_id";
            				 }
		                
		            }
		            else if($_SESSION['user_type']=='E')
				        {
				            $sql3 ="select IFNULL(count(gt.grievance_id),0) as count,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and emp_id='".$_SESSION['emp_id']."' and gt.disposal_status IN('9','12') and is_reopened_yn='1'  and g.grievance_status_id IN('13') group by app_type_id";
				            $sql4 ="select IFNULL(count(DISTINCT g.grievance_id),0) as count,disposal_status as grievance_status_id,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.disposal_status IN('11','12') and gt.emp_id='".$_SESSION['emp_id']."' group by app_type_id, grievance_status_id";
				        }
				        else if($_SESSION['user_type']=='R')
		                {
		                    
		                   $sql3="select IFNULL(count(gt.grievance_id),0) as count,app_type_id from grievances g,grievances_transactions gt,ulbmst u,Districtmst d where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and u.distid=d.distid and d.rdma='".$_SESSION['uid']."' and cat3_id !='0' and gt.disposal_status IN('9','12') and is_reopened_yn='1'  and g.grievance_status_id IN('13') group by app_type_id";
...
<div class="boxed">
               ...
               <div class="bash_heading row  m-b20"> Total Number of Complaints  </div> 
                ...
                <div class="row dashboard-stats">
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                <div class="panel-left panel-icon bg-success" style="vertical-align: middle;">
                                    <i class="fa fa-cloud text-large stat-icon "></i>
                                </div>
                                <div class="panel-right panel-icon bg-reverse">
                                    ...
                                    <p class="size-h1 no-margin countdown_first">
                                        ...
                                        else
                                        {
                                            if($_SESSION['user_type']=='M')
                                            {
                                                echo "<a href='cdma_ulbwise_mepma_report.php?status=0&app_type_id=1&name=".$_SESSION['uid']."' target='_blank'>".$data[1]['total_received']."</a>";
                                            }
                                            else
                                            {
				...
				{?>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                <div class="panel-left panel-icon bg-lovender" style="vertical-align: middle;">
                        ...
                        <p class="size-h1 no-margin countdown_first">
                            ...
                            <?php if($_SESSION['user_type']=='U'){
                                        ...
                                        else
                                        {
                                            if($_SESSION['user_type']=='M')
                                            {
                                                echo "<a href='cdma_ulbwise_mepma_report.php?status=1&app_type_id=1&name=".$_SESSION['uid']."' target='_blank'>".$data[1]['pendingforapproval']."</a>";
                                            }
                                            else
                                            {
               ...
               <p class="size-h1 no-margin countdown_first">
                   ...
                   <?php if($_SESSION['user_type']=='U'){
                                        ...
                                        else
                                        {
                                            if($_SESSION['user_type']=='M')
                                            {
                                                echo "<a href='cdma_ulbwise_mepma_report.php?status=2&app_type_id=1&name=".$_SESSION['uid']."'>".$data[1]['resolved_within_sla']."</a>";
                                            }
                                            else
                                            {
                        ...
                        <div class="col-md-4 col-sm-6" style="clear:both;">
                            <section class="panel panel-box">
                                <div class="panel-left panel-icon bg-info" style="vertical-align: middle;">
                     ...
                     <p class="size-h1 no-margin countdown_first">
                          ...
                          <?php if($_SESSION['user_type']=='U'){
                                        ...
                                        else
                                        {
                                            if($_SESSION['user_type']=='M')
                                            {
                                                echo "<a href='cdma_ulbwise_mepma_report.php?status=3&app_type_id=1&name=".$_SESSION['uid']."'>".$data[1]['resolved_beyond_sla']."</a>";
                                            }
                                            else
                                            {
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                <div class="panel-left panel-icon bg-instagram" style="vertical-align: middle;">
    ...
    <p class="size-h1 no-margin countdown_first">
                                        ...
                                        else
                                        {
                                            if($_SESSION['user_type']=='M')
                                            {
                                                echo "<a href='cdma_ulbwise_mepma_report.php?status=4&app_type_id=1&name=".$_SESSION['uid']."'>".$data[1]['pending_with_sla']."</a>";
                                            }
                                            else
                                            {
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                <div class="panel-left panel-icon bg-vimeo" style="vertical-align: middle;">
         ...
         <p class="size-h1 no-margin countdown_first">
                                        ...
                                        else
                                        {
                                            if($_SESSION['user_type']=='M')
                                            {
                                                echo "<a href='cdma_ulbwise_mepma_report.php?status=5&app_type_id=1&name=".$_SESSION['uid']."'>".$data[1]['pending_beyond_sla']."</a>";
                                            }
                                            else
                                            {
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">
                                        ...
                                        else
                                        {
                                            if($_SESSION['user_type']=='M')
                                            {
                                                echo "<a href='cdma_ulbwise_mepma_report.php?status=6&app_type_id=1&name=".$_SESSION['uid']."'>".$data[1]['fin']."</a>";
                                            }
                                            else
                                            {
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                <div class="panel-left panel-icon bg-danger" style="vertical-align: middle;">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">
                                        ...
                                        else
                                        {
                                            if($_SESSION['user_type']=='M')
                                            {
                                                echo "<a href='cdma_ulbwise_mepma_report.php?status=10&app_type_id=1&name=".$_SESSION['uid']."'>".$data[1]['rejected']."</a>";
                                            }
                                            else
                                            {
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                            echo "<a href='cdma_ulbwise_mepma_report.php?status=11&app_type_id=1&name=".$_SESSION['uid']."'>".$data[1]['unresolved']."</a>";
                                            }
                                        }

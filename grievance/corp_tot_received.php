...
/////////////////////////////////////////////////////////////////// admin start
	...
	if ($_REQUEST['aptid'] == 1 && $_SESSION['user_type'] == 'P') {
		...
		if ($_REQUEST['status'] == 111 && $_REQUEST['sla'] == 0) {
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				...
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and g.app_type_id='1' and g.ulbid='" . $_SESSION['ulbid'] . "' and cat3_id !='0' and grievance_status_id in(2,3,5,6,8,9,10,11,12,13) AND YEAR(date_regd) = '" . $selectedYear . "'";
	...
	if ($_REQUEST['aptid'] == 2 && $_SESSION['user_type'] == 'P') {
...
/* ====================pagination code start========================= */	
	...
	$sql .= " group by g.grievance_id order by date_regd DESC ";
...
/************************* pagination end  **************************/
	...
	$tpl->display('corp_tot_received.tpl');
} else {

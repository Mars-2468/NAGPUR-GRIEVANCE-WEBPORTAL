...
if (isset($_SESSION['uid'])) {
	...
	/*old 20-07-2024 $sql = "SELECT count(DISTINCT grievance_id) as count,ulbid FROM grievances WHERE grievance_status_id =? and app_type_id=? and ulbid=?";
	...
	$query->bind_param("iis", $id9, $app_type_id, htmlspecialchars(strip_tags($ulbid)));*/
	...
	while ($row = $rs->fetch_assoc()) {
		...
		/*old 20-07-2024 $sql3 = "SELECT response_time FROM grievances WHERE response_time!=? 
		and grievance_status_id =? 
		...
		$cat3_id = 0;
		$app_type_id = 1;
		$query->bind_param("siii", $response_time1, $id9, $cat3_id, $app_type_id);*/

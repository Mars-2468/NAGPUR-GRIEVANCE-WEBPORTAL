...
<a href="#" onclick="window.history.go(-1); return false;" style="list-style:none; color:#FFF;">Back</a>
</div>
</div>
<br>
<br>-->
 ...
 <tr>
    ...
    <td align="left" valign="top">
	    ...
	    {if $row.app_type_id eq '1'}
			...
			<td align="center"><a href="view_comp_det_admin.php?grievance_id={$grievance_id}&ulbid={$row.ulbid}">{$grievance_id}</a></td>

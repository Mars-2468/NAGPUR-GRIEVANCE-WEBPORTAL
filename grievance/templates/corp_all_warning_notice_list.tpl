			...
			<form method="POST" class="form-horizontal">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" class="phone-group form-control datepicker" name="f_date" value="{$f_date}" placeholder="Select Date" autocomplete="off">
						</div>
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" class="phone-group form-control datepicker" name="t_date" value="{$t_date}" placeholder="Select Date" autocomplete="off">
						</div>
					</div>
				</div>
				{if $user_type eq 'E'}
				...
				<div class="button-container">
					<input name="search" type="submit" class="btn btn-success" value="SEARCH">
					<!-- <a href="corp_warning_notice.php?active=tr-clmn" class="btn btn-warning" onclick="history.go(-1);">
						<i class="fa fa-backward"></i> Back
					</a> -->
				</div>
				{/if}
					...
					<table width="100%" border="1" cellspacing="0" cellpadding="0" class="display table-bordered table-striped table-condensed cf" id="example">
						...
						<tbody>
							...
							<tr>
								...
								<td align='center'>{$dept_list[$dept_id]}</td>

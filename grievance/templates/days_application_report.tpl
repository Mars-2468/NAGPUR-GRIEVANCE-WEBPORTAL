...
$("#from_date").datepicker({ maxDate:-2,dateFormat: 'yy-mm-dd',changeMonth: true,changeYear: true});
$("#to_date").datepicker({ maxDate:+1,dateFormat: 'yy-mm-dd',changeMonth: true,changeYear: true});
...
<tr>
	<th width="10%" align="right">Select Type</th> 
	<td>
	...
	<th width="10%" align="right">Enter Name </th>
	<td>
	<input type="text" id="apprec_id"  name="apprec_id" onkeyup="autocomplet()" class="chr" value="{$apprec_sel}" autocomplete="off">
	<b><ul id="country_list_id"></ul></b>	</td>
	
	
	<th width="10%" align="right">Form Date</th> 
	<td>
	<input type="text" id="from_date"  name="from_date" value="{$from_date}"  class="datepick mytext" style="width:100px;">	</td>
	<th width="10%" align="right"> To Date</th>
	<td>
	<input type="text" id="to_date"  name="to_date"   value="{$to_date}" class="datepick mytext" style="width:100px;">	</td>
<tr> 
</table>
  </form>

...
<body style="padding: 0px; margin: 0px;">
    ...
    <div>
        <div>
            ...
            <div id="area" class="container-fluid d-flex justify-content-between align-items-center" style="margin-top: 5px;">
                <div style="float: left;">
					<h2 class="comp-txt">COMPLAINT STATUS / तक्रारीची स्थिती</h2>
				</div>
                <div style="float: right;">
				    ...
				    &nbsp;&nbsp;
                    <a href="web_complaint_form.php" class="btn btn-primary" style="list-style:none; color:#FFF;margin-top: 23px;">Register grievance</a>
				  &nbsp;&nbsp;
			...
			<div id="area" class="container-fluid" style="margin-top: 15px;">
                <div class="panel panel-info" style="margin-top: 15px;">
                    <div class="panel-heading" style="text-align: center;">Check Status</div>
                    <div class="panel-body">
                        <form name='check_comp_status' method='POST' action='check_comp_status.php' onSubmit="return validateForm();">
                            <input type="hidden" name="ulbid" value="{$ulbid}">
                            <div class="row">
                                <div class="col-md-3">
                                    <label>Name</label>
                                    <input type="text" name="person_name" id="person_name" value="{$search_fields['person_name']}" class="form-control"/>
                                </div>
                                <div class="col-md-3">
                                    <label>Mobile No</label>
                                    <input type="text" name="mobile" value="{$search_fields['mobile']}" class="form-control"/>
                                </div>
                                <div class="col-md-3">
                                    <label>Period From</label>
                                    <input type="text" name="from_date" id="from_date" value="{$search_fields['from_date']}" readonly1 class="datepick form-control">
                                </div>
                                <div class="col-md-3">
                                    <label>Period To</label>
                                    <input type="text" name="to_date" id="to_date" value="{$search_fields['to_date']}" readonly1 class="datepick form-control">
                                </div>
                                <div class="col-md-3" style="margin-top: 10px;">
                                    <label>Reference No</label>
                                    <input type="text" name="grievance_id"  value="{$search_fields['grievance_id']}" class="form-control">
                                </div>
                                <div class="col-md-3" style="margin-top: 10px;">
                                    <label>Status</label>
                                    <select name="grievance_status_id" id="grievance_status_id" class="form-control">
                                        <option value='%'>-All-</option>
                                        {html_options options=$grievance_status_list selected=$search_fields['grievance_status_id']}
                                    </select>
                                </div>
								<div class="row" style="padding-bottom:12px;">
										<div class="col-md-12 d-flex text-center" style="margin-top: 32px;">
											<input style="padding:8px 20px" type="submit" name="save" id="save" value="Submit" class="excel_btn btn btn-success"/>
                ...
                <table id='example' width="100%" border="1" cellpadding="0" cellspacing="0" class="table" style="font-size: 13px;">
                    ...
                    <tr>
                        ...
                        <td align="center" valign="middle" style="width: 100px; word-wrap: break-word;">
                            ...
                            {if $row.grievance_status_id eq '9' && $row.feedback_status eq 0}
                            <a href="feedback.php?id=250&grievance_id={$grievance_id}" class="excel_btn btn btn-success">FeedBack</a>
                            {/if}
                        </td>
                    </tr>
                    {/foreach}

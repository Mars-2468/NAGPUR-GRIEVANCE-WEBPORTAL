...
<script type="text/javascript" src="assets/data-tables/jquery.dataTables.js"></script><!-- DATATABLE JS -->
	<script type="text/javascript" src="assets/data-tables/DT_bootstrap.js"></script><!-- BOOTSTRAP DATATABLE JS -->
    	...
    	<script>
 var displayduration = "";
function fetchdept(i,emp_id,street_id,street_desc,ward_id,cs_id,emp_id2,ward_desc)
{
displayduration = i;
	$.ajax({
	type: "POST",
	url: "fetchdept.php",
	data:{emp_id:emp_id,street_id:street_id,street_desc:street_desc,ward_id:ward_id,cs_id:cs_id,emp_id2:emp_id2,ward_desc:ward_desc},
...
function editemp(emp_id,street_id,street_desc,ward_id,ward_desc,cs_id,dept_id)
{
...
//alert(dept_id1);
	...
	type: "POST",
	url: "fetchemp.php",
	data:{emp_id:emp_id,street_id:street_id,street_desc:street_desc,ward_id:ward_id,cs_id:cs_id,dept_id:dept_id1,ward_desc:ward_desc},
	success: function(data){
	//alert(data);
...
function updaterecord(street_id,ward_id, cs_id)
{
	...
	//alert(emp_id);
		$.ajax({
		type: "POST",
		url: "updateemp_service.php",
		data:{emp_id:emp_id,ward_id:ward_id,cs_id:cs_id,emp_id1:emp_id1,dept_id:dept_id,street_id:street_id},
		success: function(data){
		//alert(data);
		if(data == '0')
		{
...
{/literal}
 ...
 <div class="row">
		<div class="col-lg-12">
			<div class="boxed">
                ...
                <div class="title-bar white">
                  <h4>Please Select Service From Bellow Drop Down To View/Edit Mapping</h4>
                  
                </div>
                <br>
                <form method="GET" action="service_emp_map_report_street_wise.php" >
	...
	-->                    <button class="btn btn-primary"  onclick="fetchdept({$i},'{$emp_id}','{$street_id}','{$street_list[$ward_id][$street_id]}','{$ward_id}','{$cat_id}','{$emp_id2}','{$ward_list[$ward_id]}')">

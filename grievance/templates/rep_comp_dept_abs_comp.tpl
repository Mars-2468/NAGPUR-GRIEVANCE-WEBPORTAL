          ...
          {foreach from=$dept_list key=dept_id item=row}
			{if $smarty.session.user_type=='U'}
				  <tr>
					...
					<td class="{if $active_class eq 'tr-clm3qclmn'} activ_column {/if}"><a href="dept_empwise.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=0&f_date={$fdate}&t_date={$tdate}">{$dept_list[$dept_id]}</a></td>
					<td align='center' class="{if $active_class eq 'tr-clmn'} activ_column {/if}"><a href="dept_empwise.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=0&f_date={$fdate}&t_date={$tdate}">{$data[$dept_id]['count']}</a></td>
					<td align='center' class="{if $active_class eq 'pwsla-clmn'} activ_column {else if $active_class eq 'tr-totpending'} activ_column {/if}">{if $data_list[$dept_id].underprogress_within_sla neq ''}<a href="dept_empwise.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=2&f_date={$fdate}&t_date={$tdate}&sla_status=1" target="">{$data_list[$dept_id].underprogress_within_sla}</a>{else}-{/if}</td>
					<td align='center' class="{if $active_class eq 'pdbsla-clmn'} activ_column {else if $active_class eq 'tr-totpending'} activ_column {/if}">{if $data_list[$dept_id].underprogress_beyond_sla neq ''}<a href="dept_empwise.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=2&f_date={$fdate}&t_date={$tdate}&sla_status=2" target="">{$data_list[$dept_id].underprogress_beyond_sla}</a>{else}-{/if}</td>
					<td align='center' class="{if $active_class eq 'cmp-wthin-sla'} activ_column {else if $active_class eq 'tr-totresolved'} activ_column {/if}">{if $data_list[$dept_id].completed_within_sla neq ''}<a href="dept_empwise.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=3&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].completed_within_sla}</a>{else}-{/if}</td>
					<td align='center' class="{if $active_class eq 'cmp-bnd-sla'} activ_column {else if $active_class eq 'tr-totresolved'} activ_column {/if}">{if $data_list[$dept_id].completed_beyond_sla neq ''}<a href="dept_empwise.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=4&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].completed_beyond_sla}</a>{else}-{/if}</td>
					<td align='center'>-</td>
					<td align='center' class="{if $active_class eq 'tr-totpending' || $active_class eq 'tr-totpending-reopen' || $active_class eq 'tr-totpending-reopen-total'}activ_column{/if}">{if $data_list[$dept_id].reopened neq ''}<a href="dept_empwise.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=5&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].reopened} </a>{else}-{/if}</td>
					<td align='center' class="{if $active_class eq 'tr-totpending' || $active_class eq 'tr-totpending-reopen' || $active_class eq 'tr-totpending-reopen-under-progress'}activ_column{/if}">{if $data_list[$dept_id].reopend_underProgress neq ''}<a href="dept_empwise.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=6&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].reopend_underProgress} </a>{else}-{/if}</td>
					<td align='center' class="{if $active_class eq 'tr-totresolved' || $active_class eq 'tr-totpending-reopen' || $active_class eq 'tr-totpending-reopen-completed'}activ_column{/if}">{if $data_list[$dept_id].reopened_completed neq ''}<a href="dept_empwise.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=7&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].reopened_completed} </a>{else}-{/if}</td>
					<td align='center'>{if $data_list[$dept_id].rejected neq ''}<a href="dept_empwise.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=4&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].rejected} </a>{else}-{/if}</td>
					<td align='center' class="{if $active_class eq 'tr-totresolved' || $active_class eq 'tr-totresolved-fin'}activ_column{/if}">{if $data_list[$dept_id].fin neq ''}<a href="dept_empwise.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=7&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].fin} </a>{else}-{/if}</td>
					<!-- <td align='center' class="{if $active_class eq 'tr-clmn'} activ_column {/if}">{$data_list[$dept_id].transfers}</td> -->
				  </tr>
			{else}	  
				<tr>
					<td align='center'>{counter}</td>
					<td class="{if $active_class eq 'tr-clm3qclmn'} activ_column {/if}"><a href="emp_comp_det1.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=0&f_date={$fdate}&t_date={$tdate}">{$dept_list[$dept_id]}</a></td>
					<td align='center' class="{if $active_class eq 'tr-clmn'} activ_column {/if}"><a href="emp_comp_det1.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=0&f_date={$fdate}&t_date={$tdate}">{$data[$dept_id]['count']}</a></td>
					<td align='center' class="{if $active_class eq 'pwsla-clmn'} activ_column {else if $active_class eq 'tr-totpending'} activ_column {/if}">{if $data_list[$dept_id].underprogress_within_sla neq ''}<a href="emp_comp_det1.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=21&f_date={$fdate}&t_date={$tdate}&sla_status=1" target="">{$data_list[$dept_id].underprogress_within_sla}</a>{else}-{/if}</td>
					<td align='center' class="{if $active_class eq 'pdbsla-clmn'} activ_column {else if $active_class eq 'tr-totpending'} activ_column {/if}">{if $data_list[$dept_id].underprogress_beyond_sla neq ''}<a href="emp_comp_det1.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=22&f_date={$fdate}&t_date={$tdate}&sla_status=2" target="">{$data_list[$dept_id].underprogress_beyond_sla}</a>{else}-{/if}</td>
					<td align='center' class="{if $active_class eq 'cmp-wthin-sla'} activ_column {else if $active_class eq 'tr-totresolved'} activ_column {/if}">{if $data_list[$dept_id].completed_within_sla neq ''}<a href="emp_comp_det1.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=3891&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].completed_within_sla}</a>{else}-{/if}</td>
					<td align='center' class="{if $active_class eq 'cmp-bnd-sla'} activ_column {else if $active_class eq 'tr-totresolved'} activ_column {/if}">{if $data_list[$dept_id].completed_beyond_sla neq ''}<a href="emp_comp_det1.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=3892&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].completed_beyond_sla}</a>{else}-{/if}</td>
					<td align='center'>-</td>
					<td align='center' class="{if $active_class eq 'tr-totpending' || $active_class eq 'tr-totpending-reopen' || $active_class eq 'tr-totpending-reopen-total'}activ_column{/if}">{if $data_list[$dept_id].reopened neq ''}<a href="emp_comp_det1.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=13&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].reopened} </a>{else}-{/if}</td>
					<td align='center' class="{if $active_class eq 'tr-totpending' || $active_class eq 'tr-totpending-reopen' || $active_class eq 'tr-totpending-reopen-under-progress'}activ_column{/if}">{if $data_list[$dept_id].reopend_underProgress neq ''}<a href="emp_comp_det1.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=11&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].reopend_underProgress} </a>{else}-{/if}</td>
					<td align='center' class="{if $active_class eq 'tr-totresolved' || $active_class eq 'tr-totpending-reopen' || $active_class eq 'tr-totpending-reopen-completed'}activ_column{/if}">{if $data_list[$dept_id].reopened_completed neq ''}<a href="emp_comp_det1.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=12&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].reopened_completed} </a>{else}-{/if}</td>
					<td align='center'>{if $data_list[$dept_id].rejected neq ''}<a href="emp_comp_det1.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=4&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].rejected} </a>{else}-{/if}</td>
					<td align='center' class="{if $active_class eq 'tr-totresolved' || $active_class eq 'tr-totresolved-fin'}activ_column{/if}">{if $data_list[$dept_id].fin neq ''}<a href="emp_comp_det1.php?active={$active_class}&app_type_id=1&dept_id={$dept_id}&status=6&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].fin} </a>{else}-{/if}</td>
					<!--	
					<td align='center' class="{if $active_class eq 'tr-clmn'} activ_column {/if}">{$data_list[$dept_id].transfers}</td>
				    -->
				  </tr>

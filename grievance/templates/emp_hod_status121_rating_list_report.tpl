...
<div class="boxed">
	<div style="padding:10px;background-color: #00AEEF;border-color: #00AEEF;display: flex;justify-content: space-between;align-items: center;text-color:#FFF;">
		...
		<p class="m-0"><a href="emp_hod_status121_rating_report.php" class="btn btn-warning"><i class="fa fa-backward"></i> Back</a></p>
	</div>
				...
				<div  id="area" class="table-responsive">
					...
					<table id='example' cellpadding="3" cellspacing="0" border="1" class="display table-bordered table-striped table-condensed cf" width="100%">
						...
						<tbody id="myTable">
							 ...
							 {foreach from=$data item=grievances}
							{foreach from=$grievances item=g}
							<tr>
								<td class="text-center" >{counter}</td>
								<td><a href="emp_hod_status121_comp_rating_det_admin.php?grievance_id={$data[$g.emp_id][$g.grievance_id]['grievance_id']}&rating_no={$rating_no}&department_id={$department_id}">{$data[$g.emp_id][$g.grievance_id]['grievance_id']}</a></td>
								<td>{$emp_list[$g.emp_id]['emp_name']}</td>
								<td>{$dept_list[$g.dept_id]}</td>
								<td class="text-center" >
								<div id="eform-id-{$emp_id}" class="d-flex justify-content-start align-items-center" name="eform_name{$emp_id}">
											
											<div class="erating">({$data[$g.emp_id][$g.grievance_id]['rating_no']})
												<span>	
													<input type="radio" class="erating-input" id="erating-input-{$emp_id}-10" value="10"  {if $data[$g.emp_id][$g.grievance_id]['rating_no']==10} checked {/if} onclick="return false;">
													<label for="erating-input-{$emp_id}-10" class="erating-star" title="10"></label>			
													<input type="radio" class="erating-input" id="erating-input-{$emp_id}-9" value="9"  {if $data[$g.emp_id][$g.grievance_id]['rating_no']==9} checked {/if} onclick="return false;">
													<label for="erating-input-{$emp_id}-9" class="erating-star" title="9"></label>			
													<input type="radio" class="erating-input" id="erating-input-{$emp_id}-8" value="8"  {if $data[$g.emp_id][$g.grievance_id]['rating_no']==8} checked {/if} onclick="return false;">
													<label for="erating-input-{$emp_id}-8" class="erating-star" title="8"></label>			
													<input type="radio" class="erating-input" id="erating-input-{$emp_id}-7" value="7"  {if $data[$g.emp_id][$g.grievance_id]['rating_no']==7} checked {/if} onclick="return false;">
													<label for="erating-input-{$emp_id}-7" class="erating-star" title="7"></label>			
													<input type="radio" class="erating-input" id="erating-input-{$emp_id}-6" value="6"  {if $data[$g.emp_id][$g.grievance_id]['rating_no']==6} checked {/if} onclick="return false;">
													<label for="erating-input-{$emp_id}-6" class="erating-star" title="6"></label>			
													
													<input type="radio" class="erating-input" id="erating-input-{$emp_id}-5" value="5"  {if $data[$g.emp_id][$g.grievance_id]['rating_no']==5} checked {/if} onclick="return false;">
													<label for="erating-input-{$emp_id}-5" class="erating-star" title="5"></label>			
													<input type="radio" class="erating-input" id="erating-input-{$emp_id}-4" value="4"  {if $data[$g.emp_id][$g.grievance_id]['rating_no']==4} checked {/if} onclick="return false;">
													<label for="erating-input-{$emp_id}-4" class="erating-star" title="4"></label>
													<input type="radio" class="erating-input" id="erating-input-{$emp_id}-3" value="3"  {if $data[$g.emp_id][$g.grievance_id]['rating_no']==3} checked {/if} onclick="return false;">
													<label for="erating-input-{$emp_id}-3" class="erating-star" title="3"></label>
													<input type="radio" class="erating-input" id="erating-input-{$emp_id}-2" value="2"  {if $data[$g.emp_id][$g.grievance_id]['rating_no']==2} checked {/if} onclick="return false;" >
													<label for="erating-input-{$emp_id}-2" class="erating-star" title="2" readonly></label>
													<input type="radio" class="erating-input" id="erating-input-{$emp_id}-1" value="1"  {if $data[$g.emp_id][$g.grievance_id]['rating_no']==1} checked {/if} onclick="return false;" >

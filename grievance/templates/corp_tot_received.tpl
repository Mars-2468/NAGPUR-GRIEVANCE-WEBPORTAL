				...
				<table border="1" cellspacing="0" cellpadding="0" class="table table-bordered" id="data-table" width="100%">
					<caption style="caption-side:top; text-align:center;font-size:16px;">
						<b>
							...
							{elseif $status eq '0' && $sla eq '0' && $user_type eq 'P' }
							...
							{elseif $status eq '100' && $sla eq '2' && $user_type eq 'P' }
							...
							{elseif $status eq '111' && $sla eq '0' && $user_type eq 'P' }
							...
							{elseif $status eq '200' && $sla eq '2' && $user_type eq 'P' }
							...
							{elseif $status eq '6' && $user_type eq 'P' }
							...
							{elseif $status eq '2' && $sla eq '1' && $user_type eq 'P' }
							...
							{elseif $status eq '3' && $sla eq '1' && $user_type eq 'P' }
							...
							{elseif $status eq '2' && $sla eq '2' && $user_type eq 'P' }
							...
							{elseif $status eq '3' && $sla eq '2' && $user_type eq 'P' }
							...
							{elseif $status eq '005' && $user_type eq 'P' }
...
<a href="corp_view_comp_det_admin_today_recieved.php?grievance_id={$grievance_id}">

		...
		<div id="div_print" style="border:#999999 0px solid;">
			...
			<div id="area" style="width:100%; overflow:scroll; font-size:13px;">
				<table border="1" cellspacing="0" cellpadding="0" class="table table-bordered" id="data-table" width="100%">
					...
					<thead>
						<!--05-06-24 <tr style="background-color:#2c3e50; color:#FFF;text-align:center;">
						...
						<!--do not open<th align="center" valign="middle">{if $app_type_id eq '1'} Complaint {else} SERVICE{/if} Details</th>	-->
						<!--05-06-24 <th align="center" valign="middle">Status</th>
						...
						<!--do not open <th align="center" valign="middle">Completed Date</th>
							<th align="center" valign="middle">No.of days exceeded</th>-->

						<!--05-06-24 <th align="center" valign="middle" colspan="1">Actions</th>
					...
					<tbody style="background-color:#FFF;">
						...
						<tr>
							...
							<!--05-06-24 <td align="center" class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}"><a href="view_comp_det_admin.php?grievance_id={$grievance_id}">{$grievance_id}</a></td> -->
							...
							<td align="center">
								...
								{/if}
								{if $row.grievance_status_id eq '5'}

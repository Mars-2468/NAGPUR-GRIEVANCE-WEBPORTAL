...
<div class="boxed">
	...
	<div class="inner no-radius">
		<div id="area" class="table-responsive">
			<table id='data-table' cellpadding="3" cellspacing="0" border="1" class="display table-bordered table-striped table-condensed cf" width="100%">
				...
				<thead>
					...
					{foreach from=$dept_list key=dept_id item=row}
						...
						<tr>
							...
							<td align='center'><a href="corp_dept_empwise.php?app_type_id=1&dept_id={$dept_id}&status=0&f_date={$fdate}&t_date={$tdate}">{$dept_list[$dept_id]}</a></td>
							...
							<!-- <td align='center'> <a href="corp_grievance_analysis_dept_zone_inner_rep.php?dept_id={$dept_id}&zone_id={$ward_id}&status=all"> {$received} </a></td>
							<td align='center'> <a href="corp_grievance_analysis_dept_zone_inner_rep.php?dept_id={$dept_id}&zone_id={$ward_id}&status=received">{$completed} </a></td>
							<td align='center'> <a href="corp_grievance_analysis_dept_zone_inner_rep.php?dept_id={$dept_id}&zone_id={$ward_id}&status=pending">{$pending}</a> </td>
							<td align='center'> <a href="corp_grievance_analysis_dept_zone_inner_rep.php?dept_id={$dept_id}&zone_id={$ward_id}&status=resloved_insla">{$data_list[$dept_id][$ward_id]['completed']} </a> </td>
							<td align='center'> <a href="corp_grievance_analysis_dept_zone_inner_rep.php?dept_id={$dept_id}&zone_id={$ward_id}&status=resloved_beyondsla">{$data_list[$dept_id][$ward_id]['completed_be_sla']} </a></td> -->

							<td align='center'> <a href="corp_grievance_analysis_dept_zone_inner_rep.php?dept_id={$dept_id}&zone_id={$ward_id}&status=0"> {$received} </a></td>
							<td align='center'> <a href="corp_grievance_analysis_dept_zone_inner_rep.php?dept_id={$dept_id}&zone_id={$ward_id}&status=20">{$completed} </a></td>
							<td align='center'> <a href="corp_grievance_analysis_dept_zone_inner_rep.php?dept_id={$dept_id}&zone_id={$ward_id}&status=21">{$pending}</a> </td>
							<td align='center'> <a href="corp_grievance_analysis_dept_zone_inner_rep.php?dept_id={$dept_id}&zone_id={$ward_id}&status=22">{$data_list[$dept_id][$ward_id]['completed']} </a> </td>
							<td align='center'> <a href="corp_grievance_analysis_dept_zone_inner_rep.php?dept_id={$dept_id}&zone_id={$ward_id}&status=23">{$data_list[$dept_id][$ward_id]['completed_be_sla']} </a></td>
							{/foreach}
						</tr>
					{/foreach}
				...
				<tfoot>
					...
					{foreach from=$ward_list item=row2 key=ward_id}
					<!-- <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $tot_received[$ward_id] gt 0}<a href="corp_grievance_analysis_dept_zone_inner_rep.php?zone_id={$ward_id}&status=total_all">{$tot_received[$ward_id]}</a>{else}{$tot_received[$ward_id]}{/if}</td>
					<td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $tot_resolved[$ward_id] gt 0}<a href="corp_grievance_analysis_dept_zone_inner_rep.php?zone_id={$ward_id}&status=total_resolved">{$tot_resolved[$ward_id]}</a>{else}{$tot_resolved[$ward_id]}{/if}</td>
					<td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $tot_pending[$ward_id] gt 0}<a href="corp_grievance_analysis_dept_zone_inner_rep.php?zone_id={$ward_id}&status=total_pending">{$tot_pending[$ward_id]}</a>{else}{$tot_pending[$ward_id]}{/if}</td>
					<td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $resolved_sla[$ward_id] gt 0}<a href="corp_grievance_analysis_dept_zone_inner_rep.php?zone_id={$ward_id}&status=total_comp_insla">{$resolved_sla[$ward_id]}</a>{else}{$resolved_sla[$ward_id]}{/if}</td> -->

					<td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $tot_received[$ward_id] gt 0}<a href="corp_grievance_analysis_dept_zone_inner_rep.php?zone_id={$ward_id}&status=100">{$tot_received[$ward_id]}</a>{else}{$tot_received[$ward_id]}{/if}</td>
					<td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $tot_resolved[$ward_id] gt 0}<a href="corp_grievance_analysis_dept_zone_inner_rep.php?zone_id={$ward_id}&status=108">{$tot_resolved[$ward_id]}</a>{else}{$tot_resolved[$ward_id]}{/if}</td>
					<td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $tot_pending[$ward_id] gt 0}<a href="corp_grievance_analysis_dept_zone_inner_rep.php?zone_id={$ward_id}&status=800">{$tot_pending[$ward_id]}</a>{else}{$tot_pending[$ward_id]}{/if}</td>
					<td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $resolved_sla[$ward_id] gt 0}<a href="corp_grievance_analysis_dept_zone_inner_rep.php?zone_id={$ward_id}&status=400">{$resolved_sla[$ward_id]}</a>{else}{$resolved_sla[$ward_id]}{/if}</td>
		...
		<div>
			<center>
				<form action="corp_exporttoexcel.php" method="post">

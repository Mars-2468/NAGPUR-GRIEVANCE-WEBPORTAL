...
<div class="form-group">
 ...
 <div style="text-align:right;"><a href="level_dept_empwise.php?app_type_id=1&dept_id={$dept_id_sel}&status=0" class="btn btn-warning" onclick="history.go(-1);"><i class="fa fa-backward"></i> Back</a></div>

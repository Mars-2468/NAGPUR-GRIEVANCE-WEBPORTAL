	...
	<div >
		<div class="boxed">
                ...
                <div class="title-bar success">
                  <h4>Update Employee Service Map </h4>
 	...
 	<br>
			...
			<form   method="post" action="edit_standard_service_emp_map.php" name="manage_wards"  id="manage_wards" class="form-horizontal">
		...
		<br>
		<form   method="post" action="edit_standard_service_emp_map.php" name="manage_wards"  id="manage_wards" onSubmit="return validateForm()">

                ...
                <div class="row dashboard-stats">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[2].resolved_within_sla eq ''}0{else}<a href="services_boduppal.php?aptid=2&status=3&sla=1&user_type={$user_type}&ulbid={$ulbid}">{$data[2].resolved_within_sla}</a>{/if}</p>
                ...
                <div class="row dashboard-stats">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[1].resolved_within_sla eq ''}0{else}<a href="services_boduppal.php?aptid=1&status=3&sla=1&user_type={$user_type}&ulbid={$ulbid}">{$data[1].resolved_within_sla-2}</a>{/if}</p>
                                    <p class="text-muted no-margin"><span style="color:#000;">Completed with in SLA</span></p>
                                </div>
                            </section>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    ...
                                    <p class="text-muted no-margin"><span style="color:#000;">Under Progress Beyond SLS</span></p>
                                </div>
                            </section>
                        </div>

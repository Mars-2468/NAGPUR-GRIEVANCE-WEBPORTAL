		...
		<div class="col-lg-12">
			<div class="boxed">
                ...
                <div class="inner no-radius">
					<table class="display table-bordered table-striped table-condensed cf" >
									...
									<tr>
										<td>{counter}</td>
										<td>{if $status eq '1'}<a href="ulb_cat_wise.php?ulbid={$ulbid}&status={$status}&app_type_id={$app_type_id}">{$ulb_list[$ulbid]}</a>{else}<a href="ulb_dept_wise.php?ulbid={$ulbid}&status={$status}&app_type_id={$app_type_id}">{$ulb_list[$ulbid]}{/if}</a></td>
										<td>
						    
						    
						    
						   {if $status eq '1'}<a href="ulb_cat_wise.php?ulbid={$ulbid}&status={$status}&app_type_id={$app_type_id}">{$data[$ulbid].count}</a>{else}<a href="ulb_dept_wise.php?ulbid={$ulbid}&status={$status}&app_type_id={$app_type_id}">{$data[$ulbid].count}{/if}</a>

				...
				<div class="table-responsive">
					<table width="100%" height="35" border="1" cellpadding="0" cellspacing="0" class="someclass table-bordered table-striped table-condensed cf">
						...
						<tr>
							...
							<td align="left" valign="middle"> Grievance Id:</td>
							<td align="left" valign="middle"><b>{$data1.grievance_id}</b></td>
						</tr>
						{/if}
						{if $user_type eq 'U'}
						<tr>
						...
						<tr>
							...
							<td align="left" valign="middle" colspan="1">
								{$row.emp_name} ({$row.emp_mobile},{$user_id_list[$row.emp_id]}) , {$desg_list[$row.emp_desg]} , {$cs_data[$data1.cat3_id]}
							</td>
						...
						<tr>
							...
							<td align="left" valign="middle"> Disposal Status: </td>
							<td align="left" valign="middle">
								<select name='disposal_status' id='disposal_status' onchange="toggle(this.value);" required>
						...
						<tr>
							<td align="left" valign="middle"><span class="text-danger">*</span>Upload Image : </td>
							<td align="left" valign="middle">
						...
						<tr class="black">
							...
							<td align="left" valign="middle" colspan='3'>
								<select name='emp_dept' id="emp_dept" onchange="get_det(this.value);">
									<option value='0'>--Select Department--</option>
									{html_options options=$dept_list_all}
								</select>
...
<script>
	function fetchDesignations(deptId) {
		...
		var allids='deptId='+deptId+' empId='+emp_id+' wardId='+ward_id+' streetId='+street_id+' cat3Id='+cat3_id;
		//alert (allids);

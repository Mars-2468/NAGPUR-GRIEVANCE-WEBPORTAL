...
<div class="boxed">
	...
	<div class="inner no-radius">
		...
		<div id='comp_div'>
			<form method="post" action="save_manage_comp_sel.php" name="update_comp" id="update_comp" onsubmit="return validateForm()" enctype="multipart/form-data">
				...
				<div class="table-responsive">
					<table width="100%" height="35" border="1" cellpadding="0" cellspacing="0" class="someclass table-bordered table-striped table-condensed cf">
						<tr>
							...
							<td align="left" valign="middle">{$data1.address}</td>
						</tr>
						<tr>
						...
						<tr>
							<td align="left" valign="middle">Upload Image&nbsp;<span id="mandatory_symbol" style="display:none;color:red;font-size:20px;">*</span> : </td>
							<td align="left" valign="middle">
						...
						{/if}
						<tr>
							<td align="left" valign="middle"> <span id="trnsd_on">Transferred on:</span><span id="dipd_on">Disposed on&nbsp;<span style="color:red;font-size:20px;">*</span>:</span> </td>
							<td align="left" valign="middle">
							...
							<td align="left" valign="middle"> Action taken&nbsp;<span style="color:red;font-size:20px;">*</span>: </td>
							<td align="left" valign="middle">
								<textarea name="disposal_remarks" id="disposal_remarks" class="mandatory_field" data-field="Action taken" style="width:300px;height:100px;" data-type="sptext" onkeyup="funInputFielTypes(this)" required>{$row.disposal_remarks}</textarea>
								<div style="font-size:10px;color:red;" id="disposal_remarksX"></div>
							</td>
						</tr>

						<tr></tr>
						<td align="left" valign="middle"> Root Cause Anlysis&nbsp;<span style="color:red;font-size:20px;">*</span>: </td>
						<td align="left" valign="middle">
							<textarea name="rca" id="rca" style="width:300px;height:100px;" data-type="sptext" onkeyup="funInputFielTypes(this)" required>{$row.rca}</textarea>
							<div style="font-size:10px;color:red;" id="rcaX"></div>
						</td>
						<td align="left" valign="middle"> Corrective Action&nbsp;<span style="color:red;font-size:20px;">*</span>: </td>
						<td align="left" valign="middle">
							<textarea name="ca" id="ca" style="width:300px;height:100px;" data-type="sptext" onkeyup="funInputFielTypes(this)" required>{$row.ca}</textarea>
							<div style="font-size:10px;color:red;" id="caX"></div>
						</td>
						</tr>
						...
						<tr>
							<td bgcolor='#aeeff0' align="center" valign="middle" colspan='4'>
								<input type='submit' name='save' value='Submit' class="btn btn-success" id="submitBtn" disabled>

			...
			<table class="table table-striped table-bordered table-hover table-full-width" id="data-table">
				...
				<tbody>
					...
					<tr style="text-align:center;">
						<td>{counter}</td>
						<td class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}"><a href="ulb_responsetime_inner_rep.php?app_type_id=1&ulbid={$ulbid}&f_date={$fdate}&t_date={$tdate}"> {$ulb_list[$ulbid]} </a></td>

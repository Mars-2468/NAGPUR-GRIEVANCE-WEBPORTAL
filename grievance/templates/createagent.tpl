 ...
 <div class="row ">
	<div >
		<div class="boxed">
			...
			<form   method="post" action="createagent.php" name="manage_emp"  class="form-horizontal" onSubmit="return validateForm()">
				...
				<div class="form-group">
						<label class="control-label col-md-3">Select supervisor: <span class="required">* </span></label>
							<div class="col-md-8">
									<select name="supervisorId" class="form-control" required>
									    <option value="">-- select --</option>
									    {foreach from=$supervisorsList key=user_id item=row}
					...
					<div class="form-group">
						<label class="control-label col-md-3">Agent Name: <span class="required">* </span></label>
							<div class="col-md-8">
									<input name='emp_name' type="text" id="emp_name" size="30" maxlength='70' data-required="1" class="form-control" required="required"/>
							</div>
					</div>
					...
					<div class="form-group">
						<label class="control-label col-md-3">Mobile: <span class="required">*</span></label>
							<div class="col-md-8">
									 <input name='emp_mobile' maxlenght='10' type="text" id="mobile" maxlength='10'  class="form-control num" onblur="check_mobile(this.value)" required="required"/>
							</div>
					</div>
					...
					<div class="form-group">
						<label class="control-label col-md-3"> User name <span class="required">* </span></label>
							<div class="col-md-8">
									<input type="text" name='username' id="username" class="form-control" onblur="checkusername(this.value)" required autocomplete='off'/>
									<input type="hidden" id="usernameStatus" value="">
							</div>
					</div>
			...
			<div class="boxed">
                ...
                <div class="inner no-radius">
					<table class="table table-striped table-bordered table-hover table-full-width" id="example">
									...
									<tr>
										<td>{counter}</td>
										<td>{$supervisorsnames[$row.updated_by]}</td>
										<td>{$row.emp_name}</td>
										...
										<td>
										    <form action="updateagent.php" method="post">
										        ...
										        <input type="submit" name="update" class="btn btn-warning" value="Edit">
										    </form>

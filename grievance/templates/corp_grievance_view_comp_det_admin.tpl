...
<div style="text-align:right;"><button class="btn btn-warning" onclick="location.href='corp_total_streetwise_complaints.php?ulbid={$ulbid}&app_type_id=1&page={$page}&ward_id={$ward_id}&status={$status}&f_date={$f_date}&t_date={$t_date}'"><i class="fa fa-backward"></i> Back</button></div>

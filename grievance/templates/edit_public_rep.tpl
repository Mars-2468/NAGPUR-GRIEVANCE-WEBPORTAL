	...
	<div class="col-lg-12">
		<div class="boxed">
                ...
                <div class="title-bar success">
                  <h4>Update Public Representatives:</h4>
			...
			<form name='add_council' id="add_council" method='POST' action='edit_public_rep.php' class="form-horizontal">
...
<form   method="POST" action="edit_public_rep.php" enctype="multipart/form-data" onSubmit="return validateForm();">
...
<input type="hidden" name="img_url" value="{$data.img_url}">
					...
					<div class="form-group">
						<label class="control-label col-md-3">Mobile No: <span class="required">* </span></label>
							<div class="col-md-8">
						<input type="text" name="mobile" id="mobile" value="{$data.mobile}" class="form-control" maxlength="10">
							</div>
					</div>
					...
					<div class="form-actions fluid">
						...
						<a href=add_public_rep.php><button type="button" class="btn btn-danger">Back</button></a>
						</div>
					</div>
				</div>

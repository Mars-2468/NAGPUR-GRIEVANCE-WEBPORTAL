                ...
                <div class="card bg-success">
                    <div class="card-body p-4">
                        ...
                        <h1 class="countdown_first">
                            <!--01-04-24 <b><a href="corp_grievance_month_inner_report.php?status=1" class="text-white" style="text-decoration: none">{$data['last_week_records']}</a></b> -->
                            <b><a href="corp_grievance_month_inner_report.php?status=109" class="text-white" style="text-decoration: none">{$data['last_week_records']}</a></b>
                        </h1>
                        <div class="icon">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="card bg-info">
                    <div class="card-body p-4">
                        ...
                        <h1 class="countdown_first">
                            <!--01-04-24 <b><a href="corp_grievance_month_inner_report.php?status=2" class="text-white" style="text-decoration: none">{$data['greater_30days_records']}</a></b> -->
                            <b><a href="corp_grievance_month_inner_report.php?status=110" class="text-white" style="text-decoration: none">{$data['greater_30days_records']}</a></b>
                        </h1>

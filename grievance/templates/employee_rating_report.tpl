					...
					<table id='example' cellpadding="3" cellspacing="0" border="1" class="display table-bordered table-striped table-condensed cf" width="100%">
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="employees_rating_list_report.php?rating_no={$rating_no}&department_id={$department_id}&f_date={$fdate}&t_date={$tdate}">{$row.empcnt}</a></td>									
							</tr>
						
							{/foreach}
						</tbody>
						<tfoot>
							<td align='center' colspan="2"><strong>Total Employees</strong></td>

...
<table width="100%" border="1" cellspacing="0" cellpadding="0" style="font-size:13px;" class="display table-bordered table-striped table-condensed cf" id='example'>
  ...
  <tr>
    ...
    <td align="center">{$comp_resolved[$ulbid].withinsla + $comp_resolved[$ulbid].beyondinsla + $comp_pending[$ulbid].withinsla + $comp_pending[$ulbid].beyondinsla}</td>
    <td align="center">{$comp_resolved[$ulbid].withinsla}</td>
    <td align="center">{$comp_resolved[$ulbid].beyondinsla}</td>
    
    <td align="center"> {$comp_pending[$ulbid].withinsla}</td>
    <td align="center"> {$comp_pending[$ulbid].beyondinsla}</td>
   
    <td align="center">{$service_resolved[$ulbid].withinsla + $service_resolved[$ulbid].beyondinsla + $service_pending[$ulbid].withinsla + $service_pending[$ulbid].beyondinsla}</td>
    <td align="center">{$service_resolved[$ulbid].withinsla}</td>
    <td align="center">{$service_resolved[$ulbid].beyondinsla}</td>
   
    <td align="center"> {$service_pending[$ulbid].withinsla}</td>
    <td align="center"> {$service_pending[$ulbid].beyondinsla}</td>

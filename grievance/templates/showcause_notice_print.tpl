...
<div class="row">
	<div>
		<div class="boxed">
			<!-- Title Bart Start -->
			<!-- 09-08-2024 <div class="title-bar blue">
				<h4>Warning Messages</h4>
				<a href="ajax_dashboard.php" class="btn btn-warning"><i class="fa fa-backward"></i> Back</a>
			</div> -->
			<div class="title-bar blue" style="display: flex; justify-content: space-between; align-items: center;">
				...
				<a href="show_cause_notice.php?active=tr-clmn" class="btn btn-warning" style="margin-left: auto;"><i class="fa fa-backward"></i> Back</a>
			</div>
			<!-- Title Bart End -->
			<div class="inner no-radius">
				<div style="padding:20px">
					<div>
						<img src="https://web.nagpurnmc.in/grievance/images/nagpurlg.png" style="height:50%;width:15%">
					</div><br>

...
<form name='track_app' method='POST' action='track_app.php' onSubmit="return validateForm();" >
...
<br><br>
 <div class="container">
        ...
        <div class="label_div">Acknowledgement No</div> 
<div class="input_container">
       

                  <input type="text" id="actno"  name="actno"  class="chr" value="{$actno_sel}" autocomplete="off">
</div>
...
<br>
<br>
<center width="50%"><input type='submit' name='save' value='Track' class="mybtn"> </center>

 ...
 <div class="row ">
	<div class="col-lg-12">
 	...
 	<br>
			...
			<form   method="post" action="update_comptest.php" name="manage_wards"  id="manage_wards" class="form-horizontal">
		...
		<br>
		<form   method="post" action="update_comptest.php" name="manage_wards"  id="manage_wards" onSubmit="return validateForm()">

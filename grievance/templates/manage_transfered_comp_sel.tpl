	...
	<div class="inner no-radius">
		...
		<div id='comp_div'>
			<form method="post" action="manage_transfered_comp_sel.php" name="update_comp" id="update_comp" onsubmit="return validateForm()" enctype="multipart/form-data">
				...
				<input type="hidden" name="prev_aptid" value="{$prev_aptid}">
				<input type="hidden" name="prev_user_type" value="{$prev_user_type}">
				<input type="hidden" name="prev_status" value="{$prev_status}">
				<input type="hidden" name="prev_sla" value="{$prev_sla}">
				<input type="hidden" name="prev_f_date" value="{$prev_f_date}">
				<input type="hidden" name="prev_t_date" value="{$prev_t_date}">

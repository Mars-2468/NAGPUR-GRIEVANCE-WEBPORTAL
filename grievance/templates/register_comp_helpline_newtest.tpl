	...
	<div>
		<div class="boxed">
			...
			{/if}
                ...
                <form action="register_comp_helpline.php" method="post" id="form1">
...
<div class="row">
	<div>
		...
		<div class="inner no-radius" style="background-color: #FFF; padding: 15px;">
			<form action="save_register_comp_helpline.php" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
				<span id="form1"></span>
				<span id="form2"></span>
			</form>
		</div>

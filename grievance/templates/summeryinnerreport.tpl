...
<CENTER><strong>VIEW {if $app_type_id eq '1'} COMPLAINTS {else} SERVICE{/if} DETAILS</strong></CENTER>
    ...
    <div style="width:100%; overflow:scroll; font-size:11px;">
	    <table width="97%" border="1" cellspacing="0" cellpadding="0" class="" id="example" width="100%">
	    <thead>
	        <tr style="background-color:#2c3e50; color:#FFF;">
	            <th align="center" valign="middle" colspan="30">ULB Name: {$ulblist[$ulbid]}, {$comptypelist[$aptid]}, From : {$fdate} -  {$tdate}</th>
	       </tr>
	    <tr style="background-color:#2c3e50; color:#FFF;">

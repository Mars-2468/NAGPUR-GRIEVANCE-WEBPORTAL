...
<div class="form-group">
  <label class="control-label col-sm-5" for="usr">Reference No:</label>
  <div class="col-sm-7">
...
<div class="form-group">
  ...
  <div class="col-sm-7">
  <input type="text" class="phone-group form-control demoInputBox" id="datepicker"  name="mobile" value="{$mobile}">
  </div>
</div>
</div>   
  ...
  <div class="col-md-4" align="center" style="margin-top:1px;"><input name="search" type="submit" class="btn btn-success" value="SEARCH"> </div>   

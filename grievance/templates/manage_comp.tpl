...
<div class="boxed">
    ...
    <div class="inner no-radius table-responsive">
            ...
            <form action="" method="post">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
						<input type="text" class="form-control form-control-inline input-medium" name="ref_no"  id="ref_no" placeholder="Enter Complaint ID" value="{$ref_no}" autocomplete="off" data-type="dnumber" onkeyup="funInputFielTypes(this)">
						<div style="font-size:10px;color:red;" id="ref_noX"></div>
						</td>
                        <td>
						<input type="text" class="form-control form-control-inline input-medium" name="applicant_name" id="applicant_name" placeholder="Enter Applicant Name" value="{$applicant_name}" autocomplete="off" data-type="text" onkeyup="funInputFielTypes(this)">
						<div style="font-size:10px;color:red;" id="applicant_nameX"></div>
						</td>
                        <td>
						<input type="text" class="form-control form-control-inline input-medium" name="mobile" id="mobile" placeholder="Enter Mobile Number" value="{$mobile}" autocomplete="off" data-type="text" onkeyup="funInputFielTypes(this)">
                        ...
                        <td><input type="submit" name="search" value="Search" class="btn btn-success btn-sm" id="submitBtn" disabled></td>
                    </tr>
                </table>
            </form>
        </div>
        ...
        <hr>
{if $user_type eq 'U'}
        <form name='manage_comp_det' id='manage_comp_det' action='manage_comp_sel.php' method='POST'>
            <div id="demo">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {if $ulbid eq '207'}
									...
									{else}
										<td style="text-align: center;">{$grievance_id}-{$row.grievance_at_emp_level}</td>
									{/if}
                                {else}
									<td style="text-align: center;">{$grievance_id}-{$row.grievance_at_emp_level} </td>
                                {/if}                                                
		...
		{if $user_type eq 'E'}
        <form name='manage_comp_det_emp' id='manage_comp_det_emp' action='manage_transfered_comp_sel.php' method='POST'>
            <div id="demo">
                <div class="table-responsive" style="width:100%; overflow:scroll;">
                    <table cellpadding="3" cellspacing="0" border="1" class="table table-striped table-bordered table-hover table-full-width" id="data-table" width="100%">
                        <thead>
                        ...
                        <tbody>
                            {foreach from=$data key=grievance_id item=row}
							{if !in_array($row.grievance_status_id,[5,10]) }
                            <input type="hidden" name="app_type_id" value="{$row.app_type_id}">
                            <input type="hidden" name="cs_id" value="{$row.cat3_id}">
                            <tr>
                                <td style="text-align: center;">{counter}</td>
                                ...
                                <td style="text-align: center;"><input type='radio' name='grievance_id' value='{$grievance_id}' onclick="get_comp_det_emp(this.value)"></td>
                            </tr>
							{/if}
                            {/foreach}
                        </tbody>

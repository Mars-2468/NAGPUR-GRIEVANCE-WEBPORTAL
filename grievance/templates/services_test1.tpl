...
<div class="form-group">
  ...
  <div class="col-md-4 col-md-offset-4" align="center" style="margin-top:1px;"><input name="search" type="submit" class="btn btn-success" value="SEARCH"> </div>   
...
<div  id="div_print" style="border:#999999 0px solid;margin-top:20px;">

 ...
 <div class="row ">
	<div class="col-lg-12">
 	...
 	<br>
			...
			<form   method="post" action="merge_services.php" name="manage_wards"  id="manage_wards" class="form-horizontal" onSubmit="return validateForm()">
		...
		<div class="row">		
				...
				{if isset($ulb_list)}
				<br><br><br>
				<form action="merge_services.php" method="post">

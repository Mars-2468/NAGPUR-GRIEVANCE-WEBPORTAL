		...
		<div class="inner no-radius">
			...
			<form method="POST" class="form-horizontal">
				...
				<div class="button-container">
					...
					<!-- <a href="corp_show_cause_notice.php?active=tr-clmn" class="btn btn-warning" onclick="history.go(-1);">
						...
						<tbody>
							{foreach from=$data key=warning_id item=row}
								<tr>
									...
									<td align='center'>
										<a href="corp_showcause_notice_print.php?warning_id={$row.warning_id}&emp_id={$row.emp_id}" target="_blank" style="color: red;font-size: 20px;font-weight:bolder;"><b><i class="fa fa-eye" aria-hidden="true"></i></b></a>
									</td>
								</tr>
							{/foreach}
						</tbody>

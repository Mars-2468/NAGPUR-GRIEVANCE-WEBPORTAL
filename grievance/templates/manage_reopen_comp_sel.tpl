...
<div class="boxed">
	...
	<div class="inner no-radius">
		...
		<div id='comp_div'>
			<form method="post" action="manage_reopen_comp_sel.php" name="update_comp" id="update_comp" onsubmit="return validateForm()" enctype="multipart/form-data">
					...
					<table width="100%" height="35" border="1" cellpadding="0" cellspacing="0" class="someclass table-bordered table-striped table-condensed cf">
						...
						<tr>
							...
							<td align="left" valign="middle">
								<select name='disposal_status' id='disposal_status' onchange="toggle(this.value);" required="required">
									...
									{html_options options=$present_grievance_status_list selected=$row.disposal_status}
								</select>

								<?php print_r($present_grievance_status_list); ?>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td bgcolor='#aeeff0' align="center" valign="middle" colspan='4'>
								...
								<a href="rep_comp_dept_abs_comp.php?active=tr-totpending-reopen-total" class="btn btn-info"><i class="fa fa-backward"></i> Back</a>
							</td>
						</tr>
					</table>
				</div>

...
<div id="div_print" class="cap_font" style="border:#999999 0px solid;">
	...
	<div class="tab-content">
		<div class="d-flex justify-content-between align-items-center" style="padding:15px;margin:10px;">
			<div>
		...
		<div class="tab-pane active table-responsive">
			...
			<table width="97%" border="1" cellspacing="0" cellpadding="0" class="display table-bordered table-striped table-condensed cf" id="data-table">
				...
				<tr>
					...
					<td>{$cs_list[$cs_id]}</td>
					<td align="center" valign="middle">{if $data2[$cs_id].pendingforapproval neq ''}<a href="corp_origin.php?ulbid={$ulbid}&originid={$origin_id}&cat3_id={$cs_id}&grievance_status_id=1" target="_blank">{$data2[$cs_id].pendingforapproval} </a>{else}-{/if}</td>
					<td align="center" valign="middle">{if $data2[$cs_id].pending neq ''}<a href="corp_origin.php?ulbid={$ulbid}&originid={$origin_id}&cat3_id={$cs_id}&grievance_status_id=2" target="_blank">{$data2[$cs_id].pending} </a>{else}-{/if}</td>
					<td align="center" valign="middle">{if $data2[$cs_id].completed neq ''}<a href="corp_origin.php?ulbid={$ulbid}&originid={$origin_id}&cat3_id={$cs_id}&grievance_status_id=3" target="_blank">{$data2[$cs_id].completed} </a>{else}-{/if}</td>
					...
					<!--15-06-2024 <td align="center" valign="middle"><a href="corp_origin.php?ulbid={$ulbid}&originid={$origin_id}&cat3_id={$cs_id}&grievance_status_id=1" target="_blank">{if $data2[$cs_id].pendingforapproval eq ''} - {else}{$data2[$cs_id].pendingforapproval}{/if}</a></td>
					<td align="center" valign="middle"><a href="corp_origin.php?ulbid={$ulbid}&originid={$origin_id}&cat3_id={$cs_id}&grievance_status_id=2" target="_blank">{if $data2[$cs_id].pending eq ''} - {else}{$data2[$cs_id].pending}{/if}</a></td>
					<td align="center" valign="middle"><a href="corp_origin.php?ulbid={$ulbid}&originid={$origin_id}&cat3_id={$cs_id}&grievance_status_id=3" target="_blank">{if $data2[$cs_id].completed eq ''} - {else}{$data2[$cs_id].completed}{/if}</a></td>
				...
				<tr>
					...
					<td align="center" class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}" valign="middle"><strong>{if $data2.pendingforapproval eq ''} 0 {else}<a href="corp_Totalorigin_mayor.php?ulbid={$ulbid}&originid={$origin_id}&status=100" target="_blank">{$data2.pendingforapproval}</a>{/if}</strong></td>
					<td align="center" class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}" valign="middle"><strong>{if $data2.pending eq ''} 0 {else}<a href="corp_Totalorigin_mayor.php?ulbid={$ulbid}&originid={$origin_id}&status=200" target="_blank">{$data2.pending} </a>{/if}</strong></td>
					<td align="center" class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}" valign="middle"><strong>{if $data2.completed eq ''} 0 {else}<a href="corp_Totalorigin_mayor.php?ulbid={$ulbid}&originid={$origin_id}&status=300" target="_blank">{$data2.completed} </a>{/if}</strong></td>
					<td align="center" class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}" valign="middle"><strong>{if $data2.total eq ''} 0 {else}<a href="corp_Totalorigin_mayor.php?ulbid={$ulbid}&originid={$origin_id}&status=400" target="_blank">{$data2.total} </a>{/if}</strong></td>
				</tr>

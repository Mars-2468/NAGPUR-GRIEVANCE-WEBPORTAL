	...
	<div>
		<div class="boxed">
			...
			<div class="inner no-radius">
				<form method="post" action="" class="form-horizontal" name="field_visitor_form" onSubmit="return validateForm()" enctype="multipart/form-data">
...
<div align='center'>
  <input type="button"  onclick="tableToExcel('Remarks/Rating Report', 'Sheet')" value="Export To Excel" class="btn btn-success">

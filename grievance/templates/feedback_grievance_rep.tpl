...
<div  id="div_print" style="border:#999999 0px solid;">
     ...
     <div class="title-bar white">
                  <center>ULB: {$ulbname}</center>
                  <center>Department: {$deptname}</center>
                  <center>Employee : {$empname}</center>
...
<CENTER><strong>VIEW {if $app_type_id eq '1'} COMPLAINTS {else} SERVICE {/if} DETAILS</strong></CENTER>
    ...
    <div style="width:100%; overflow:scroll;">
		...
		<th align="center" valign="middle">Feed back option</th>
		<th align="center" valign="middle">Feed back Comment</th>
		...
		<tr>
			...
			<td>{$feedbackoptions[$row.rating_no].0}- {$feedbackoptions[$row.sub_option_id]}</td>
			<td>{$row.comment_desc }</td>
			
			<td>
			    <!--<a href="file_movment.php?gid={$grievance_id}">Click here</a>-->
			    <a href="view_comp_det_admin.php?grievance_id={$grievance_id}">Click here</a>

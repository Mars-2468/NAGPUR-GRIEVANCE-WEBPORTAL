				...
				<form method="post" action="save_category.php" name="category" class="form-horizontal" onSubmit="return validateForm()">
					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input name="description" type="text" id="description" size="30" maxlength='255' data-required="1" placeholder="Enter Category Name" class="form-control" autocomplete="off" data-type="text" onkeyup="funInputFielTypes(this)" required="required" />
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<textarea name='telugu_description' id='telugu_description' rows="2" cols="50" data-required="1" class="form-control" placeholder="Enter Category In Marathi" autocomplete="off" data-type="sptext" onkeyup="funInputFielTypes(this)" required="required"></textarea>
						...
						<div class="form-group" id="ref">
							...
							<div class="col-md-4">
								<input type="text" class="form-control" name="captcha" id="captcha" placeholder="Enter Captcha" autocomplete="off" required="required" style="border-radius: 3px;" data-type="dcaptcha" minlength="4" maxlength="4" onkeyup="funInputFielTypes(this)" onpaste="return false;">
								<input type="hidden" name="code" value="{$code}">
									<div style="font-size:10px;color:red;" id="captchaX">
									</div>
							</div>
						</div>
						...
						<div class="form-actions fluid">
							<div class="col-md-offset-5 col-md-9">
								<button type="submit" class="btn btn-info" name="save" value="Add / Update Category" id="submitBtn" disabled>Submit</button>

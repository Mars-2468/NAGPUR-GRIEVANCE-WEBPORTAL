...
{/literal}
 ...
 <a href="http://www.municipalservices.in/service_emp_map_report_street_wise.php" target="_blank" class="btn-link" style="color:#FFF;"><span class="fa fa-clipboard"></span> Click Here  To Employee Service Mapping Report</a></button>
 </center>
 	<br>
			
			<form   method="post" action="employee_standard_service_map.php" name="manage_wards"  id="manage_wards" class="form-horizontal" onSubmit="return validateForm()">
    ...
    <div >
		...
		<br>
		<form   method="post" action="employee_standard_service_map.php" name="manage_wards"  id="manage_wards" onSubmit="return validateForm()">

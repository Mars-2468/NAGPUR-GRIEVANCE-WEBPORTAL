                ...
                <div class="row dashboard-stats">
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first"> {if $data[1].total_received eq ''}0{else}<a href="services.php?aptid=1&status=0&user_type={$user_type}&sla=0">{$data[1].total_received}</a>{/if}</p>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[1].resolved_within_sla eq ''}0{else}<a href="services.php?aptid=1&status=3&sla=1&user_type={$user_type}">{$data[1].resolved_within_sla}</a>{/if}</p>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[1].resolved_beyond_sla eq ''}0{else}<a href="services.php?aptid=1&status=3&sla=2&user_type={$user_type}">{$data[1].resolved_beyond_sla}</a>{/if}</p>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[1].pending_within_sla eq ''}0{else}<a href="services.php?aptid=1&status=2&sla=1&user_type={$user_type}">{$data[1].pending_within_sla}</a>{/if}</p>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[1].pending_beyond_sla eq ''}0{else}<a href="services.php?aptid=1&status=2&sla=2&user_type={$user_type}">{$data[1].pending_beyond_sla}</a>{/if}</p>
                         ...
                         <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[1].fin_implication eq ''}0{else}<a href="services.php?aptid=1&status=500&user_type={$user_type}">{$data[1].fin_implication}</a>{/if}</p>
                ...
                <div class="row dashboard-stats">
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[2].total_received eq ''}0{else}<a href="services.php?aptid=2&status=0&user_type={$user_type}&sla=0">{$data[2].total_received}</a>{/if}</p>
                                    <p class="text-muted no-margin "><span style="color:#000;">Received</span></p>
                                </div>
                            </section>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[2].pendingforapproval eq ''}0{else}<a href="pending_approval.php?grievance_status_id=1&aptid=2">{$data[2].pendingforapproval}</a>{/if}</p>
                                    <p class="text-muted no-margin "><span style="color:#000;">Pending for Approval</span></p>
                                </div>
                            </section>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[2].resolved_within_sla eq ''}0{else}<a href="services.php?aptid=2&status=3&sla=1&user_type={$user_type}">{$data[2].resolved_within_sla}</a>{/if}</p>
                                    <p class="text-muted no-margin "><span style="color:#000;">Completed with in SLA</span></p>
                                </div>
                            </section>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[2].resolved_beyond_sla eq ''}0{else}<a href="services.php?aptid=2&status=3&sla=2&user_type={$user_type}">{$data[2].resolved_beyond_sla}</a>{/if}</p>
                                    <p class="text-muted no-margin "><span style="color:#000;">Completed Beyond SLA</span></p>
                                </div>
                            </section>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[2].pending_within_sla eq ''}0{else}<a href="services.php?aptid=2&status=2&sla=1&user_type={$user_type}">{$data[2].pending_within_sla}</a>{/if}</p>
                                    <p class="text-muted no-margin "><span style="color:#000;">Under Progress with in SLA</span></p>
                                </div>
                            </section>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[2].pending_beyond_sla eq ''}0{else}<a href="services.php?aptid=2&status=2&sla=2&user_type={$user_type}">{$data[2].pending_beyond_sla}</a>{/if}</p>
                                    <p class="text-muted no-margin "><span style="color:#000;">Under Progress Beyond SLA</span></p>
                                </div>
                            </section>
                        </div>
						 ...
						 <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[2].fin_implication eq ''}0{else}<a href="services.php?aptid=2&status=500&user_type={$user_type}">{$data[2].fin_implication}</a>{/if}</p>
                                    <p class="text-muted no-margin "><span style="color:#000;">Financial Implication</span></p>
                                </div>
                            </section>
                        </div>
				 ...
				 <div class="row dashboard-stats">
                        <div class="col-md-4 col-sm-6">
						 ...
						 <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first"> {if $origin_rep[1].count eq ''}0{else}<a href="cat_origin.php?originid=1">{$origin_rep[1].count}</a>{/if}</p>
						...
						<div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first"> {if $origin_rep[3].count eq ''}0{else}<a href="cat_origin.php?originid=3">{$origin_rep[3].count}</a>{/if}</p>

	...
	<div class="col-lg-12">
		<div class="boxed">
                ...
                <div class="title-bar success">
                  <h4>Update Municipal Council:</h4>
			...
			<form name='add_council' id="add_council" method='POST' action='edit_council.php' class="form-horizontal">
...
<form   method="POST" action="edit_council.php" enctype="multipart/form-data" onSubmit="return validateForm();">
...
<input type="hidden" name="img_url" value="{$data.img_url}">
					...
					<div class="col-md-8">
					<img src="{$data.img_url}" width="30%" height="15%">
							</div>
					</div>
					...
					<div class="form-actions fluid">
						...
						<a href="add_council.php"><button type="button" class="btn btn-danger">Back</button></a>
						</div>
					</div>
				</div>

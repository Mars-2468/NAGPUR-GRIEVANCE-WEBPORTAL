...
<form name='appliaction_rec_status' method='POST' action='appliaction_rec_status.php' onSubmit="return validateForm();" >

<div class="my_heading">Application Status</div>
<div id="area">
<br><br>
 <div class="container">
...
<br>
{if isset($apprec_sel)}
 <table width='97%' cellspacing="0"  border="1" cellpadding="5">
<thead>
...
<td><input type='BUTTON' name='save' Onclick="window.location.href='status_update.php?id={$row.apprec_id}'" value='Update Value' style="background-color:#991f36; color:#FFF; border-radius:8px; cursor:pointer;"></td>
 </tr>

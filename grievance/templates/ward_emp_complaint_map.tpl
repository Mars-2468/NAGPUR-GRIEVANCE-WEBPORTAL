			...
			<div class="inner no-radius">
				...
				<form method="post" action="ward_emp_complaint_map.php" name="manage_wards" id="manage_wards" class="form-horizontal" onSubmit="return validateForm()">
					...
					<div class="form-body">
						...
						<div class="col-md-6">
							<select class="form-control" name="cs_id[]" id="cs_id" multiple="multiple" size="10" style="width:100%" autocomplete="off">
						...
						<div class="col-md-6">
							...
							<select class="form-control" name="dept_id" id="dept_id" onchange="get_employees(this.value)" style="margin-bottom:15px;" autocomplete="off">
								<option value="0">--- Select Department ---</option>
								{html_options options=$dept_list selected=$dept_id_sel}
							</select>

							<label>Level-1 <span style="margin-left:2px;"> : </span> </label>
							<select class="form-control" name="emp_id" id="emp_id" style="margin-bottom:15px;" autocomplete="off">
							...
							<select class="form-control" name="emp_id2" id="emp_id2" style="margin-bottom:15px;" autocomplete="off">
							...
							<select class="form-control" name="emp_id3" id="emp_id3" style="margin-bottom:15px;" autocomplete="off">
							...
							<select class="form-control" name="emp_id4" id="emp_id4" style="margin-bottom:15px;" autocomplete="off">
							...
							<tbody>
								<tr>
									<td>
										...
										<br>
										<div style="clear:both;color:red; font-weight:bold;">{$cs_list[$cs_id][{$row2}]}{$cs_data[$row2]}</div>
										<br>
										<table class="table-bordered table-striped table-condensed cf" id="map-data-table" width="100%">
											<thead>
											...
											<tr>
												<td align="center" colspan="7" style="font-size:medium;color:brown;"><b>{$ward_list2[$cs_id][$ward_id2]}</b></td>
											</tr>
											{foreach from=$street_list2[$cs_id][$ward_id2] item=row4 key=street_id2}
											<tr>
												<th style="text-align: center;"></th>
												<th style="text-align: center;">{$street_list2[$cs_id][$ward_id2][$street_id2]}</th>

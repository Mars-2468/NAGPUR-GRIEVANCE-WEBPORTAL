...
<CENTER><strong>FEEDBACK DETAILS</strong></CENTER>
	...
	<tr>
										    <td>Total:</td>
										    <td>--</td>
										    <td>{$response_time['grand_total_complaints']}</td>
										   <td>{$response_time['grand_c_avg_res_time']}</td>
										    <td>{$response_time['grand_total_services']}</td>
										     <td>{$response_time['grand_s_avg_res_time']}</td>
										</tr>
									</tfoot>
			</table>

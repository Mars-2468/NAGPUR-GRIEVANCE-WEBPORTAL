 ...
 <div class="row ">
	<div >
		<div class="boxed">
			...
			<form   method="post" action="createsupervisor.php" name="manage_emp"  class="form-horizontal" onSubmit="return validateForm()">
				...
				{/if}
					...
					<div class="form-group">
						<label class="control-label col-md-3"> User name <span class="required">* </span></label>
							<div class="col-md-8">
									<input type="text" name='username' id="username" class="form-control" onblur="checkusername(this.value)" required/>

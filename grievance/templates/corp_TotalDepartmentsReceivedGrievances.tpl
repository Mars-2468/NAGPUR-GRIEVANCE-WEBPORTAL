...
<div class="" style="margin-top: -45px;">
	...
	<div class="boxed">
		<div class="title-bar blue">
			...
			<div style="text-align:right;"><a href="corp_rep_comp_dept_abs_comp.php?active=tr-clmn" class="btn btn-warning" onclick="history.go(-1);"><i class="fa fa-backward"></i> Back</a></div>
		</div>
...
<div class="boxed">
		<div class="title-bar blue">
			<h4>VIEW RECEIVED COMPLAINT DETAILS</h4>
		</div>
		<div class="inner no-radius">
		<div id="div_print" style="border:#999999 0px solid;">
		
			<div id="area" class="table-responsive" style="width:100%;">
				<div >
					<table id='example' cellpadding="3" cellspacing="0" border="1" class="display table-bordered table-striped table-condensed cf" width="100%">
						...
						<tbody>
							...
							<tr>
								<td align='center'>{$pageNumbers++}</td>
...
<!-- ********************************Downloading page formats start********************************** -->

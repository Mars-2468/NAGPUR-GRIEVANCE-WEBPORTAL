		...
		<div class="inner no-radius">
			<form method="POST" class="form-horizontal">
				...
				<div class="button-container">
					...
					<a href="corp_dept_empwise.php?app_type_id=1&dept_id={$dept_id_sel}&status=0" class="btn btn-warning" onclick="history.go(-1);">
						...
						<tbody>
							...
							<tr>
								...
								<td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">
									<a href="corp_view_comp_det_admin.php?grievance_id={$grievance_id}&app_type_id=1&emp_id={$emp_id}&status={$status}&dept_id={$dept_id}&f_date={$f_date}&t_date={$t_date}" target="_blank">

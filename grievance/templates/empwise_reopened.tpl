		...
		<div>
			<div class="boxed">
                ...
                <div class="title-bar white">
                  <h4>Department wise report -{$dept_list[$dept_id]} - {$ulb_list[$ulbid]}</h4>
                ...
                <div class="inner no-radius">
					<table class="table table-striped table-bordered table-hover table-full-width" id="data-table" width="100%">
									...
									<tbody>
									    ...
									    <tr>
									        <th>{counter}</th>
									        <th><a href="grievances_reopened.php?ulbid={$ulbid}&app_type_id={$app_type_id}&dept_id={$dept_id}&emp_id={$emp_id}&status={$status}" target="_blank">{$emp_list[$emp_id]}</a></th>
									        <th>{$data[$emp_id].count}</th>
									    </tr>
									    {/foreach}
									</tbody>
									<tfoot>

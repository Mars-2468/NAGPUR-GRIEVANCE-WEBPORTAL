		...
		<div class="col-lg-12">
			<div class="boxed">
                ...
                <div class="title-bar white">
                  <h4>ULB Wise Report &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ULB Name: {$ulbname}</h4>
                ...
                <div class="inner no-radius">
					<table class="display table-bordered table-striped table-condensed cf" id="data-table">
									...
									<tr>
										<td>{counter}</td>
										<td><a href="cdma_empwise_report.php?ulbid={$ulbid_sel}&status={$status}&app_type_id={$app_type_id}&dept_id={$ulbid}">{$dept_list[$ulbid]}</a></td>
										<td>
						    
						    <a href="cdma_empwise_report.php?ulbid={$ulbid_sel}&status={$status}&app_type_id={$app_type_id}&dept_id={$ulbid}">{$data[$ulbid].count} </a>

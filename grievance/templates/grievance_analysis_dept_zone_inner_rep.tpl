		...
		<div class="inner no-radius">
			...
			<form method="POST" class="form-horizontal">
				...
				<div class="button-container">
					...
					<a href="grievance_analysis_dept_zone.php" class="btn btn-warning" onclick="history.go(-1);">
						<i class="fa fa-backward"></i> Back
					</a>
				</div>
			</form>
			<!--18-06-2024 <div style="text-align:right;"><a href="grievance_analysis_dept_zone.php" class="btn btn-warning" onclick="history.go(-1);"><i class="fa fa-backward"></i> Back</a></div> -->
		</div>
					...
					<table width="100%" border="1" cellspacing="0" cellpadding="0" class="display table-bordered table-striped table-condensed cf" id="data-table">
						<caption style="caption-side:top; text-align:center;font-size:16px;">
							<b>
								...
								{elseif $status eq '20' || $status eq '108' && $user_type eq 'U' }
								...
								{elseif $status eq '21' || $status eq '800' && $user_type eq 'U' }
								...
								{elseif $status eq '22' || $status eq '400' && $user_type eq 'U' }
								...
								{elseif $status eq '23' || $status eq '500' && $user_type eq 'U' }

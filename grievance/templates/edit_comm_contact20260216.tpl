	...
	<div class="col-lg-12">
		<div class="boxed">
			...
			{/if}
				...
				<form name='' method='POST' action='update_comm_contact.php' class="form-horizontal" onSubmit="return validateForm1()"  enctype="multipart/form-data">
					...
					<div class="form-group">						
						...
						<div class="col-md-4">
							<input name="mobile" type="text" id="mobile1" data-required="1" class="form-control int1 num" value="{$data.mobile}" onblur="validation()" placeholder="Enter Mobile Number" autocomplete="off" data-type="mobile" onkeyup="funInputFielTypes(this)" required="required" />
					...
					<div class="form-group">						
						...
						<div class="col-md-4">
							<input name='f1' class="form-control" id='f1' type="file"  autocomplete="off" data-type="image" onchange="funInputFielTypes(this)"  />
					...
					<div class="form-group">						
						...
						<div class="col-md-4">
							<input type="email" id="email" name="email" data-required="1" class="form-control" value="{$data.email}" placeholder="Enter Email ID" data-type="email" onkeyup="funInputFielTypes(this)" autocomplete="off" />
					...
					<div class="form-group">						
						...
						<div class="col-md-4">
							<input type="text" id="land_line" name="land_line" data-required="1" class="form-control" value="{$data.land_line}" placeholder="Enter Land Line" data-type="landline" onkeyup="funInputFielTypes(this)" autocomplete="off" />
					...
					<div class="form-group">						
						...
						<div class="col-md-4">
							<input type="text" id="fax" name="fax" data-required="1" class="form-control" value="{$data.fax}" placeholder="Enter Fax" data-type="fax" onkeyup="funInputFielTypes(this)" autocomplete="off" />
					...
					<div class="form-group">					
						...
						<div class="col-md-4">
							...
							<textarea name='address' id='address' rows="2" cols="50" data-required="1" class="form-control" placeholder="Enter Address" data-type="address" onkeyup="funInputFielTypes(this)" autocomplete="off">{$data.address}</textarea>
					...
					<div class="form-group">						
						...
						<div class="col-md-4">
							...
							<textarea name='address_marathi' id='address_marathi' rows="2" cols="50" data-required="1" class="form-control" placeholder="Enter Address In Marathi" data-type="address" onkeyup="funInputFielTypes(this)" autocomplete="off">{$data.address_marathi}</textarea>
					...
					<div class="form-group">						
						...
						<div class="col-md-4">
							...
							<textarea name='link' id='link' rows="2" cols="50" data-required="1" class="form-control" placeholder="Enter Map Link" data-type="url" onkeyup="funInputFielTypes(this)" autocomplete="off">{$data.link}</textarea>
					...
					<div class="form-group">						
						...
						<div class="col-md-4">
							<input name='f2' class="form-control" id='f2' type="file" data-type="image" onkeyup="funInputFielTypes(this)" autocomplete="off" />

				...
				<form method="post" action="save_sub_category.php" name="sub_category" class="form-horizontal" onSubmit="return validateForm()">
					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input name='description' type="text" id="description" size="30" maxlength='255' data-required="1" class="form-control" placeholder="Enter Sub Category Name" autocomplete="off" data-type="text" onkeyup="funInputFielTypes(this)" required="required" />
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input name="description_marathi" type="text" id="description_marathi" size="30" maxlength='255' placeholder="Enter Sub Category Name In Marathi" data-required="1" class="form-control" data-type="text" onkeyup="funInputFielTypes(this)" required="required" autocomplete="off" />
						...
						<div class="form-actions fluid">
							<div class="col-md-offset-5 col-md-9">
								<button type="submit" class="btn btn-info" name='save' value='Add / Update Sub Category' id="submitBtn" disabled>Submit</button>

...
<br>
			...
			<ul class="navs nav-tabs panel-info" style="background-color: #ccf4ff;">
				<li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true" onclick="fun1()">Complaints</a></li>
				<li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false" onclick="fun1()">Services</a></li>
				<li class=""><a href="#tab_3" data-toggle="tab" aria-expanded="false" onclick="fun1()">Origin Wise</a></li>
		...
		<div class="tab-content" style="background-color: #F2F7FF;" id="tabsdata">
			...
			<div class="boxed">
               ...
               <div class="bash_heading row  m-b20"> Total Number of Complaints  </div> 
                ...
                <div class="row dashboard-stats">
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    ...
                                    <p class="size-h1 no-margin countdown_first"> {if $data[1].total_received eq ''}0{else}{if $user_type == 'A' || $user_type == 'R'}<a href="cdma_ulbwise_report.php?status=0&app_type_id=1&name={$uid}">{$data[1].total_received}</a>{else}<a href="services1.php?aptid=1&status=0&user_type={$user_type}&sla=0">{$data[1].total_received}</a>{/if}{/if}</p>
                        ...
                        <p class="size-h1 no-margin countdown_first">{if $data[1].pending_apprval eq ''}0{else}{if $user_type eq 'A' || $user_type == 'R'}<a href="cdma_ulbwise_report.php?status=1&app_type_id=1&name={$uid}">{$data[1].pending_apprval}</a>{else}<a href="view_pending_approval.php?app_type_id=1">{$data[1].pending_apprval}</a>{/if}{/if}</p>
               ...
               <p class="size-h1 no-margin countdown_first">{if $user_type eq 'A' || $user_type == 'R'}<a href="cdma_ulbwise_report.php?status=2&app_type_id=1&name={$uid}">{$data[1].resolved_withinsla}</a>{else}<a href="services1.php?aptid=1&status=3&sla=1&user_type={$user_type}">{$data[1].resolved_withinsla}</a>{/if}</p>                   
                     ...
                     <p class="size-h1 no-margin countdown_first">{if $user_type eq 'A' || $user_type == 'R'}<a href="cdma_ulbwise_report.php?status=3&app_type_id=1&name={$uid}">{$data[1].resolved_beyond_sla}</a>{else}<a href="services1.php?aptid=1&status=3&sla=2&user_type={$user_type}">{$data[1].resolved_beyond_sla}</a>{/if}</p>                
    ...
    <p class="size-h1 no-margin countdown_first">{if $user_type eq 'A' || $user_type == 'R'}<a href="cdma_ulbwise_report.php?status=4&app_type_id=1&name={$uid}">{$data[1].pending_within_sla}</a>{else}<a href="services1.php?aptid=1&status=2&sla=1&user_type={$user_type}">{$data[1].pending_within_sla}</a>{/if}</p>                                
         ...
         <p class="size-h1 no-margin countdown_first">{if $user_type eq 'A' || $user_type == 'R'}<a href="cdma_ulbwise_report.php?status=5&app_type_id=1&name={$uid}">{$data[1].pending_be_sla}</a>{else}<a href="services1.php?aptid=1&status=2&sla=2&user_type={$user_type}">{$data[1].pending_be_sla}</a>{/if}</p>                            
                         ...
                         <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[1].fin_implication eq ''}0{else}{if $user_type eq 'A' || $user_type == 'R'}<a href="cdma_ulbwise_report.php?status=6&app_type_id=1&name={$uid}">{$data[1].fin_implication}</a>{else}<a href="services1.php?aptid=1&status=500&user_type={$user_type}">{$data[1].fin_implication}</a>{/if}{/if}</p>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $reopened_completed_tot[1][13].count eq ''}0{else}{if $user_type eq 'U'}<a href="deptwise_reopened.php?ulbid={$ulb}&app_type_id=1&status=13" target="_blank">{$reopened_completed_tot[1][13].count}</a>{else}<a href="ulbwise_reopened_rep.php?app_type_id=1&status=13" target="_blank">{$reopened_completed_tot[1][13].count}</a>{/if}{/if}</p>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $reopened_completed_tot[1][11].count eq ''}0{else}{if $user_type eq 'U'}<a href="deptwise_reopened.php?ulbid={$ulb}&app_type_id=1&status=11" target="_blank">{$reopened_completed_tot[1][11].count}</a>{else}<a href="ulbwise_reopened_rep.php?app_type_id=1&status=11" target="_blank">{$reopened_completed_tot[1][11].count}</a>{/if}{/if}</p>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $reopened_completed_tot[1][12].count eq ''}0{else}{if $user_type eq 'U'}<a href="deptwise_reopened.php?ulbid={$ulb}&app_type_id=1&status=12" target="_blank">{$reopened_completed_tot[1][12].count}</a>{else}<a href="ulbwise_reopened_rep.php?app_type_id=1&status=12" target="_blank">{$reopened_completed_tot[1][12].count}</a>{/if}{/if}</p>
                         ...
                         <div class="col-md-4 col-sm-6" >
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $user_type eq 'A' || $user_type == 'R'}<a href="cdma_ulbwise_report.php?status=10&app_type_id=1&name={$uid}" target="_blank">{$data[1].rejected}</a>{else}<a href="services1.php?aptid=1&status=10&user_type={$user_type}" target="_blank">{$data[1].rejected}</a>{/if}</p>
                        ...
                        <div class="col-md-4 col-sm-6" >
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $user_type eq 'A' || $user_type == 'R'}<a href="cdma_ulbwise_report.php?status=11&app_type_id=1&name={$uid}" target="_blank">{$data[1].unresolved}</a>{else}<a href="services1.php?aptid=1&status=11&user_type={$user_type}" target="_blank">{$data[1].unresolved}</a>{/if}</p>
                ...
                <div class="row dashboard-stats">
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[2].total_received eq ''}0{else}{if $user_type eq 'A' || $user_type == 'R'}<a href="cdma_ulbwise_report.php?status=0&app_type_id=2&name={$uid}">{$data[2].total_received}</a>{else}<a href="services1.php?aptid=2&status=0&user_type={$user_type}&sla=0">{$data[2].total_received}</a>{/if}{/if}</p>
                                    <p class="text-muted no-margin "><span style="color:#000;">Received</span></p>
                                </div>
                            </section>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[2].pending_apprval eq ''}0{else}{if $user_type eq 'A' || $user_type == 'R'}<a href="cdma_ulbwise_report.php?status=1&app_type_id=2&name={$uid}">{$data[2].pending_apprval}</a>{else}<a href="view_pending_approval.php?app_type_id=2">{$data[2].pending_apprval}</a>{/if}{/if}</p>
                                    <p class="text-muted no-margin "><span style="color:#000;">Pending for Approval</span></p>
                                </div>
                            </section>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[2].resolved_withinsla eq ''}0{else}{if $user_type eq 'A' || $user_type == 'R'}<a href="cdma_ulbwise_report.php?status=2&app_type_id=2&name={$uid}">{$data[2].resolved_withinsla}</a>{else}<a href="services1.php?aptid=2&status=3&sla=1&user_type={$user_type}">{$data[2].resolved_withinsla}</a>{/if}{/if}</p>
                                    <p class="text-muted no-margin "><span style="color:#000;">Completed with in SLA</span></p>
                                </div>
                            </section>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[2].pending_within_sla eq ''}0{else}{if $user_type eq 'A' || $user_type == 'R'}<a href="cdma_ulbwise_report.php?status=4&app_type_id=2&name={$uid}">{$data[2].pending_within_sla}</a>{else}<a href="services1.php?aptid=2&status=2&sla=1&user_type={$user_type}">{$data[2].pending_within_sla}</a>{/if}{/if}</p>
                                    <p class="text-muted no-margin "><span style="color:#000;">Under Progress with in SLA</span></p>
                                </div>
                            </section>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[2].pending_be_sla eq ''}0{else}{if $user_type eq 'A' || $user_type == 'R'}<a href="cdma_ulbwise_report.php?status=5&app_type_id=2&name={$uid}">{$data[2].pending_be_sla}</a>{else}<a href="services1.php?aptid=2&status=2&sla=2&user_type={$user_type}">{$data[2].pending_be_sla}</a>{/if}{/if}</p>
                                    <p class="text-muted no-margin "><span style="color:#000;">Under Progress Beyond SLA</span></p>
                                </div>
                            </section>
                        </div>
						 ...
						 <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[2].fin_implication eq ''}0{else}{if $user_type eq 'A' || $user_type == 'R'}<a href="cdma_ulbwise_report.php?status=6&app_type_id=2&name={$uid}">{$data[2].fin_implication}</a>{else}<a href="services1.php?aptid=2&status=500&user_type={$user_type}">{$data[2].fin_implication}</a>{/if}{/if}</p>
                                    <p class="text-muted no-margin "><span style="color:#000;">Financial Implication</span></p>
                                </div>
                            </section>
                        </div>
                         ...
                         <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{if $data[2].rejected eq ''}0{else}{if $user_type eq 'A' || $user_type == 'R'}<a href="#}">{$data[2].rejected}</a>{else}<a href="services1.php?aptid=2&status=10&user_type={$user_type}">{$data[2].rejected}</a>{/if}{/if}</p>
                                    <p class="text-muted no-margin "><span style="color:#000;">Rejected</span></p>
                                </div>
                            </section>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">{$data[2].unresolved}</p>
                                    <p class="text-muted no-margin "><span style="color:#000;">Un Resolved</span></p>
                                </div>
                            </section>
                        </div>
				 ...
				 <div class="row dashboard-stats">
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first"> {if $origin_rep.total_received eq ''}0{else}<a href="services1.php?aptid=1&status=0&user_type={$user_type}">{$origin_rep.total_received}</a>{/if}</p>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first"> {if $origin_rep[7].count eq ''}0{else}<a href="cat_origin.php?originid=7">{$origin_rep[7].count}</a>{/if}</p>
                                    <p class="text-muted no-margin"><span style="color:#000;">Endorsed by Commissioner</span></p>
                                </div>
                            </section>
                        </div>

...
{if isset($data)}
<!--
<div style="text-align:right;"><button class="btn btn-warning" onclick="location.href='comp_det1.php?app_type_id=1&emp_id={$emp_id}&status={$grievance_status_list[$data.grievance_status_id]}&dept_id={$dept_id}&f_date={$f_date}&t_date={$t_date}'"><i class="fa fa-backward"></i> Back</button></div>
-->
<br>
<div class="table-responsive" id="area">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table" id="data-table">
    <tr>
...
{include file='footer_excel_print.tpl'}
{literal}
	<script>

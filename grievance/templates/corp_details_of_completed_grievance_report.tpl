									...
									{if $row.dept_id!=0}
										...
										<tr>
											...
											{if $ulbid eq '207'}
												...
												{else}
													<td><a href="corp_view_comp_det_admin.php?grievance_id={$grievance_id}">{$grievance_id}</a></td>
												{/if}
											{else}
												<td class="text-center"><a href="corp_view_comp_det_admin.php?grievance_id={$grievance_id}">{$grievance_id}</a></td>
											{/if}
											...
											<td class="text-center">
												...
												<!-- <td>
												<button type="button" class="btn btn-success btn-sm" id="{$grievance_id}-{$row.emp_id}-{$row.dept_id}" title="{$grievance_id}-{$row.emp_id}-{$row.dept_id}" onclick="myFun2NOACTION(this)">Update</button>  
												</td>-->
					...
					<form  method="POST" action="details_of_completed_grievance_report.php" id="form-id" name="form_name">
							...
							<tbody>	
								<tr>							
									...
									<td>
									<!-- <button type="button" class="btn btn-success btn-sm" id="form-id"  onclick="document.form_name.submit();" name="save" value="Save">Submit</button> -->
									</td>

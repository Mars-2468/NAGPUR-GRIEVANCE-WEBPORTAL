          ...
          <tbody>
            ...
            <tr>
              <td align='center'>{counter} <?php
                                            ...
                                            ?></td>
              <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}"><a href="corp_all_empwise_comp_det.php?app_type_id={$app_type_id}&emp_id={$dept_id}&status=0&dept_id={$emp_dept_list[$dept_id]}&f_date={$fdate}&t_date={$tdate}">{$emp_list[$dept_id]}</a></td>
              ...
              <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$dept_id].count neq ''}<a href="corp_all_empwise_comp_det.php?app_type_id={$app_type_id}&emp_id={$dept_id}&status=0&dept_id={$emp_dept_list[$dept_id]}&f_date={$fdate}&t_date={$tdate}" target="">{$data[$dept_id].count}</a>{else}-{/if}</td>
              <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data_list[$dept_id].pending neq ''}<a href="corp_all_empwise_comp_det.php?app_type_id={$app_type_id}&emp_id={$dept_id}&status=2&dept_id={$emp_dept_list[$dept_id]}&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].pending}</a>{else}-{/if}</a></td>
              <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data_list[$dept_id].pending_be_sla neq ''}<a href="corp_all_empwise_comp_det.php?app_type_id={$app_type_id}&emp_id={$dept_id}&status=8&dept_id={$emp_dept_list[$dept_id]}&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].pending_be_sla}</a>{else}-{/if}</td>
              <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data_list[$dept_id].completed neq ''}<a href="corp_all_empwise_comp_det.php?app_type_id={$app_type_id}&emp_id={$dept_id}&status=3&dept_id={$emp_dept_list[$dept_id]}&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].completed}</a>{else}-{/if}</a></td>
              <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data_list[$dept_id].completed_be_sla neq ''}<a href="corp_all_empwise_comp_det.php?app_type_id={$app_type_id}&emp_id={$dept_id}&status=9&dept_id={$emp_dept_list[$dept_id]}&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].completed_be_sla}</a>{else}-{/if}</td>
              <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data_list[$dept_id].unresolved neq ''}<a href="corp_all_empwise_comp_det.php?app_type_id={$app_type_id}&emp_id={$dept_id}&status=4&dept_id={$emp_dept_list[$dept_id]}&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].unresolved}</a>{else}-{/if}</a></td>
              <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data_list[$dept_id].reopened neq ''}<a href="corp_all_empwise_comp_det.php?app_type_id={$app_type_id}&emp_id={$dept_id}&status=5&dept_id={$emp_dept_list[$dept_id]}&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].reopened}</a>{else}-{/if}</a></td>
               <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data_list[$dept_id].reopened_pending neq ''}<a href="corp_all_empwise_comp_det.php?app_type_id={$app_type_id}&emp_id={$dept_id}&status=105&dept_id={$emp_dept_list[$dept_id]}&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].reopened_pending}</a>{else}-{/if}</a></td>
              <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data_list[$dept_id].reopened_completed neq ''}<a href="corp_all_empwise_comp_det.php?app_type_id={$app_type_id}&emp_id={$dept_id}&status=7&dept_id={$emp_dept_list[$dept_id]}&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].reopened_completed}</a>{else}-{/if}</a></td>
              <td align='center'>{if $data_list[$dept_id].rejected neq ''}{$data_list[$dept_id].rejected}{else}-{/if}</td>
              <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data_list[$dept_id].fin neq ''}<a href="corp_all_empwise_comp_det.php?app_type_id={$app_type_id}&emp_id={$dept_id}&status=10&dept_id={$emp_dept_list[$dept_id]}&f_date={$fdate}&t_date={$tdate}" target="">{$data_list[$dept_id].fin}</a>{else}-{/if}</a></td>
            </tr>
            {/foreach}

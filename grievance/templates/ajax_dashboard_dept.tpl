...
<script>
    $(document).ready(function() {
        ...
        if (user_type == 'M') {
            ...
            $.post('ajax_complaint_dashboard_dept.php', {}, function(data) {
                //alert(data);
                $("#loading").css('display', 'none');
                $("#result").html(data);
            });
...
{if $user_type eq 'E'}
    ...
    <div class="report-btns">
            ...
            <!-- 28-03-24 <a href="reports.php" class="btn btn-success"><i class="fa fa-file-alt"></i> Reports</a> -->
            <a href="ajax_dashboard.php" class="btn btn-warning" onclick="history.go(-1);"><i class="fa fa-backward"></i> Back</a>
        {/if}
...
{/if}
    <div class="nav-tabs-custom">
        ...
        <li class="active nav-item"><a href="javascript:void(0);" data-toggle="tab" aria-expanded="true">Complaints</a></li>
            <!-- <li class="active nav-item"><a href="javascript:void(0);" data-toggle="tab" aria-expanded="true" onclick="fun1('1')">Complaints</a></li> -->
            {if $uid neq 'mepma'}

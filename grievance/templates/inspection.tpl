	...
	<div>
		<div class="boxed">
			...
			<div class="inner no-radius">
				<form method="post" action="save_inspection.php" class="form-horizontal" name="field_visitor_form" onSubmit="return validateForm()" enctype="multipart/form-data">
					<input type="hidden" name="token" value="{$token}" />
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input name='lat' type="text" id="lat"  class="form-control " placeholder="Enter Latitude" autocomplete="off" required="required" readonly />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-4">
								<input name='lang' type="text" id="lang"  class="form-control " placeholder="Enter Langitude" autocomplete="off" required="required" readOnly />
							</div>
						</div>
					...
					<!--	<div class="form-group">
							...
							<div class="col-md-4">
								<input name='field_verification_reason' type="text" id="field_verification_reason"  class="form-control" placeholder="Enter field verification reason" autocomplete="off" required="required" onchange="return valReason()" />
							</div>
						</div>
						...
						<div class="form-group">						
							...
							<div class="col-md-4">
								<input name='field_verification_address' type="text" id="field_verification_address"  class="form-control"  placeholder="Enter field verification address" autocomplete="off" required="required" onchange="return valAddress()" />
							</div>
						</div>  -->
						<div class="form-group">						
							...
							<div class="col-md-4">
								<input name='remarks' type="text" id="remarks"  class="form-control " placeholder="Enter field verification address" autocomplete="off" required="required"  onchange="return valRemarks()"/>
							</div>
						</div>
						<div class="form-group">						
							<label class="control-label col-md-4">Doc Type <span class="required" style="color:red"> * </span> <span style="margin-left:10px;"> : </span> </label>
							<div class="col-md-4">
...
<div class="row">
	<div>
		<!--<form method="post" action="inspection.php" class="form-horizontal" onSubmit="return validateSearchForm()">
			<div class="form-group">
				<label class="control-label col-md-2">Field Verification Address<span style="margin-left:10px;"> : </span> </label>
				<div class="col-md-3">
					<input type="text" name="field_address" class="form-control" value="{$field_address}" Placeholder="Search field verification address" autocomplete="off">
				</div>
				<label class="control-label col-md-2">Remarks <span style="margin-left:10px;"> : </span> </label>
				<div class="col-md-3">
					<input type="text" name="remarks" class="form-control" value="{$remarks}" Placeholder="Search remarks" autocomplete="off">
				</div>
				<div class="col-md-2">
		...
		<div class="boxed">
			...
			<div class="title-bar white">
				...
				<a class="btn btn-warning pull-right" href="inspection_report.php">Report</a>
			</div>
			<!-- Title Bart End -->
			<div id="area">
					...
					<table id="data-table" class="table table-striped table-bordered table-hover table-full-width"  width="100%">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<input type="button" class="btn btn-danger" value="Delete" onclick="delete_rec({$id})">
								</td>
							</tr>
...
<script type="text/javascript" src="js/jquery-oet.js"></script>
...
<script src="js/xlsx-zoef.full.min.js"></script> 
  <script src="js/exceljs-ftz.min.js"></script>
    <script src="js/FileSaver-tzf.min.js"></script>

...
<div class="" style="margin-top: -45px;">
	<div class="boxed">
		...
		<div class="inner no-radius">
			...
			{if $user_type eq 'E'}
			/* Not Open <div style="text-align:right;"><a href="all_empwise_report.php?active=tr-clmn" class="btn btn-warning"><i class="fa fa-backward"></i> Back</a></div>*/
			<div style="text-align:right;"><a href="all_empwise_report_new.php?active=tr-clmn" class="btn btn-warning"><i class="fa fa-backward"></i> Back</a></div>
			{else}
			/* Not Open <div style="text-align:right;"><a href="all_empwise_report.php?active=tr-clmn" class="btn btn-warning" onclick="history.go(-1);"><i class="fa fa-backward"></i> Back</a></div>*/
			<div style="text-align:right;"><a href="all_empwise_report_new.php?active=tr-clmn" class="btn btn-warning" onclick="history.go(-1);"><i class="fa fa-backward"></i> Back</a></div>
			{/if} -->
			
			{if $user_type eq 'E'}
				<div class="button-container">
					<input name="search" type="submit" class="btn btn-success" value="SEARCH">
					<a href="all_empwise_report_new.php?active=tr-clmn" class="btn btn-warning" onclick="history.go(-1);">
		...
		<div id="div_print" style="border:#999999 0px solid;">
			...
			<div class="table-responsive" style="width:100%;">
					...
					<table width="100%" border="1" cellspacing="0" cellpadding="0" class="display table-bordered table-striped table-condensed cf" id="example">
						<caption style="caption-side:top; text-align:center;font-size:16px;">
							<b>
								...
								<CENTER><strong>VIEW {if $app_type_id eq '1'} ADMIN UNDER PROGRESS COMPLAINT {else} SERVICE {/if} DETAILS</strong></CENTER>
								{elseif $status eq '2' && $user_type eq 'E' }
								<CENTER><strong>VIEW {if $app_type_id eq '1'} EMPLOYEE UNDER PROGRESS COMPLAINT {else} SERVICE {/if} DETAILS</strong></CENTER>

								{elseif $status eq '7' && $user_type eq 'U' }
								<CENTER><strong>VIEW {if $app_type_id eq '1'} ADMIN COMPLETED COMPLAINT {else} SERVICE {/if} DETAILS</strong></CENTER>
								{elseif $status eq '7' || $status eq '401' && $user_type eq 'E' }
								<CENTER><strong>VIEW {if $app_type_id eq '1'} EMPLOYEE COMPLETED COMPLAINT {else} SERVICE {/if} DETAILS</strong></CENTER>
						...
						<thead>
							...
							<tr style="background-color:#2c3e50; color:#FFF;">
								...
								<th align="center" valign="middle" style="width: 150px; text-align: center; vertical-align: middle;">COMPLETED DATE</th>
						...
						<tbody>
							...
							<tr>
								...
								<!--13-06-2024 <td align='center'><a href="view_comp_det_admin.php?grievance_id={$grievance_id}">{$grievance_id}</a></td> -->
								...
								<td align='center'>{$row.last_updated_date|date_format:"%d-%m-%Y %H:%M:%S"}</td>
								{/if}
				...
				<!-- <center>
					<div id="pagination" class="pagination" align="center">{$pagination} pagination</div>
				</center> -->
			</div>
		</div>
	</div>

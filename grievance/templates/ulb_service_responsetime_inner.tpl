...
<CENTER><strong>CATEGORY WISE SERVICES AVG RESPONSE TIME REPORT</strong></CENTER>
    ...
    <div style="width:100%; overflow:scroll;">
	     <table class="table table-striped table-bordered table-hover table-full-width" id="data-table">
										...
										<tr>
										    <td>{counter}</td>
										    <td><a href="category-wise-ulb-response-time.php?cat_id={$cs_id}&ulbid={$ulbid}">{$cat_list[$cs_id]}</a></td>

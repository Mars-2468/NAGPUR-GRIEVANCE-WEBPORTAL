...
-->
				...
				<div class="button-container">
					...
					<a href="corp_escaleted_grievance_rep.php" class="btn btn-warning" onclick="history.go(-1);">
				...
				<table border="1" cellspacing="0" cellpadding="0" class="table table-bordered" id="data-table" width="100%">
					...
					<tbody style="background-color:#FFF;">
						...
						<tr>
							...
							<td align="center" class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}"><a href="corp_view_comp_det_admin.php?grievance_id={$grievance_id}" target="_blank">{$grievance_id}</a></td>

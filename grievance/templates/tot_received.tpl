...
<td align="center">
								...
								{if $smarty.session.user_type eq 'E'}
									...
									<form action="manage_transfered_comp_sel.php" method="post">
										<input type="hidden" name="prev_aptid" value="{$app_type_id}">
										<input type="hidden" name="prev_user_type" value="{$user_type}">
										<input type="hidden" name="prev_status" value="{$status}">
										<input type="hidden" name="prev_sla" value="{$sla}">
										<input type="hidden" name="prev_f_date" value="{$fdate}">
										<input type="hidden" name="prev_t_date" value="{$tdate}">

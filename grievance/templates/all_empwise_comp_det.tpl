	...
	<div class="boxed">
		...
		<div class="inner no-radius">
			...
			<form method="POST" class="form-horizontal">
				...
				<div style="text-align:right;"><a href="all_empwise_report.php?active=tr-clmn" class="btn btn-warning" onclick="history.go(-1);"><i class="fa fa-backward"></i> Back</a></div>
				{/if} -->
			...
			<div class="table-responsive" style="width:100%;">
				<div id="area">
					<table width="100%" border="1" cellspacing="0" cellpadding="0" class="display table-bordered table-striped table-condensed cf" id="example">
						...
						<thead>
							<!--31-05-2024 <tr style="background-color:#2c3e50; color:#FFF;">
						...
						<tbody>
							...
							<tr>
								...
								<!--31-05-2024 <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}"><a href="view_comp_det_admin.php?grievance_id={$grievance_id}">{$grievance_id}</a></td> -->
								...
								<td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{$row.last_updated_date|date_format:"%d-%m-%Y %H:%M:%S"}</td>
								{/if}

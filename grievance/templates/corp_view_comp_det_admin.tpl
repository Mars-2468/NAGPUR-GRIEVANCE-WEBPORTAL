...
{if isset($data)}
<!--
<div style="text-align:right;"><button class="btn btn-warning" onclick="location.href='corp_comp_det1.php?app_type_id=1&emp_id={$emp_id}&status={$grievance_status_list[$data.grievance_status_id]}&dept_id={$dept_id}&f_date={$f_date}&t_date={$t_date}'"><i class="fa fa-backward"></i> Back</button></div>
-->
<br>

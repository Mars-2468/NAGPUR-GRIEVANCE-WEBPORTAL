      ...
      <table id='example' cellpadding="3" cellspacing="0" border="1" class="display table-bordered table-striped table-condensed cf" width="100%">
        ...
        <tbody>
          ...
          <tr>
            ...
            <!--12-03-24 <td align='center'><a href="complaints_full_rep.php?app_type_id=1&cs_id={$cs_id}&status=0&f_date={$fdate}&t_date={$tdate}">{$cs_list[$cs_id]}</a> -->
            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}"><a href="complaints_full_rep.php?ulbid={$ulbid}&app_type_id=1&cs_id={$cs_id}&status=0&f_date={$fdate}&t_date={$tdate}" target="_blank">{$cs_list[$cs_id]}</a>  
            <!-- <td align='center'><a href="complaints_full_rep.php?app_type_id=1&cs_id={$cs_id}&status=0&f_date={$fdate}&t_date={$tdate}">{$data[$cs_id].count}</a></td> -->
            <!--23-05-24 <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].total_received neq ''}<a href="complaints_full_rep.php?ulbid={$ulbid}&app_type_id=1&cs_id={$cs_id}&status=1&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].total_received}</a>{else}-{/if}</td>

            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].pending_within_sla neq ''}<a href="complaints_full_rep.php?app_type_id=1&cs_id={$cs_id}&status=2&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].pending_within_sla}</a>{else}-{/if}</td>
            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].pending_beyond_sla neq ''}<a href="complaints_full_rep.php?app_type_id=1&cs_id={$cs_id}&status=3&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].pending_beyond_sla}</a>{else}-{/if}</td>

            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].resolved_within_sla neq ''}<a href="complaints_full_rep.php?app_type_id=1&cs_id={$cs_id}&status=4&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].resolved_within_sla}</a>{else}-{/if}</td>
            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].resolved_beyond_sla neq ''}<a href="complaints_full_rep.php?app_type_id=1&cs_id={$cs_id}&status=5&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].resolved_beyond_sla}</a>{else}-{/if}</td>

            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].tot_resolved neq ''}<a href="complaints_full_rep.php?app_type_id=1&cs_id={$cs_id}&status=6&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].tot_resolved}</a>{else}-{/if}</td>
            ...
            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].fin_implication neq ''}<a href="complaints_full_rep.php?app_type_id=1&cs_id={$cs_id}&status=6&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].fin_implication}</a>{else}-{/if}</td>
            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].pending_apprvl neq ''}<a href="complaints_full_rep.php?app_type_id=1&cs_id={$cs_id}&status=7&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].pending_apprvl}</a>{else}-{/if}</td>
            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].rejected neq ''}<a href="complaints_full_rep.php?app_type_id=1&cs_id={$cs_id}&status=8&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].rejected}</a>{else}-{/if}</td>
            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].unresolved neq ''}<a href="complaints_full_rep.php?app_type_id=1&cs_id={$cs_id}&status=8&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].unresolved}</a>{else}-{/if}</td>
            ...
            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].total_received neq ''}<a href="complaints_full_rep.php?ulbid={$ulbid}&app_type_id=1&cs_id={$cs_id}&status=0&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].total_received}</a>{else}-{/if}</td>

            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].pending_within_sla neq ''}<a href="complaints_full_rep.php?ulbid={$ulbid}&app_type_id=1&cs_id={$cs_id}&status=2&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].pending_within_sla}</a>{else}-{/if}</td>
            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].pending_beyond_sla neq ''}<a href="complaints_full_rep.php?ulbid={$ulbid}&app_type_id=1&cs_id={$cs_id}&status=8&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].pending_beyond_sla}</a>{else}-{/if}</td>

            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].resolved_within_sla neq ''}<a href="complaints_full_rep.php?ulbid={$ulbid}&app_type_id=1&cs_id={$cs_id}&status=3&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].resolved_within_sla}</a>{else}-{/if}</td>
            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].resolved_beyond_sla neq ''}<a href="complaints_full_rep.php?ulbid={$ulbid}&app_type_id=1&cs_id={$cs_id}&status=9&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].resolved_beyond_sla}</a>{else}-{/if}</td>

            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].tot_resolved neq ''}<a href="complaints_full_rep.php?ulbid={$ulbid}&app_type_id=1&cs_id={$cs_id}&status=108&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].tot_resolved}</a>{else}-{/if}</td>

            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].reopened neq ''}<a href="complaints_full_rep.php?ulbid={$ulbid}&app_type_id=1&cs_id={$cs_id}&status=5&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].reopened} </a>{else}-{/if}</td>
            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id][11].reopend_underProgress neq ''}<a href="complaints_full_rep.php?ulbid={$ulbid}&app_type_id=1&cs_id={$cs_id}&status=105&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id][11].reopend_underProgress} </a>{else}-{/if}</td>
            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].reopend_completed neq ''}<a href="complaints_full_rep.php?ulbid={$ulbid}&app_type_id=1&cs_id={$cs_id}&status=7&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].reopend_completed} </a>{else}-{/if}</td>

            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].fin_implication neq ''}<a href="complaints_full_rep.php?ulbid={$ulbid}&app_type_id=1&cs_id={$cs_id}&status=10&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].fin_implication}</a>{else}-{/if}</td>
            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].pending_apprvl neq ''}<a href="complaints_full_rep.php?ulbid={$ulbid}&app_type_id=1&cs_id={$cs_id}&status=7&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].pending_apprvl}</a>{else}-{/if}</td>
            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].rejected neq ''}<a href="complaints_full_rep.php?ulbid={$ulbid}&app_type_id=1&cs_id={$cs_id}&status=8&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].rejected}</a>{else}-{/if}</td>
            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].unresolved neq ''}<a href="complaints_full_rep.php?ulbid={$ulbid}&app_type_id=1&cs_id={$cs_id}&status=8&f_date={$fdate}&t_date={$tdate}" target="_blank">{$data[$cs_id].unresolved}</a>{else}-{/if}</td>
            <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}">{if $data[$cs_id].percent neq ''}{$data[$cs_id].percent}{else}-{/if}</td>
          </tr>
          {/foreach}

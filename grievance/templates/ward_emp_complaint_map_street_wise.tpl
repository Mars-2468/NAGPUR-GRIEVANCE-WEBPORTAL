...
{/literal}
 ...
 <a href="http://www.municipalservices.in/complaint_emp_map_report.php" target="_blank" class="btn-link" style="color:#FFF;"><span class="fa fa-clipboard"></span> Click Here  To Employee Complaint Mapping Report</a></button>
 	...
 	<br>
			...
			<form   method="post" action="ward_emp_complaint_map_street_wise.php" name="manage_wards"  id="manage_wards" class="form-horizontal" onSubmit="return validateForm()">
    ...
    <div >
		...
		<br>
		<form   method="post" action="ward_emp_complaint_map_street_wise.php" name="manage_wards"  id="manage_wards" onSubmit="return validateForm()">

...
<div class="" style="margin-top: -45px;">
	...
	<div class="boxed">
		<div class="title-bar blue">
			<h4>Total Departments Received Grievances</h4>
		</div>
			...
			<div class="table-responsive" style="width:100%;">
				<div id="area">
					<table id='example' cellpadding="3" cellspacing="0" border="1" class="display table-bordered table-striped table-condensed cf" width="100%">
						<!-- <table id="example" border="1" cellspacing="0" cellpadding="0" class="display table-bordered table-striped table-condensed cf" width="100%"> -->
						<caption style="caption-side:top; text-align:center;font-size:16px;">
							<b>
								...
								{elseif $status eq '105' || $status eq '501' }
						...
						<thead>
							<!--13-06-2024 <tr style="background-color:#2c3e50; color:#FFF;">
								...
								<td align='center'>
									...
									{if $ulbid eq '207'}
										...
										{else}
											<a href="receive_print_boduppal.php?gid={$grievance_id}&aptid={$row.app_type_id}" target="_blank">Receipt</a>
										{/if}
									{else if $status eq '701'}
										-
									{else}
										{if $row.app_type_id eq '2'}
											<a href="receive_print.php?gid={$grievance_id}&aptid={$row.app_type_id}" target="_blank">Receipt</a>
										{else}
											{if $row.grievance_status_id eq 12}
												<a href="#" target="_blank">-</a>
											{else}
												<a class="btn btn-warning" href="manage_reopen_comp_sel.php?grievance_id={$grievance_id}&app_type_id={$row.app_type_id}" target="_blank">TakeAction</a>
											{/if}
										{/if}
									{/if}

									<!--{if $row.grievance_status_id eq '2'}<form action="manage_comp_sel.php" method="post">
...
<!--01-02-2024 <div style="width:100%; text-align:center">

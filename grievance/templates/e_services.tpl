...
<table   id='example' width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
 <tr>
    ...
    <td align="left" valign="top">
		...
		<td align="center"><a href="d_e_services.php?aptid={$app_type_id}&status={$status}&user_type={$user_type}&{if $app_type_id eq '1'}cs_id={$row.cs_id}{else}dept_id={$row.dept_id}{/if}&sla={$sla}&emp_id={$row.emp_id}">{$row.count}</a></td>

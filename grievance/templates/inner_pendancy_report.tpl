	...
	<div class="boxed">
		...
		<div class="inner no-radius">
			...
			<form method="POST" class="form-horizontal">
				...
				<div style="text-align:right;"><a href="grievance_sla_anlysis_report.php" class="btn btn-warning" onclick="history.go(-1);"><i class="fa fa-backward"></i> Back</a></div>
				{else}
				<div style="text-align:right;"><a href="dept_pendancy_report.php" class="btn btn-warning" onclick="history.go(-1);"><i class="fa fa-backward"></i> Back</a></div>
				{/if} -->

				{if $status eq 'all' || $status eq 'L1' || $status eq 'L2' || $status eq 'L3' || $status eq 'L4'}
				<div class="button-container">
					<input name="search" type="submit" class="btn btn-success" value="SEARCH">
					<a href="grievance_sla_anlysis_report.php" class="btn btn-warning" onclick="history.go(-1);">
				...
				<div class="button-container">
					<input name="search" type="submit" class="btn btn-success" value="SEARCH">
					<a href="dept_pendancy_report.php" class="btn btn-warning" onclick="history.go(-1);">
						<i class="fa fa-backward"></i> Back
					</a>
				</div>
				{/if}
					...
					<table width="100%" border="1" cellspacing="0" cellpadding="0" class="display table-bordered table-striped table-condensed cf" id="data-table">
						<caption style="caption-side:top; text-align:center;font-size:16px;">
							<b>
								...
								{if $status eq '0' || $status eq '100' && $user_type eq 'U' }
								...
								{elseif $status eq '107' || $status eq '800' && $user_type eq 'U' }
								...
								{elseif $status eq '108' || $status eq '900' && $user_type eq 'U' }
						...
						<tbody>
							...
							<tr>
								...
								<!--30-05-2024 <td align='center' class="{if $active_class eq 'tr-clm3qclmn'}activ_column{/if}"><a href="view_comp_det_admin.php?grievance_id={$grievance_id}">{$grievance_id}</a></td> -->

...
if (isset($_SESSION['uid'])) {
	...
	if ($_REQUEST['aptid'] == 1 && $_REQUEST['user_type'] == 'E') {
		...
		if ($_REQUEST['status'] == 300) {
	        ...
	        app_type_id='1' and g.mcat3_id=ss.cs_id and gt.dept_id IN( $deptlist ) and gt.is_escalated='1'";

			//$sql="g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id, DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added  AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date  FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and emp_id IN('".$emplist."') and gt.disposal_status !=5 and app_type_id='1' and grievance_status_id IN('3','8','9') and sla_status=2 and gt.is_escalated=0 and cat3_id !='0' and gt.grievance_id NOT IN(select gg.grievance_id from grievances_transactions gg where emp_id IN('".$emplist."') and is_escalated='1')";
	        ...
	        gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and gt.is_escalated='1'";
			...
			g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) and gt.disposal_status=9 ";
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				...
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and cat3_id !='0' and gt.disposal_status !=5 AND YEAR(date_regd) = '" . $selectedYear . "'";

				$esca_sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where DATE(date_regd) = '" . $date . "' and g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
				...
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.dept_id IN( $deptlist ) and g.ward_id=w.ward_id and g.street_id=s.street_id and gt.disposal_status !=5 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where DATE(date_regd) = '" . $date . "' and g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and cat3_id !='0' and gt.disposal_status !=5 ";

				$esca_sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where DATE(date_regd) = '" . $date . "' and g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and cat3_id !='0'";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where DATE(date_regd) = '" . $date . "' and g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.dept_id IN( $deptlist ) and g.ward_id=w.ward_id and g.street_id=s.street_id and gt.disposal_status !=5 and cat3_id !='0' ";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				...
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where DATE(date_regd) = '" . $date . "' and g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and cat3_id !='0'";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN($deptlist) and g.grievance_status_id IN('3','6','8','9','12','13') and gt.disposal_status !=5 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
				...
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.dept_id IN( $deptlist ) and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('3','6','8','9','12','13') and gt.disposal_status !=5 and gsm.grievance_status_id IN ('3','6','8','9','12','13') and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				/*$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id, DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and g.mcat3_id=ss.cs_id and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and g.grievance_status_id IN('3','9','8') and gt.disposal_status IN('3','9','8') and cat3_id !='0' and gt.grievance_id not in(select gg.grievance_id from grievances gg where gg.grievance_status_id IN(13,12,11) and gt.is_escalated='0')";*/

				/*29-02-24 $sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN($deptlist) and gt.disposal_status IN('3','9','8') and g.grievance_status_id IN('3','9','8') and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null) ";*/

				/*15-04-24 $sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN($deptlist) and gt.disposal_status !=5 and g.grievance_status_id IN('3','6','8','9','12') and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null) ";*/

				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN($deptlist) and g.grievance_status_id IN('3','6','8','9','12','13') and gt.disposal_status !=5 and cat3_id !='0' ";

				/*$sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,g.eoffice_no as EofficeNo, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and
				gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and app_type_id='1' and g.grievance_status_id IN('3','9','8') and gt.disposal_status IN('3','9','8') and gsm.grievance_status_id IN('3','8','9') and cat3_id !='0' and gt.grievance_id not in(select gg.grievance_id from grievances gg where gg.grievance_status_id IN(13,12,11) and gt.is_escalated='0')";*/
				...
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and g.grievance_status_id IN('3','6','8','9','12') and gt.disposal_status!=5 and gsm.grievance_status_id IN('3','6','8','9','12') and cat3_id !='0' and gt.disposal_status !=5 and g.ward_id=w.ward_id and g.street_id=s.street_id and gt.grievance_id not in(select gg.grievance_id from grievances gg where gg.grievance_status_id IN('13','11') and gt.is_escalated='0')";*/

				/*15-04-24 $sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.dept_id IN( $deptlist ) and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN ('3','6','8','9','12') and gsm.grievance_status_id IN ('3','6','8','9','12') and gt.disposal_status !=5 and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null) ";*/

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.dept_id IN( $deptlist ) and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('3','6','8','9','12','13') and gt.disposal_status !=5 and gsm.grievance_status_id IN ('3','6','8','9','12','13') and cat3_id !='0' ";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and g.grievance_status_id IN('3','6','8','9','12','13') and gt.disposal_status !=5 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				...
				//app_type_id='1' and g.mcat3_id=ss.cs_id and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and g.grievance_status_id IN('3','9','8') and gt.disposal_status IN('3','9','8') and cat3_id !='0' and gt.grievance_id not in(select gg.grievance_id from grievances gg where gg.grievance_status_id IN(13,12,11) and  gt.is_escalated='0')";

				//old 29-02-24  
				/*$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN($deptlist) and gt.disposal_status IN('3','9','8') and g.grievance_status_id IN('3','9','8') and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null)";*/
				...
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) and g.grievance_status_id IN('3','6','8','9','12') and cat3_id !='0' ";*/

				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and g.grievance_status_id IN('3','6','8','9','12','13') and gt.disposal_status !=5 and cat3_id !='0' ";

				//$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where g.grievance_id=gt.grievance_id and 
				//g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and g.grievance_status_id IN('3','9','8') and gt.disposal_status IN('3','9','8') and cat3_id !='0' and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) ";
			}	
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN($deptlist) and g.grievance_status_id IN('11') and gt.disposal_status!=5 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
	
				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.dept_id IN( $deptlist ) and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('11') and gt.disposal_status!=5 and gsm.grievance_status_id IN ('11') and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN($deptlist) and g.grievance_status_id IN('11') and gt.disposal_status!=5 and cat3_id !='0'";

				/*$sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,g.eoffice_no as EofficeNo, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and
				gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and app_type_id='1' and g.grievance_status_id IN('11') and gt.disposal_status IN('11') and gsm.grievance_status_id IN('11') and cat3_id !='0' and gt.grievance_id IN(select gg.grievance_id from grievances gg where gg.grievance_status_id IN(11) and gt.is_escalated='0')";*/

				/*old 19-02-24 $sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and g.grievance_status_id IN('11') and gt.disposal_status IN('11') and gsm.grievance_status_id IN('11') and cat3_id !='0' and g.ward_id=w.ward_id and gt.grievance_id IN(select gg.grievance_id from grievances gg where gg.grievance_status_id IN('11') and gt.is_escalated='0')";*/

				//12-02-24 $sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and g.grievance_status_id IN('11') and gt.disposal_status IN('11') and gsm.grievance_status_id IN('11') and cat3_id !='0' and g.ward_id=w.ward_id and g.street_id=s.street_id and gt.grievance_id IN(select gg.grievance_id from grievances gg where gg.grievance_status_id IN('11') and gt.is_escalated='0')";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.dept_id IN( $deptlist ) and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('11') and gt.disposal_status!=5 and gsm.grievance_status_id IN ('11') and cat3_id !='0' ";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and
	        	app_type_id='1' and g.mcat3_id=ss.cs_id and gt.dept_id IN( $deptlist ) and g.grievance_status_id IN('11') and gt.disposal_status!=5 and cat3_id !='0' and gt.grievance_id IN(select gg.grievance_id from grievances gg where gg.grievance_status_id IN(11)) AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and
				app_type_id='1' and g.mcat3_id=ss.cs_id and gt.dept_id IN( $deptlist ) and g.grievance_status_id IN('11') and gt.disposal_status!=5 and cat3_id !='0' and gt.grievance_id IN(select gg.grievance_id from grievances gg where gg.grievance_status_id IN(11))";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN($deptlist) and g.grievance_status_id IN('11','12','13') and gt.disposal_status!=5 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.dept_id IN( $deptlist ) and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('11','12','13') and gt.disposal_status!=5 and gsm.grievance_status_id IN ('11','12','13') and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN($deptlist) and g.grievance_status_id IN('11','12','13') and gt.disposal_status!=5 and cat3_id !='0'";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.dept_id IN( $deptlist ) and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('11','12','13') and gt.disposal_status!=5 and gsm.grievance_status_id IN ('11','12','13') and cat3_id !='0'";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and
	        	app_type_id='1' and g.mcat3_id=ss.cs_id and gt.dept_id IN( $deptlist ) and g.grievance_status_id IN('11','12','13') and gt.disposal_status!=5 and cat3_id !='0' and gt.grievance_id IN(select gg.grievance_id from grievances gg where gg.grievance_status_id IN('11','12','13')) AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and
				app_type_id='1' and g.mcat3_id=ss.cs_id and gt.dept_id IN( $deptlist ) and g.grievance_status_id IN('11','12','13') and gt.disposal_status!=5 and cat3_id !='0' and gt.grievance_id IN(select gg.grievance_id from grievances gg where gg.grievance_status_id IN('11','12','13'))";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and g.grievance_status_id IN('12') and cat3_id !='0' and gt.grievance_id IN(select gg.grievance_id from grievances gg where gg.grievance_status_id IN(12)) AND YEAR(date_regd) = '" . $selectedYear . "'";
				...
				and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.dept_id IN( $deptlist ) and g.ward_id=w.ward_id and g.street_id=s.street_id and gt.disposal_status !=5 and g.grievance_status_id IN('12') and cat3_id !='0' and gt.grievance_id IN(select gg.grievance_id from grievances gg where gg.grievance_status_id IN(12)) AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				/*12-04-24 $sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN($deptlist) and gt.disposal_status NOT IN('5','9','13') and g.grievance_status_id IN('12') and cat3_id !='0'";*/

				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and g.grievance_status_id IN('12') and cat3_id !='0' and gt.grievance_id IN(select gg.grievance_id from grievances gg where gg.grievance_status_id IN(12))";

				/*12-04-24 $sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and g.grievance_status_id IN('12') and gt.disposal_status NOT IN('5','9','13') and gsm.grievance_status_id IN('12') and cat3_id !='0' and gt.disposal_status !=5 and g.ward_id=w.ward_id and g.street_id=s.street_id and gt.grievance_id not in(select gg.grievance_id from grievances gg where gg.grievance_status_id IN('5','9','13') and gt.is_escalated='0')";*/
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and
				app_type_id='1' and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and g.grievance_status_id IN('12') and cat3_id !='0' and gt.grievance_id IN(select gg.grievance_id from grievances gg where gg.grievance_status_id IN(12)) AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				...
				app_type_id='1' and g.mcat3_id=ss.cs_id and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and g.grievance_status_id IN('12') and gt.disposal_status NOT IN('5','9','13') and cat3_id !='0' and gt.grievance_id IN(select gg.grievance_id from grievances gg where gg.grievance_status_id IN(12) and  gt.is_escalated='0')";*/

				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and
				app_type_id='1' and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and g.grievance_status_id IN('12') and cat3_id !='0' and gt.grievance_id IN(select gg.grievance_id from grievances gg where gg.grievance_status_id IN(12))";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN($deptlist) and g.grievance_status_id IN('2','11') and gt.disposal_status !=5 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.dept_id IN($deptlist) and g.grievance_status_id IN('2','11') and gt.disposal_status !=5 and cat3_id !='0' and g.ward_id=w.ward_id and g.street_id=s.street_id AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				/*$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id, DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added  AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and
				app_type_id='1' and g.mcat3_id=ss.cs_id and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and g.grievance_status_id IN('2') and gt.disposal_status IN('2') and  gt.is_escalated='0' and cat3_id !='0'";*/

				/*29-02-24 $sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id, DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added  AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) and g.grievance_status_id IN('2') and gt.disposal_status IN('2') and cat3_id !='0'";*/

				/*15-04-24 $sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id, DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added  AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and (is_reopened_yn='0' || is_reopened_yn is null) and g.grievance_status_id IN('2','11') and gt.disposal_status !=5  and cat3_id !='0'";*/

				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN($deptlist) and g.grievance_status_id IN('2','11') and gt.disposal_status !=5 and cat3_id !='0' ";
				...
				//FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and (gt.disposal_status !=5 or (gt.disposal_status =5 and is_escalated=1)) and g.grievance_status_id IN('2') and gt.disposal_status IN('2') and cat3_id !='0'";

				/*old 19-02-24 
				$sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate 
				FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s,comp_cutofdays_map ccm where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and g.ward_id=w.ward_id and gt.dept_id IN($deptlist) and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) and g.grievance_status_id IN('2') and gt.disposal_status IN('2') and cat3_id !='0'";*/

				/*29-02-24 $sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate 
				FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s,comp_cutofdays_map ccm where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and g.ward_id=w.ward_id and g.street_id=s.street_id and gt.dept_id IN($deptlist) and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) and g.grievance_status_id IN('2') and gt.disposal_status IN('2') and cat3_id !='0'";*/
				...
				FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s,comp_cutofdays_map ccm where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and g.ward_id=w.ward_id and g.street_id=s.street_id and gt.dept_id IN($deptlist) and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) and g.grievance_status_id IN('2','11') and cat3_id !='0'";*/

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.dept_id IN($deptlist) and g.grievance_status_id IN('2','11') and gt.disposal_status !=5 and cat3_id !='0' and g.ward_id=w.ward_id and g.street_id=s.street_id";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and app_type_id='1' and g.grievance_status_id IN('2','11') and gt.disposal_status !=5 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				...
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) and g.grievance_status_id IN('2') and gt.disposal_status IN('2') and cat3_id !='0' ";*/
				...
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and (is_reopened_yn='0' || is_reopened_yn is null) and g.grievance_status_id IN('2','11') and gt.disposal_status !=5 and cat3_id !='0' ";*/

				//31-05-24 $query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and app_type_id='1' and g.grievance_status_id IN('2','11') AND gt.disposal_status IN('2','11') and gt.disposal_status !=5 and cat3_id !='0'";

				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and app_type_id='1' and g.grievance_status_id IN('2','11') and gt.disposal_status !=5 and cat3_id !='0'";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {				
				...
				$esca_sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
				...
				//$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id, DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				//g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and
				//app_type_id='1' and g.mcat3_id=ss.cs_id and gt.dept_id IN( $deptlist ) and gt.disposal_status IN(2,9,8,4,6,10) and g.grievance_status_id IN(2,9,8,4,6,10,13,12,11) and cat3_id !='0' and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null) ";

				//$sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,g.eoffice_no as EofficeNo, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and
				//gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and gt.dept_id IN($deptlist) and gt.disposal_status IN(2,9,8,4,6,10) and g.grievance_status_id IN(2,9,8,4,6,10,13,12,11) and cat3_id !='0' and gt.disposal_status !=5";

				/*old 19-02-24 */
				/*$sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate 
				FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and gt.dept_id IN($deptlist) and gt.disposal_status IN(2,9,8,4,6,10) 
				and g.grievance_status_id IN(2,9,8,4,6,10,13,12,11) and cat3_id !='0' and gt.disposal_status !=5 and g.ward_id=w.ward_id";*/

				/*$sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate 
				FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and gt.disposal_status=gsm.grievance_status_id and app_type_id='1' and gt.dept_id IN( $deptlist )
				...
				/* 01-03-24 $sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and gt.disposal_status IN(2,9,8,4,6,10) and g.grievance_status_id IN(2,9,8,4,6,10,13,12,11) and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null) ";

				$sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,grievance_status_desc as Status ,date_regd as ReceivedDate FROM grievances g,cs_mst c,ulbmst u,grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and 
				...
				app_type_id='1' and gt.dept_id IN($deptlist) and gt.disposal_status IN(2,9,8,4,6,10) and g.grievance_status_id IN(2,9,8,4,6,10,13,12,11) and cat3_id !='0'";*/

				/*15-04-24 $sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null) ";

				$esca_sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and
				app_type_id='1' and gt.dept_id IN( $deptlist ) and gt.disposal_status!=5 and cat3_id !='0'";*/

				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and cat3_id !='0' and gt.disposal_status !=5 ";

				$esca_sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and cat3_id !='0'";
				...
				where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.dept_id IN( $deptlist ) and g.ward_id=w.ward_id and g.street_id=s.street_id and gt.disposal_status !=5 and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null) ";*/
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				...
				/*15-03-24 $query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN($deptlist) and gt.disposal_status IN(2,9,8,4,6,10) and g.grievance_status_id IN(2,9,8,4,6,10,13,12,11) and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null)";

				$query = "SELECT count(DISTINCT(g.grievance_id)) as num FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN($deptlist) and gt.disposal_status !=5 and app_type_id='1' and cat3_id !='0'";*/
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,cs_mst c,ulbmst u,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.app_type_id='1' and g.grievance_status_id IN('3','9','8') and gt.disposal_status !=5 and app_type_id='1' and sla_status='1'and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.dept_id IN( $deptlist ) and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('3','9','8') and gt.disposal_status !=5 and g.sla_status='1' and gsm.grievance_status_id IN ('3','9','8') and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				/*old 19-02-24 $sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,cs_mst c,ulbmst u,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN($deptlist) and 
				...
				/*$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN($deptlist) and gt.disposal_status IN('3','9','8') and g.grievance_status_id IN('3','9','8') and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null) group by g.grievance_id";*/
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and dept_id IN( $deptlist ) and app_type_id='1' and g.grievance_status_id IN('3','9','8') and gt.disposal_status !=5 and sla_status='1' and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				//$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,cs_mst c,ulbmst u,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN($deptlist) and 
				...
				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and dept_id IN( $deptlist ) and app_type_id='1' and g.grievance_status_id IN('3','9','8') and gt.disposal_status !=5 and sla_status='1' and cat3_id !='0'";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$sql = "SELECT g.*,gt.file_url as updated_imag,gt.dept_id FROM grievances g,cs_mst c,ulbmst u,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and g.grievance_status_id IN('3','9','8') and gt.disposal_status !=5 and sla_status=2 and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null) AND YEAR(date_regd) = '" . $selectedYear . "'";
				...
				g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and g.grievance_status_id IN('3','9','8') and gt.disposal_status !=5 and sla_status=2 and cat3_id !='0' and g.ward_id=w.ward_id and g.street_id=s.street_id and (is_reopened_yn='0' || is_reopened_yn is null) AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,cs_mst c,ulbmst u,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and g.grievance_status_id IN('2') and gt.disposal_status !=5 and sla_status=1 and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null) AND YEAR(date_regd) = '" . $selectedYear . "'";
				...
				g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and app_type_id='1' and g.grievance_status_id IN('2') and gt.disposal_status !=5 and sla_status=1 and cat3_id !='0' and g.ward_id=w.ward_id and g.street_id=s.street_id and (is_reopened_yn='0' || is_reopened_yn is null) AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				/*$sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,cs_mst c,ulbmst u, grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and 
				...
				g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and app_type_id='1' and g.grievance_status_id IN('2') and gt.disposal_status IN('2') and sla_status=1 and cat3_id !='0' and gt.disposal_status !=5 and g.ward_id=w.ward_id and (is_reopened_yn='0' || is_reopened_yn is null)";*/

				$sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,grievance_status_desc as Status ,date_regd as ReceivedDate FROM grievances g,cs_mst c,ulbmst u, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where 
				g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and app_type_id='1' and g.grievance_status_id IN('2') and gt.disposal_status !=5 and sla_status=1 and cat3_id !='0' and g.ward_id=w.ward_id and g.street_id=s.street_id and (is_reopened_yn='0' || is_reopened_yn is null)";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				...
				//$query = "SELECT count(DISTINCT g.grievance_id) as num,gt.dept_id FROM grievances g,category3_mst c,ulbmst u , grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,cs_mst c,ulbmst u ,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and g.grievance_status_id IN('2') and gt.disposal_status !=5 and sla_status=2 and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null) AND YEAR(date_regd) = '" . $selectedYear . "'";
		
				$sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,grievance_status_desc as Status ,date_regd as ReceivedDate FROM grievances g, ulbmst u, cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where 
				g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and g.grievance_status_id IN('2') and gt.disposal_status !=5 and sla_status=2 and cat3_id !='0' and g.ward_id=w.ward_id and g.street_id=s.street_id and (is_reopened_yn='0' || is_reopened_yn is null) AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				$sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,cs_mst c,ulbmst u ,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and 
				...
				/*$sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,grievance_status_desc as Status ,date_regd as ReceivedDate FROM grievances g, ulbmst u, cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where 
				g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and g.grievance_status_id IN('2') and gt.disposal_status IN('2') and sla_status=2 and cat3_id !='0' and gt.disposal_status !=5 and g.ward_id=w.ward_id and (is_reopened_yn='0' || is_reopened_yn is null)";*/

				$sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,grievance_status_desc as Status ,date_regd as ReceivedDate FROM grievances g, ulbmst u, cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where 
				g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and app_type_id='1' and gt.dept_id IN( $deptlist ) and g.grievance_status_id IN('2') and gt.disposal_status !=5 and sla_status=2 and cat3_id !='0' and g.ward_id=w.ward_id and g.street_id=s.street_id and (is_reopened_yn='0' || is_reopened_yn is null)";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN($deptlist) and g.grievance_status_id IN('6') and gt.disposal_status !=5 and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null) AND YEAR(date_regd) = '" . $selectedYear . "'";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.dept_id IN($deptlist) and g.grievance_status_id IN('6') and gt.disposal_status !=5 and cat3_id !='0' and g.ward_id=w.ward_id and g.street_id=s.street_id and (is_reopened_yn='0' || is_reopened_yn is null) AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				/*03-06-24 $sql = "SELECT g.*,gt.file_url as updated_image FROM grievances g,cs_mst c,ulbmst u ,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and g.grievance_status_id IN('6') and gt.disposal_status !=5 and cat3_id !='0' and gt.disposal_status !=5 and (is_reopened_yn='0' || is_reopened_yn is null)";*/

				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.dept_id IN($deptlist) and g.grievance_status_id IN('6') and gt.disposal_status !=5 and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null)";
				...
				/*03-06-24 $sqlExcel = "SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,grievance_status_desc as Status ,date_regd as ReceivedDate FROM grievances g,cs_mst c,ulbmst u, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and app_type_id='1' and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('6') and gt.disposal_status !=5 and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null)";*/

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.dept_id IN($deptlist) and g.grievance_status_id IN('6') and gt.disposal_status !=5 and cat3_id !='0' and g.ward_id=w.ward_id and g.street_id=s.street_id and (is_reopened_yn='0' || is_reopened_yn is null)";
			}
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances g,cs_mst c,ulbmst u ,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and g.grievance_status_id IN('6') and gt.disposal_status !=5 and cat3_id !='0' and (is_reopened_yn='0' || is_reopened_yn is null) AND YEAR(date_regd) = '" . $selectedYear . "'";
	...
	$tpl->assign('user_type2', 'D');

	$tpl->display('tot_received_dept.tpl');
} else {

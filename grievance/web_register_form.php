...
<body style="padding:0px; margin:0px;">
 ...
 ?> Aurangabad Municipal Corporation</strong>
		...
		<?php if (isset($_SESSION['register_form'])) {
				echo '<div class="alert alert-danger success_msg1" role="alert"><strong>USER REGISTRATION Failed because of : <br><ul> ' ?>
				<?php
				// Display cart
				foreach ($_SESSION['register_form'] as $key=>$product) {

...
if (isset($_SESSION['uid'])) {
	...
	$sql = "select g.*,count(cat3_id) as completed,cat3_id from grievances g,". $grievances_trns ." gt, ulbmst u,Districtmst d where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and 
	u.distid=d.distid and app_type_id='1' and g.ulbid like '%" . $_REQUEST['ulbid'] . "%' and grievance_status_id in ('3','6','8','9','12') ";
...
//echo $sql;exit;
	...
	$sql = "select g.*,count(cat3_id) as pendingforapproval,cat3_id from grievances g,". $grievances_trns ." gt, ulbmst u,Districtmst d where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and u.distid=d.distid 
	...
	$sql = "select g.*,count(cat3_id) as pending,cat3_id from grievances g,". $grievances_trns ." gt, ulbmst u,Districtmst d where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and u.distid=d.distid  and app_type_id='1' and g.ulbid like '%" . $_REQUEST['ulbid'] . "%' and grievance_status_id in ('2','11') ";

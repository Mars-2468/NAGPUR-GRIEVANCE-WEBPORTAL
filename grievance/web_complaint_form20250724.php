...
<body style="padding:0px; margin:0px;">
 ...
 ULB Name: <strong> <?php //echo $ulbName; 
			...
			<div class="col-md-4 comp-btn" style="text-align:right">
				<a class="btn btn-success " href="check_comp_status.php?id=<?php echo $ulbid; ?>" target="_blank" style="list-style:none; color:#FFF;margin-top: 23px;">Check Status / तक्रार स्थिती तपासा</a>
		...
		<div class="panel panel-info">
			...
			<form action="save_comp.php" id="myForm" class="form-horizontal" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
					...
					<span id="form">
						...
						<div class="d-flex">
							...
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<input readonly type="text" name="mobile" id="mobile" placeholder="Mobile No" value="<?php echo (isset($_SESSION['com_reg_mobile'])) ? $_SESSION['com_reg_mobile'] : '' ?>" class="form-control num mytext" maxlength="10" required>
							...
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<input type="email" name="email" id="email" placeholder="E-Mail ID" value="<?php echo $row['user_email']; ?>" readonly class="form-control">
						...
						<div class="d-flex">
							...
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<input type="text" name="hno" id="hno" placeholder="House No/Plot No" class="form-control mytext" value="<?php echo $row['house_no']; ?>" readonly required>
								</div>
							</div>
							...
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<input type="text" name="address" id="address" placeholder="Address " class="form-control mytext" value="<?php echo $row['address']; ?>" readonly required>
								</div>
							</div>
						...
						<div class="d-flex">
							...
							<div class="col-md-4">
								<div class="form-group col-md-12">
									<label>Ward No / वॉर्ड क्र. <span class="merror">*</span> </label>
									<select name="street_id" id="street_id" class="form-control dropdown" required>

										<option value="">-Select-</option>
									</select>
									<!--&#187; -->
									<u><a target="_blank" href="https://nmcnagpur.gov.in/grievance/zone-ward-and-area-details.pdf">Click here to know your Ward</a></u>
								</div>
							</div>
							...
							<div class="col-md-4">
								...
								<div class="form-group col-md-12">
									<label>Select Department / विभाग निवडा <?php //echo json_encode($cat_list);
																			?> <span class="merror">*</span> </label>
									<select name="cat_id" id="cat_id" class="form-control dropdown" onChange="get_sc_desc(this.value)" required>
							...
							<div class="col-md-4">
								...
								<div class="form-group col-md-12">
									<label>Select Sub Department / उप विभाग निवडा <span class="merror">*</span> </label>
									<select name="sub_id" id="sub_id" class="form-control dropdown" onchange="get_csdesc(this.value)" required>

										<option value="">-Select-</option>

									</select>
									<u id="property_tx_dept" style="display:none;"> <a target="_blank" href="https://nmcnagpur.gov.in/grievance/images/ward-details-for-property-tax-department.pdf">Click here to know your Ward</a></u>
								</div>

							</div>
						</div>
						<div class="row">
							<div class="col-md-3 property_tx_uptin_no" style="margin-left:15px; margin-right:15px;margin-top:10px;display:none;">
								<div class="form-group col-md-12">
									<label>UPIN/Index No. <span class="merror">*</span> </label>
									<input type="text" name="property_tx_uptin_no" id="property_tx_uptin_no" placeholder="UPIN/Index No." class="form-control ">
								</div>
							</div>
						...
						<div class="d-flex">
							...
							<div class="col-md-4">
								<div class="form-group col-md-12">
									...
									<!--<p class="text-danger"><?php echo $_SESSION['f1']; ?></p>-->
								</div>
							</div>
								...
								<div class="form-group col-md-12">
									...
									<div class="row form-group">
										<div class="col-md-12">
											...
											<input class="form-control" type="text" id="validate_captcha" data-validate="false" name="captcha" required autocomplete="off" />
										</div>
									</div>

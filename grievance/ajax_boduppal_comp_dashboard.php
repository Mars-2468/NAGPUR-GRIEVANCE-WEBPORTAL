...
<div class="boxed">
                ...
                <div class="row dashboard-stats">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    ...
                                    <p class="size-h1 no-margin countdown_first">
                                        <?php if($_SESSION['user_type']=='U'){
                                           ...
                                           echo "<a href='rep_comp_dept_abs_comp_boduppal.php' target='_blank'>".$data[1]['total_received']."</a>";
                        ...
                        <p class="size-h1 no-margin countdown_first">
                            ...
                            <?php if($_SESSION['user_type']=='U'){
                                            ...
                                            echo "<a href='tot_received_boduppal.php?aptid=1&status=1&sla=0&user_type=".$_SESSION['user_type']."' target='_blank'>".$data[1]['pendingforapproval']."</a>";
                                        }
                                        else if($_SESSION['user_type']=='E')
                                        {
               ...
               <p class="size-h1 no-margin countdown_first">
                   ...
                   <?php if($_SESSION['user_type']=='U'){
                                        ...
                                        echo "<a href='rep_comp_dept_abs_comp_boduppal.php' target='_blank'>".$data[1]['resolved_within_sla']."</a>";
                     ...
                     <p class="size-h1 no-margin countdown_first">
                          ...
                          <?php if($_SESSION['user_type']=='U'){
                                        ...
                                        echo "<a href='rep_comp_dept_abs_comp_boduppal.php' target='_blank'>".$data[1]['resolved_beyond_sla']."</a>";
    ...
    <p class="size-h1 no-margin countdown_first">
                                        ...
                                        <?php if($_SESSION['user_type']=='U')
                                        {
                                            ...
                                            echo "<a href='rep_comp_dept_abs_comp_boduppal.php' target='_blank'>".$data[1]['pending_with_sla']."</a>";
         ...
         <p class="size-h1 no-margin countdown_first">
                                        ...
                                        <?php if($_SESSION['user_type']=='U')
                                        {
                                            ...
                                            echo "<a href='rep_comp_dept_abs_comp_boduppal.php' target='_blank'>".$data[1]['pending_beyond_sla']."</a>";
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    ...
                                    echo "<a href='rep_comp_dept_abs_comp_boduppal.php' target='_blank'>".$reopened_completed_tot[1][13]['count']."</a>";
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">
                                         ...
                                         <?php if($_SESSION['user_type']=='U'){
                                           ...
                                           echo "<a href='rep_comp_dept_abs_comp_boduppal.php' target='_blank'>".$reopened_completed_tot[1][11]['count']."</a>";
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">
                                         <?php if($_SESSION['user_type']=='U'){
                                          ...
                                          echo "<a href='rep_comp_dept_abs_comp_boduppal.php' target='_blank'>".$reopened_completed_tot[1][12]['count']."</a>";
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_first">
                                         ...
                                         { 
                                             ...
                                             echo "<a href='rep_comp_dept_abs_comp_boduppal.php' target='_blank'>".$data[1]['unresolved']."</a>";

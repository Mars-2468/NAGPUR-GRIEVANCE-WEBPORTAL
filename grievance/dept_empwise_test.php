...
require "config.php";
	...
	if(isset($_SESSION['uid']))
	{
	   //session_regenerate_id();
		...
		$conn=getconnection();
		 ...
		 if($_REQUEST['f_date']!= '' && $_REQUEST['t_date']!='')
		 {
		    ...
		    $tpl->assign('tdate',date('Y-m-d',strtotime($_REQUEST['t_date'])));
                		...
                		$sql ="select COUNT(DISTINCT gt.grievance_id) as count,emp_id,g.date_regd  from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id and
		 ...
		 //echo $sql;
			...
			if($rs=mysqli_query($conn,$sql))
			{
			  while($row = mysqli_fetch_assoc($rs))
				...
				if($_SESSION['ulbid']=='3')
				 {
				     $sql1 ="select COUNT(DISTINCT g.grievance_id) as count1,emp_id,disposal_status,g.date_regd,g.sla_status from grievances g, 
		...
		if($_SESSION['ulbid']=='3')
			...
			$sql21 ="select COUNT(DISTINCT g.grievance_id) as count1,emp_id,disposal_status,g.date_regd,g.sla_status from grievances g, grievances_transactions gt where 
				 ...
				 $sql21="SELECT count(DISTINCT g.grievance_id) as count1,emp_id,disposal_status FROM grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and ulbid='".$_SESSION['ulbid']."' and 
    				 app_type_id='1' and grievance_status_id IN('3','9','8') and grievance_status_id IN('3','9','8') and sla_status=1 and cat3_id !='0' and gt.disposal_status!='5' and gt.dept_id='".$_REQUEST['dept_id']."'";
		...
		if($_SESSION['ulbid']=='3')
				 ...
				 $sql2="SELECT count(DISTINCT gt.grievance_id) as count2,emp_id  FROM grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and ulbid='".$_SESSION['ulbid']."' and 
    				 app_type_id='1' and grievance_status_id IN('3','9','8') and gt.disposal_status IN('3','9','8') and sla_status=2 and cat3_id !='0' and gt.disposal_status!='5' and gt.dept_id='".$_REQUEST['dept_id']."'"; 
		...
		if($_SESSION['ulbid']=='3')
    			...
    			grievances_transactions gt where 
				 ...
				 gt.disposal_status IN('2') and sla_status=1 and cat3_id !='0' and gt.disposal_status!='5' and gt.dept_id='".$_REQUEST['dept_id']."'";
			...
			if($_SESSION['ulbid']=='3')
				 ...
				 {
			$sql ="select COUNT(DISTINCT g.grievance_id) as count,emp_id as emp_dept from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and cat3_id !='0' and g.app_type_id='1' and gt.disposal_status IN ('10') and g.grievance_status_id IN ('10') and gt.disposal_status!='5'  and ulbid='".$_SESSION['ulbid']."' and gt.dept_id='".$_REQUEST['dept_id']."'";
				 }
			...
			g.grievance_id=gt.grievance_id  and cat3_id !='0' and g.app_type_id='1' 
			 and g.grievance_status_id IN ('6') and g.grievance_status_id IN ('6') and ulbid='".$_SESSION['ulbid']."' and gt.disposal_status!='5' and dept_id='".$_REQUEST['dept_id']."'";
       ...
       // print_r($emp_ids);
	        ...
	        $sql="select emp_id,emp_name from emp_mst where emp_id IN ('".implode("','",$emp_ids)."')"; 
			if($rs=mysqli_query($conn,$sql))
			{
				    while($row = mysqli_fetch_assoc($rs)){

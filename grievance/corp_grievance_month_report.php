<?php
	...
	if(isset($_SESSION['uid']))
	{
		...
		WHERE ward_id = " . $ward_id . " ";
		  ...
		  $sql .= " and date_regd >= DATE_SUB(CURDATE(), INTERVAL 1 WEEK) 
		  ...
		  $sql ="SELECT COUNT(grievance_id) AS count FROM grievances WHERE ward_id = " . $ward_id . " ";
		  $sql .= " and date_regd <= DATE_SUB(CURDATE(), INTERVAL 30 DAY); ";
		  $rs = mysqli_query($conn,$sql);
		  $row = mysqli_fetch_assoc($rs);
		...
		$tpl->display('corp_grievance_month_report.tpl');
	}
	else
	{

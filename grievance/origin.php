...
if (isset($_SESSION['uid'])) {
	...
	if ($_REQUEST['originid'] !== '') {
		...
		$sql = "select g.* from grievances g,". $grievances_trns ." gt where g.grievance_id=gt.grievance_id and app_type_id = '1' and ulbid = '" . $_REQUEST['ulbid'] . "' and cat3_id = '" . $_REQUEST['cat3_id'] . "'";

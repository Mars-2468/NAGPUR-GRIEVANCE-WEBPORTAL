...
//echo "<pre>";print_r($_POST);echo "</pre>";die();
	...
	$sql = "select * from  field_visit_form_docs where ulbid='" . mysqli_real_escape_string($conn, strip_tags($_SESSION['ulbid']))."' ";
	
	if ($id!='') {
		$sql .= " and field_visit_form_id =" . $id . " ";
	}
...
//echo "<pre>";print_r($desg_list);echo "</pre>";die();
	...
	$tpl->display('view_inspection_report.tpl');
} else {

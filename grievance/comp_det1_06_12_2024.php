...
if (isset($_SESSION['uid'])) {
	...
	if ($_REQUEST['status'] == 0) {
		...
		/*07-03-24 $sqlExcel ="select g.grievance_id as ReferenceNo,person_name as ApplicantName, mobile as Mobile,address as Address,comp_subject as Description,comp_desc,date_regd as ComplaintDate from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and  g.ulbid='".$_SESSION['ulbid']."' and
		g.app_type_id='".$_REQUEST['app_type_id']."' and gt.disposal_status!='5' and gt.dept_id='".$_REQUEST['dept_id']."' and gt.emp_id='".$_REQUEST['emp_id']."' and
		g.grievance_status_id IN('2') and sla_status='1'";*/

		/*26-03-24 $sqlExcel = "SELECT g.grievance_id as RefferenceNo, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,IF(is_escalated=1,'Escalated',grievance_status_desc) as Status ,date_regd as ReceivedDate FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and
		gt.disposal_status=gsm.grievance_status_id and gt.dept_id='" . $_REQUEST['dept_id'] . "' and gt.emp_id='" . $_REQUEST['emp_id'] . "' and app_type_id='1' and cat3_id !='0' and gt.disposal_status IN('2') and g.grievance_status_id IN('2') and sla_status='1' ";*/
		...
		$sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and g.ulbid='" . $_SESSION['ulbid'] . "' and
		g.app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.disposal_status IN('2') and g.grievance_status_id IN('2') and gt.dept_id='" . $_REQUEST['dept_id'] . "' and gt.emp_id='" . $_REQUEST['emp_id'] . "' and sla_status='2'";
		...
		//26-03-24 $sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid='" . $_SESSION['ulbid'] . "' and g.app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.disposal_status IN('3','8','9') and gt.dept_id='" . $_REQUEST['dept_id'] . "' and gt.emp_id='" . $_REQUEST['emp_id'] . "'  and g.grievance_status_id IN('3','8','9') and sla_status='1'";

		$sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid='" . $_SESSION['ulbid'] . "' and g.app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.disposal_status NOT IN('5') and gt.dept_id='" . $_REQUEST['dept_id'] . "' and gt.emp_id='" . $_REQUEST['emp_id'] . "'  and g.grievance_status_id IN('3','8','9') and sla_status='1'";
		//echo $sql;
		...
		/*23-05-24 $sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and cat3_id !='0' and g.app_type_id='1' and gt.disposal_status IN('9','12') and g.grievance_status_id IN('13') and ulbid='" . $_SESSION['ulbid'] . "' and gt.dept_id='" . $_REQUEST['dept_id'] . "' and gt.emp_id='" . $_REQUEST['emp_id'] . "'";
		...
		$sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id
	...
	// else if($_REQUEST['status']==6)
		...
		if ($_REQUEST['user_type'] == 'E') {
			$sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id and cat3_id !='0' and g.app_type_id='1' and g.grievance_status_id IN('11') and gt.disposal_status IN('11') and ulbid='" . $_SESSION['ulbid'] . "' and gt.dept_id='" . $_REQUEST['dept_id'] . "' and gt.emp_id='" . $_REQUEST['emp_id'] . "'";
		...
		//old $sql ="select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and cat3_id !='0' and g.app_type_id='1' and gt.disposal_status IN('12')  and ulbid='".$_SESSION['ulbid']."' and gt.dept_id='".$_REQUEST['dept_id']."' and gt.emp_id='".$_REQUEST['emp_id']."'";

		//11-03-24 $sql ="select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id and cat3_id !='0' and g.app_type_id='1' and gt.disposal_status IN('12') and gt.disposal_status NOT IN('5','9','13') and ulbid='".$_SESSION['ulbid']."' and gt.dept_id='".$_REQUEST['dept_id']."' and gt.emp_id='".$_REQUEST['emp_id']."'";
		...
		/*04-03-24 $sqlExcel ="select g.grievance_id as ReferenceNo,person_name as ApplicantName, mobile as Mobile,address as Address,comp_subject as Description,comp_desc,date_regd as ComplaintDate from grievances g, 
		...
		//$sqlExcel = "select g.grievance_id as ReferenceNo,person_name as ApplicantName, mobile as Mobile,address as Address,comp_subject as Description,comp_desc,date_regd as ComplaintDate from grievances g, 
		//grievances_transactions gt where g.grievance_id=gt.grievance_id and g.app_type_id='1' and gt.disposal_status NOT IN('5','9','13') and g.grievance_status_id IN('12') and gt.dept_id='".$_REQUEST['dept_id']."' and gt.emp_id='".$_REQUEST['emp_id']."' and g.ulbid='" . $_SESSION['ulbid'] . "' and cat3_id !='0'  ";
		...
		$sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and cat3_id !='0' and g.app_type_id='1' and g.grievance_status_id IN('6') and gt.disposal_status IN('6') and ulbid='" . $_SESSION['ulbid'] . "' and gt.dept_id='" . $_REQUEST['dept_id'] . "' and gt.emp_id='" . $_REQUEST['emp_id'] . "'";
		//$sqlExcel ="select g.grievance_id as ReferenceNo,person_name as ApplicantName, mobile as Mobile,address as Address,comp_subject as Description,date_regd as ComplaintDate,grievance_status_desc as Status,".$fieldName." as Details from grievances g, grievances_transactions gt,grievance_status_mst s,".$table." c where g.grievance_id=gt.grievance_id  and g.grievance_status_id=s.grievance_status_id and g.cat3_id=c.cs_id and g.app_type_id='1' and gt.disposal_status IN('12')  and ulbid='".$_SESSION['ulbid']."' and gt.dept_id='".$_REQUEST['dept_id']."' and gt.emp_id='".$_REQUEST['emp_id']."'";

		/*04-03-24 $sqlExcel ="select g.grievance_id as ReferenceNo,person_name as ApplicantName, mobile as Mobile,address as Address,comp_subject as Description,comp_desc,date_regd as ComplaintDate from grievances g, 
        grievances_transactions gt where g.grievance_id=gt.grievance_id  and g.grievance_status_id=s.grievance_status_id and g.cat3_id=c.cs_id and g.app_type_id='1' and gt.disposal_status IN('6')  and ulbid='".$_SESSION['ulbid']."' and gt.dept_id='".$_REQUEST['dept_id']."' and gt.emp_id='".$_REQUEST['emp_id']."'";*/

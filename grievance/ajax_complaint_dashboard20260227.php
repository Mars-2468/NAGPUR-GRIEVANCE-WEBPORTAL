...
//$start_time = hrtime(true);
	...
	if ($_SESSION['user_type'] == 'A') {
		...
		//$sql = "SELECT count(DISTINCT(g.grievance_id)) as count,g.app_type_id FROM ".$_SESSION['grievances_trns']." gt,grievances g where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and g.grievance_status_id IN(2,3,5,6,8,9,10,11,12,13) and gt.disposal_status IN(2,3,5,6,8,9,10,11,12,13) and g.app_type_id='1' and g.ulbid='" . strip_tags($_SESSION['ulbid']) . "'  and g.cat3_id!='0' AND date_format(date_regd,'%Y') = '" . $selectedYear . "'";
	...
	if ($_SESSION['user_type'] == 'A') {
		...
		if ($_SESSION['ulbid'] == (int)$mergedulbs) {
			...
			if ($selectedYear) {
				...
				$sql = "SELECT COUNT(DISTINCT grievance_id) AS count,app_type_id FROM grievances WHERE date_format(date_regd,'%Y-%m-%d') = '" . $date . "' and ulbid='" . strip_tags($_SESSION['ulbid']) . "' and app_type_id='1' and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			
			} else {
			
				$sql = "SELECT count(grievance_id) as count,app_type_id FROM grievances  where date_format(date_regd,'%Y-%m-%d') = '" . $date . "' and ulbid='" . strip_tags($_SESSION['ulbid']) . "' and app_type_id='1' and cat3_id !='0' and grievance_status_id in(2,3,5,6,8,9,10,11,12,13) ";
		...
		if ($selectedYear) {
			...
			$sql = "SELECT count(DISTINCT(g.grievance_id)) as count,app_type_id FROM ".$_SESSION['grievances_trns']." gt,grievances g where DATE(date_regd) = '" . $date . "' and g.grievance_id=gt.grievance_id and emp_id IN('" . $emplist . "') and gt.disposal_status !=5 and app_type_id='1' and cat3_id !='0' and date_format(date_regd,'%Y') = '" . $selectedYear . "'";
...
// Resolved beyond sla start 3,8,9
	...
	if ($_SESSION['user_type'] == 'A') {
		...
		if ($selectedYear) {
			...
			//$sql = "SELECT count(DISTINCT(g.grievance_id)) as count,g.app_type_id FROM ".$_SESSION['grievances_trns']." gt,grievances g where g.grievance_id=gt.grievance_id and emp_id IN('" . $emplist . "') and g.grievance_status_id IN('3','6','8','9') and g.app_type_id='1' and g.ulbid='" . strip_tags($_SESSION['ulbid']) . "' and g.sla_status=2 and cat3_id !='0' and date_format(date_regd,'%Y') = '" . $selectedYear . "'";
			...
			//$sql = "SELECT count(DISTINCT(g.grievance_id)) as count, g.app_type_id FROM ".$_SESSION['grievances_trns']." gt,grievances g where g.grievance_id=gt.grievance_id and emp_id IN('" . $emplist . "') and g.grievance_status_id IN('3','6','8','9') and g.sla_status=2 and ulbid='" . strip_tags($_SESSION['ulbid']) . "' and g.app_type_id='1' and cat3_id !='0' ";
...
// under progress with in sla start 2
	...
	if ($_SESSION['user_type'] == 'A') {
		...
		if ($selectedYear) {
			...
			//$sql = "SELECT count(DISTINCT g.grievance_id) as count,g.app_type_id FROM ".$_SESSION['grievances_trns']." gt,grievances g where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and gt.disposal_status IN(2) and g.grievance_status_id IN(2) and g.app_type_id='1' and g.ulbid='" . strip_tags($_SESSION['ulbid']) . "' and g.sla_status=1 and cat3_id !='0' and (gt.is_reopened_yn='0' || gt.is_reopened_yn is null) and date_format(date_regd,'%Y') = '" . $selectedYear . "'";
			...
			//$sql = "SELECT count(DISTINCT g.grievance_id) as count,g.app_type_id FROM ".$_SESSION['grievances_trns']." gt,grievances g where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and gt.disposal_status IN(2) and g.grievance_status_id IN(2) and g.app_type_id='1' and g.ulbid='" . strip_tags($_SESSION['ulbid']) . "' and g.sla_status=1 and cat3_id !='0' and (gt.is_reopened_yn='0' || gt.is_reopened_yn is null) ";
		...
		//Escalated
				...
				$sqlEsc ="SELECT count(DISTINCT (gt.grievance_id)) as count, cat3_id,description,cm.cat_id,c.sub_cat_id,ward_id,g.app_type_id,date_regd  
							...
							where g.grievance_id=gt.grievance_id and
								  ...
								  g.app_type_id=1 and  
								  g.ulbid='" . strip_tags($_SESSION['ulbid']) . "'  and  
								  is_escalated = 1  ";
						...
						<div class="panel-right panel-icon bg-reverse">
							<p class="size-h1 no-margin countdown_first">
								<?php 
									...
									$fin_implications=!empty($data[1]['fin'])?$data[1]['fin']:0;
					...
					<section class="panel panel-box myshadow">
						...
						<div class="panel-right panel-icon bg-reverse">
							<p class="size-h1 no-margin countdown_first">
								...
								$reopen_count=!empty($data[1]['reopened_count'])?$data[1]['reopened_count']:0;
					...
					<section class="panel panel-box myshadow">
						...
						<div class="panel-right panel-icon bg-reverse">
							<p class="size-h1 no-margin countdown_first">
								...
								$reopened_completed=!empty($data[1]['reopened_completed'])?$data[1]['reopened_completed']:0;
					...
					<section class="panel panel-box myshadow">
						...
						<div class="panel-right panel-icon bg-reverse">
							<p class="size-h1 no-margin countdown_first">
								...
								$reopen_under_progress=!empty($data[1]['reopened_under_progress'])?$data[1]['reopened_under_progress']:0;

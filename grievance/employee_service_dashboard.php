...
require "config.php";
	...
	if(isset($_SESSION['uid']))
	{
	   ...
	   // session_regenerate_id();
		...
		$sql ="select COUNT(g.grievance_id) as count,emp_id,g.date_regd  from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id and g.app_type_id='2' and gt.disposal_status NOT IN('5','11','12') and g.cat3_id !='0' and 
			...
			if($rs=mysqli_query($conn,$sql))
			{
			  while($row = mysqli_fetch_assoc($rs))
				...
				$sql1 ="select COUNT(g.grievance_id) as count1,emp_id,disposal_status,g.date_regd,g.sla_status from grievances g, 
				 ...
				 g.grievance_id=gt.grievance_id and g.app_type_id='2' and 
		...
		if($rs1=mysqli_query($conn,$sql1))
		{
		  while($row = mysqli_fetch_assoc($rs1))
			...
			$sql21 ="select COUNT(g.grievance_id) as count1,emp_id,disposal_status,g.date_regd,g.sla_status from grievances g, grievances_transactions gt where 
				 ...
				 gt.disposal_status IN ('3','9','8')  and is_reopened_yn='0' ";
		...
		//print_r($data_list);
			...
			$sql ="select COUNT(g.grievance_id) as count,emp_id as emp_dept from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and cat3_id !='0' and g.app_type_id='2'  and gt.disposal_status IN('11')  and gt.dept_id='".$_SESSION['emp_dept_id']."' group by gt.emp_id";
			$rs=mysqli_query($conn,$sql);
			while($row = mysqli_fetch_assoc($rs))
			{
				...
				// reopened Completed
			$sql ="select COUNT(g.grievance_id) as count,emp_id as emp_dept from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and cat3_id !='0' and g.app_type_id='2'  and g.grievance_status_id IN ('12') and gt.disposal_status NOT IN('5','9') and gt.dept_id='".$_SESSION['emp_dept_id']."' group by gt.emp_id";
			$rs=mysqli_query($conn,$sql);
			while($row = mysqli_fetch_assoc($rs))
			{
			...
			$sql ="select COUNT(g.grievance_id) as count,emp_id as emp_dept from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and cat3_id !='0' and g.app_type_id='2' and gt.disposal_status IN ('10') and gt.disposal_status!='5' and gt.dept_id='".$_SESSION['emp_dept_id']."' group by gt.emp_id";
			...
			$sql ="select COUNT(g.grievance_id) as count,emp_id as emp_dept from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and cat3_id !='0' and g.app_type_id='2' and gt.disposal_status IN ('6') and gt.disposal_status!='5' and gt.dept_id='".$_SESSION['emp_dept_id']."' group by gt.emp_id";
	...
	$tpl->assign('user_type',$_SESSION['user_type']);
		...
		$tpl->display('employee_service_dashboard.tpl');
	}
	else
	{

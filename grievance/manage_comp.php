...
if (isset($_SESSION['uid'])) {
	...
	$app_type_id    = '%' . trim(preg_replace('/[^A-Za-z0-9]/',' ', $_POST['app_type_id'] ?? '')) . '%';
	$ref_no         = '%' . trim(preg_replace('/[^A-Za-z0-9]/',' ', $_POST['ref_no'] ?? '')) . '%';
	$applicant_name = '%' . trim(preg_replace('/[^A-Za-z0-9]/',' ', $_POST['applicant_name'] ?? '')) . '%';
	$mobile         = '%' . trim(preg_replace('/[^A-Za-z0-9]/',' ', $_POST['mobile'] ?? '')) . '%';
	$ward_id        = '%' . trim(preg_replace('/[^A-Za-z0-9]/',' ', $_POST['ward_id'] ?? '')) . '%';
	$dept_id        = '%' . trim(preg_replace('/[^A-Za-z0-9]/',' ', $_POST['dept_id'] ?? '')) . '%';
	$cat3_id        = '%' . trim(preg_replace('/[^A-Za-z0-9]/',' ', $_POST['cat3_id'] ?? '')) . '%';


	$ulbid  = $_SESSION['ulbid'] ?? '';
	$utype  = $_SESSION['user_type'] ?? '';
	$mc_yn  = $_SESSION['mc_yn'] ?? 0;
	...
	if ($_SESSION['user_type'] == 'A') {
		$sql = "select DISTINCT g.grievance_id,person_name,email,hno,address,ward_id,street_id,g.mobile,comp_subject,comp_desc,grievance_origin_id,
		  grievance_status_id,date_regd,cat3_id,file_no,app_type_id,mcat3_id,gt.dept_id,g.grievance_at_emp_level from grievances_transactions,emp_mst where grievances_transactions.emp_id=emp_mst.emp_id and 
			 grievance_status_id ='2' and app_type_id like '%" . $app_type_id . "%' and g.grievance_id like '%" .$ref_no . "%' and 
			 g.person_name like '%" .$applicant_name . "%' and g.mobile like '%" . $mobile . "%' and 
			 ward_id like '%" . $ward_id . "%' and gt.dept_id like '%" . $dept_id . "%' and 
			 g.cat3_id like '%" . $cat3_id . "%' order by grievance_id desc";
		...
		if ($_SESSION['mc_yn'] == 1) {
		  ...
		  grievance_status_id,date_regd,cat3_id,file_no,app_type_id,mcat3_id,gt.dept_id,g.grievance_at_emp_level from grievances_transactions gt,emp_mst e,grievances g where 
			 g.grievance_id=gt.grievance_id and gt.emp_id=e.emp_id and g.grievance_status_id IN('2','11','6','13') and g.ulbid='" . $ulbid . "' and 
			 app_type_id like '%" . $app_type_id . "%' and g.grievance_id like '%" . $ref_no . "%' and 
			 g.person_name like '%" . $applicant_name . "%' and g.mobile like '%" . $mobile . "%' and 
			 ward_id like '%" . $ward_id . "%' and gt.dept_id like '%" . $dept_id . "%' and g
			 .cat3_id like '%" . $cat3_id . "%' order by g.grievance_id desc";
		  ...
		  grievance_status_id,date_regd,cat3_id,file_no,app_type_id,mcat3_id,gt.dept_id,g.grievance_at_emp_level from grievances_transactions gt,emp_mst e,grievances g where 
			 ...
			 and g.grievance_status_id IN('2','11','6') and g.ulbid='" . $ulbid . "' and 
			 app_type_id like '%" . $app_type_id . "%' and g.grievance_id like '%" . $ref_no . "%' and 
			 g.person_name like '%" . $applicant_name . "%' and g.mobile like '%" . $mobile . "%' and 
			 ward_id like '%" . $ward_id . "%' and gt.dept_id like '%" . $dept_id . "%' and g
			 .cat3_id like '%" . $cat3_id . "%' order by g.grievance_id desc";
			...
			$sql2 = "select DISTINCT g.grievance_id,person_name,email,hno,address,ward_id,street_id,g.mobile,comp_subject,comp_desc,grievance_origin_id,
		  grievance_status_id,date_regd,cat3_id,file_no,app_type_id,mcat3_id,gt.dept_id,g.grievance_at_emp_level from grievances_transactions gt,emp_mst_od e,grievances g where 
			 g.grievance_id=gt.grievance_id and gt.emp_id=e.emp_id and g.grievance_status_id IN('2','11','6') and g.ulbid='" . $ulbid . "' and 
			 app_type_id like '%" . $app_type_id . "%' and g.grievance_id like '%" . $ref_no . "%' and 
			 g.person_name like '%" . $applicant_name . "%' and g.mobile like '%" . $mobile . "%' and 
			 ward_id like '%" . $ward_id . "%' and gt.dept_id like '%" . $dept_id . "%' and g
			 .cat3_id like '%" . $cat3_id . "%' order by g.grievance_id desc";
		...
		$sql = "select DISTINCT g.grievance_id,person_name,email,hno,address,ward_id,street_id,g.mobile,comp_subject,comp_desc,grievance_origin_id,
		  grievance_status_id,date_regd,cat3_id,file_no,app_type_id,mcat3_id,gt.dept_id,g.grievance_at_emp_level from grievances_transactions gt,emp_mst e,grievances g where 
			 g.grievance_id=gt.grievance_id and gt.emp_id=e.emp_id and g.grievance_status_id IN('2','11','6') and g.ulbid='" . $ulbid . "' 
			 and gt.emp_id IN('" . $emplist . "') and app_type_id like '%" . $app_type_id . "%' and 
			 g.grievance_id like '%" . $ref_no . "%' and g.person_name like '%" . $applicant_name . "%' and 
			 g.mobile like '%" . $mobile . "%' and ward_id like '%" . $ward_id . "%' and 
			 gt.dept_id like '%" . $dept_id . "%' and g.cat3_id like '%" . $cat3_id . "%' order by g.grievance_id desc";
		//echo $sql;

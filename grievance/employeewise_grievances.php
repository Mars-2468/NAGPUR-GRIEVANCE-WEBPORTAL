...
if (isset($_SESSION['uid'])) {
	...
	$ulbid = $_REQUEST['ulbid']??$_SESSION['ulbid'];
	...
	if (isset($_POST['search'])) {
		if ($_POST['reference_no'] != '') {
			$baseSql .= " and g.grievance_id='" . $_POST['reference_no'] . "' ";
			$baseSqlExcel .= " and g.grievance_id='" . $_POST['reference_no'] . "'";
		}
	...
	//pending beyond sla
		...
		$sql = $baseSql . " AND g.grievance_status_id IN(2,13,11) AND gt.disposal_status IN(2,13,11) ";
		$sqlExcel = $baseSqlExcel . " AND g.grievance_status_id IN(2,13,11) AND gt.disposal_status IN(2,13,11) ";
	...
	//completed beyond sla
		...
		$sql = $baseSql . " AND g.grievance_status_id IN(3,6,8,9,12) ";
		$sqlExcel = $baseSqlExcel . " AND g.grievance_status_id IN(3,6,8,9,12) ";
	...
	// Transfers
		...
		$sqlExcel = $baseSqlExcel . " AND g.grievance_status_id IN(5,10) AND gt.disposal_status IN(5,10) ";

	...
	if ($_REQUEST['aptid'] == 1 && $_REQUEST['user_type'] == 'U') {
		...
		if ($_REQUEST['status'] == 111 && $_REQUEST['sla'] == 0) {
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				...
				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(gt.disposed_date,g.date_regd) - ccm.cutt_off_time - g.holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where DATE(g.date_regd) = '" . $date . "' and g.grievance_id=gt.grievance_id and 
		...
		if ($_REQUEST['status'] == 0 && $_REQUEST['sla'] == 0) {
			...
			$sql = "SELECT g.*,gt.emp_id,gt.dept_id,gt.disposal_status FROM grievances g, grievances_transactions gt,ulbmst u ,cs_mst c where g.grievance_id=gt.grievance_id and
...
//user type U
			...
			$sql = "Select g.*,gt.file_url as updated_image,gt.disposal_status, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date,gt.disposal_status from grievances g,ulbmst u ,cs_mst c,(SELECT * FROM grievances_transactions gi WHERE transaction_id = ( SELECT MAX(t.transaction_id) FROM grievances_transactions t WHERE t.grievance_id = gi.grievance_id ) )gt,comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and g.grievance_status_id IN('5','10') and g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and g.app_type_id='1'";

			//echo "<pre>";print_r($sql);echo "</pre>";die();

			/* $sql = "SELECT g.* ,gt.emp_id,gt.dept_id,gt.disposal_status FROM grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id and
			...
			*/
			...
			"SELECT c.cs_desc as CategoryName,g.grievance_id as RefrenceNo,g.eoffice_no as EofficeNo, person_name as PersonName, g.mobile as Mobile,g.address as Address,c.cs_desc as ComplaintDetails,grievance_status_desc as Status ,date_regd as ReceivedDate FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt,grievance_status_mst gsm where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and app_type_id='1' and gt.emp_id IN('87') and (gt.disposal_status =5 or (gt.disposal_status =5 and is_escalated=1))";
			...
			$query = "SELECT count(grievance_id) as num FROM grievances g,ulbmst u ,cs_mst c, grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and g.ulbid='" . $_SESSION['ulbid'] . "' and g.grievance_status_id IN('5') and gt.disposal_status IN('2','5','10') ";
	...
	if ($_REQUEST['aptid'] == 1 && $_REQUEST['user_type'] == 'E') {
		...
		if ($_REQUEST['status'] == 111 && $_REQUEST['sla'] == 0) {
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				...
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.grievance_status_id IN ('3','6','8','9','12') and gt.disposal_status IN ('3','6','8','9','12') and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate, gt.disposal_status from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN ('3','6','8','9','12') and gt.disposal_status IN ('3','6','8','9','12') and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {

				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date,gt.disposal_status FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.grievance_status_id IN ('3','6','8','9','12') and gt.disposal_status IN ('3','6','8','9','12') and cat3_id !='0' ";
			...
			if ($selectedYear) {
				$sql = "SELECT g.*,gt.file_url as updated_image,gt.disposal_status, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and gt.disposal_status IN('2','11') and g.grievance_status_id IN('2','11')  and cat3_id !='0'  and cat3_id !='0' and (gt.is_reopened_yn='0' || gt.is_reopened_yn is null) AND YEAR(date_regd) = '" . $selectedYear . "'";
				...
				$sql = "SELECT g.*,gt.file_url as updated_image,gt.disposal_status, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and gt.disposal_status IN('2','11') and g.grievance_status_id IN('2','11') and cat3_id !='0'  and cat3_id !='0' and (gt.is_reopened_yn='0' || gt.is_reopened_yn is null) ";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate,gt.disposal_status from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and gt.disposal_status IN('2','11') and cat3_id !='0' and g.grievance_status_id IN('2','11') and g.ward_id=w.ward_id and g.street_id=s.street_id ";
			}
			...
			if ($selectedYear) {
				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.emp_id IN ('" . $emplist . "') and gt.disposal_status IN('2','11') and app_type_id='1' and g.grievance_status_id IN('2','11') and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {

				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.emp_id IN ('" . $emplist . "') and gt.disposal_status IN('2','11') and app_type_id='1' and g.grievance_status_id IN('2','11') and cat3_id !='0'";
			}
			...
			if ($selectedYear) {
				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(gt.disposed_date,g.date_regd) - ccm.cutt_off_time - g.holidays_added AS no_of_days_exeed, DATE_ADD(g.date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date,gt.disposal_status FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and cat3_id !='0' and gt.disposal_status IN(2,3,6,8,9,11,12,13) and g.grievance_status_id IN(2,3,6,8,9,11,12,13)  AND YEAR(date_regd) = '" . $selectedYear . "'";
				...
				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(gt.disposed_date,g.date_regd) - ccm.cutt_off_time - g.holidays_added AS no_of_days_exeed, DATE_ADD(g.date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date,gt.disposal_status FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and cat3_id!='0' and gt.disposal_status IN(2,3,6,8,9,11,12,13) and g.grievance_status_id IN(2,3,6,8,9,11,12,13)  ";
...
// user type E
			...
			if ($selectedYear) {
				/* $sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date,gt.disposal_status FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and gt.disposal_status IN('5','10') and g.grievance_status_id IN('5','10')  and cat3_id !='0'  and cat3_id !='0' and (gt.is_reopened_yn='0' || gt.is_reopened_yn is null) AND YEAR(date_regd) = '" . $selectedYear . "'";
				*/
				$sql = "Select g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date,gt.disposal_status from grievances g,,ulbmst u ,cs_mst c,(SELECT * FROM grievances_transactions gi WHERE transaction_id = ( SELECT MAX(transaction_id) FROM grievances_transactions WHERE grievance_id = gi.grievance_id ) )gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and g.grievance_status_id IN('5','10') and gt.emp_id IN('" . $emplist . "') and g.ulbid=u.ulbid and  g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and g.app_type_id='1' AND YEAR(date_regd) = '" . $selectedYear . "'";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate,gt.disposal_status from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.grievance_status_id IN('5','10') and cat3_id !='0' and gt.disposal_status IN('5','10') and g.ward_id=w.ward_id and g.street_id=s.street_id AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {

				/* $sql = "SELECT g.*,gt.file_url as updated_image,gt.disposal_status, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date,gt.disposal_status FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and gt.emp_id IN('" . $emplist . "') and gt.disposal_status IN('5','10') and g.grievance_status_id IN('5','10') and cat3_id !='0'  ";
				 */
				 
				$sql = "Select g.*,gt.* from grievances g,(SELECT * FROM grievances_transactions gi WHERE transaction_id = ( SELECT MAX(transaction_id) FROM grievances_transactions WHERE grievance_id = gi.grievance_id ) )gt where g.grievance_id=gt.grievance_id and g.grievance_status_id IN('5','10') and gt.emp_id IN('" . $emplist . "') and g.cat3_id!=0 and g.ulbid='".$_SESSION['ulbid']."' and g.app_type_id='1'";
			...
			if ($selectedYear) {
				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.emp_id IN ('" . $emplist . "') and gt.disposal_status IN('5','10') and gt.disposal_status IN('5','10') and app_type_id='1' and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {

				$query = "SELECT count(DISTINCT g.grievance_id) as num FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.emp_id IN ('" . $emplist . "') and gt.disposal_status IN('5','10') and gt.disposal_status IN('5','10') and app_type_id='1' and cat3_id !='0'";
			}
	...
	//within sla	
			...
			if ($selectedYear) {
				$sql = "SELECT g.*,gt.file_url as updated_image,gt.disposal_status, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,cs_mst c,ulbmst u,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and gt.disposal_status IN('3','6','8','9','12') 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and grievance_status_id IN('3','6','8','9','12') and sla_status=1 and gt.is_escalated=0 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
				...
				$sql = "SELECT g.*,gt.file_url as updated_image,gt.disposal_status, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,cs_mst c,ulbmst u,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and gt.disposal_status IN('3','6','8','9','12') 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and grievance_status_id IN('3','6','8','9','12') and sla_status=1 and gt.is_escalated=0 and cat3_id !='0' ";
	...
	//beyound sal
			...
			if ($selectedYear) {
				...
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and grievance_status_id IN('3','6','8','9','12') and sla_status=2 and gt.disposal_status IN('3','6','8','9','12')  AND YEAR(date_regd) = '" . $selectedYear . "'";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('3','6','8','9','12') and sla_status=2 and gt.disposal_status IN('3','6','8','9','12') and cat3_id !='0'  AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {

				$sql = "SELECT g.*,gt.file_url as updated_image,gt.disposal_status, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,cs_mst c,ulbmst u,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and grievance_status_id IN('3','6','8','9','12') and sla_status=2 and gt.disposal_status IN('3','6','8','9','12') ";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('3','6','8','9','12') and sla_status=2 and gt.disposal_status IN('3','6','8','9','12') and cat3_id !='0' ";
			}
...
//user type E			
			...
			if ($selectedYear) {
				$sql = "SELECT g.*,gt.file_url as updated_image,gt.disposal_status, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and and app_type_id='1' and g.grievance_status_id IN('2','11') and gt.disposal_status IN('2','11') and sla_status=1  and  (gt.is_reopened_yn='0' || gt.is_reopened_yn is null) AND YEAR(date_regd) = '" . $selectedYear . "'";
				...
				$sql = "SELECT g.*,gt.file_url as updated_image,gt.disposal_status, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,ulbmst u ,cs_mst c,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and app_type_id='1' and g.grievance_status_id IN('2','11') and gt.disposal_status IN('2','11') and g.sla_status=1 and (gt.is_reopened_yn='0' || gt.is_reopened_yn is null) ";
...
// user type E
			...
			if ($selectedYear) {
				$sql = "SELECT g.*,gt.file_url as updated_image, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date,gt.disposal_status FROM grievances g,cs_mst c,ulbmst u ,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
			...
			if ($selectedYear) {
				$sql = "SELECT g.*,gt.file_url as updated_image,gt.disposal_status, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,cs_mst c,ulbmst u ,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
				g.ulbid=u.ulbid and app_type_id='1' and g.grievance_status_id IN('11','12','13') and gt.disposal_status IN('11','12','13') and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('11','12','13') and gt.disposal_status IN('11','12','13') and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				$sql = "SELECT g.*,gt.file_url as updated_image,gt.disposal_status, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,cs_mst c,ulbmst u ,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
				g.ulbid=u.ulbid and app_type_id='1' and g.grievance_status_id IN('11','12','13') and gt.disposal_status IN('11','12','13') and cat3_id !='0'";

				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
				and g.ulbid=u.ulbid and g.app_type_id='1' and gt.emp_id IN('" . $emplist . "') and g.ward_id=w.ward_id and g.street_id=s.street_id and g.grievance_status_id IN('11','12','13') and gt.disposal_status IN('11','12','13') and cat3_id !='0'";
			}
			...
			if ($selectedYear) {
				$sql = "SELECT g.*,gt.file_url as updated_image,gt.disposal_status, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,cs_mst c,ulbmst u ,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.disposal_status =12 and g.grievance_status_id IN('12') and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
				...
				$sql = "SELECT g.*,gt.file_url as updated_image,gt.disposal_status, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,cs_mst c,ulbmst u ,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.disposal_status =12 and g.grievance_status_id IN('12') and cat3_id !='0'";
			...
			if ($selectedYear) {
				...
				$sql = "SELECT g.*,gt.file_url as updated_image,gt.disposal_status, gt.disposed_date, gt.dept_id, gt.emp_id,DATEDIFF(disposed_date,g.date_regd)-ccm.cutt_off_time-holidays_added AS no_of_days_exeed, DATE_ADD(date_regd, INTERVAL ss.cutt_off_time DAY) as comp_date FROM grievances g,cs_mst c,ulbmst u ,grievances_transactions gt, comp_cutofdays_map ccm, standard_services ss where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
				g.ulbid=u.ulbid and g.mcat3_id=ccm.cs_id and g.cat3_id=c.cs_id and g.app_type_id='1' and g.grievance_status_id=11 and gt.disposal_status=11 and g.cat3_id !='0'";
//echo "<pre>";print_r($sql);echo "</pre>";die();
				$sqlExcel = "SELECT c.cs_desc as CategoryName, g.grievance_id as ReferenceNo,w.ward_desc as ZoneName,s.street_desc as WardName, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,ulbmst u ,cs_mst c, grievances_transactions gt,grievance_status_mst gsm,ward_mst w,street_mst s where g.grievance_id=gt.grievance_id 
			...
			if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
				$query = "SELECT count(DISTINCT g.grievance_id) as num, gt.disposal_status FROM grievances g,cs_mst c,ulbmst u ,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
				g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1' and gt.disposal_status IN('11') and g.grievance_status_id IN('11') and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
			} else {
				$query = "SELECT count(DISTINCT g.grievance_id) as num, gt.disposal_status FROM grievances g,cs_mst c,ulbmst u ,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id IN('" . $emplist . "') and 
...
//user type E
	...
	if ($_REQUEST['aptid'] == 2 && $_REQUEST['user_type'] == 'E') {
		...
		if ($_REQUEST['status'] == 0 && $_REQUEST['sla'] == 0) {
			...
			$sql = "SELECT g.*,gt.disposed_date,gt.disposal_status FROM grievances g,ulbmst u ,standard_services c,grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and 

			g.mcat3_id=c.cs_id and app_type_id='2' and gt.emp_id IN('" . $emplist . "') and gt.disposal_status !=5 ";


			$sqlExcel = "SELECT c.comp_desc as CategoryName,g.grievance_id as RefrenceNo,g.eoffice_no as EofficeNo, person_name as PersonName, g.mobile as Mobile,g.address as Address,date_regd as ServiceRegisterDate grievance_status_desc as Status ,date_regd as ReceivedDate,gt.disposal_status FROM grievances g,ulbmst u ,standard_services c,grievances_transactions gt,grievance_status_mst gsm where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and 
...
//echo"<pre>";print_r($data);echo"<pre>";die();
	...
	if ($rs = mysqli_query($conn, $sql)) {
		...
		while ($row = mysqli_fetch_assoc($rs)) {
			foreach ($field_info as $fi => $f)
				...
				$userdata[$row['user_id']][$f->name] = $row[$f->name];
		}
	}
	...
	$tpl->display('user_logs_report.tpl');
} else {

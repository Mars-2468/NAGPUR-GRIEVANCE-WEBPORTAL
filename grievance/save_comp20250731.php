...
$test_emp_mobile='8919820778';
$test_person_mobile='9949289478';
		...
		if (mysqli_num_rows($rs1) > 0) {
			...
			if (mysqli_query($conn, $sql2)) {
				...
				try {
					...
					$sms1="Dear " .  substr($_POST['person_name'], 0, 29) . ", Your Grievance regarding " . substr($complaintType, 0, 29) . " with " . $grievance_id . " allotted to " .  substr($emp_name_mobile, 0, 28) . " on " . date('d-m-Y H:i:s') . " Track your Application Status at " . substr("https://nmcnagpur.gov.in/g1",0,29) . " Regards, NMCGOV";
				...
				$sms = "Dear " . substr($emp_name_list[$row1['emp_id']], 0, 29) . ", A Grievance from " . mysqli_real_escape_string($conn, strip_tags(substr($_POST['person_name'], 0, 28))) . ", Mobile No. " . mysqli_real_escape_string($conn, strip_tags($_POST['mobile'])) . ", " . substr($complaintType, 0, 29) . " with Ref No " . $grievance_id . " is allotted to you on " . date('d-m-Y H:i:s') . " https://nmcnagpur.gov.in/grievance/ Regards- CitizenServiceMonitoringCell ,NMCGOV";

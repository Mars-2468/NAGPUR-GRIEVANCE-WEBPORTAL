...
if (isset($_SESSION['uid'])) {
	...
	if ($_REQUEST['status'] == 0 || $_REQUEST['status'] == 1 || $_REQUEST['status'] == 2) {
		...
		if ($_SESSION['user_type'] == 'E') {
			...
			$sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and g.ulbid='" . $_SESSION['ulbid'] . "' and 
		    g.app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.disposal_status IN(2,9,8,4,6,10) and gt.dept_id='" . $_REQUEST['dept_id'] . "' and cat3_id !='0'";

			/*01-04-24 $sqlExcel = "select g.grievance_id as ReferenceNo,person_name as ApplicantName, mobile as Mobile,address as Address,comp_subject as Description,comp_desc,date_regd as ComplaintDate from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid='" . $_SESSION['ulbid'] . "' and 
		    g.app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.disposal_status IN(2,9,8,4,6,10) and gt.dept_id='" . $_REQUEST['dept_id'] . "' and cat3_id !='0'";*/
			...
			and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='" . $_REQUEST['app_type_id'] . "' and g.ulbid='" . $_SESSION['ulbid'] . "' and gt.disposal_status IN(2,9,8,4,6,10) and gt.dept_id='" . $_REQUEST['dept_id'] . "' and cat3_id !='0'";
		} else {
			$sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and g.ulbid='" . $_SESSION['ulbid'] . "' and 
		    g.app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.disposal_status IN(2,9,8,4,6,10) and gt.dept_id='" . $_REQUEST['dept_id'] . "' and cat3_id !='0'";
		...
		if (isset($_POST['search'])) {
			...
			/*21-05-2024 if ($_REQUEST['f_date'] != '' && $_REQUEST['t_date'] != '') {
				$sql .= "and date(date_regd) between '" . $_REQUEST['f_date'] . "' and '" . $_REQUEST['t_date'] . "' ";
				$sqlExcel .= "and date(date_regd) between '" . $_REQUEST['f_date'] . "' and '" . $_REQUEST['t_date'] . "' ";
			}*/
			if ($fdate != '' && $tdate != '') {
	...
	} else if ($_REQUEST['status'] == 3 || $_REQUEST['status'] == 107) {
		if ($_SESSION['user_type'] == 'E') {

			$sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and g.ulbid='" . $_SESSION['ulbid'] . "' and
		    g.app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.disposal_status!='5' and gt.dept_id='" . $_REQUEST['dept_id'] . "' and g.grievance_status_id IN('2') and cat3_id !='0'";

			/*01-04-24 $sqlExcel = "select g.grievance_id as ReferenceNo,person_name as ApplicantName, mobile as Mobile,address as Address,comp_subject as Description,comp_desc,date_regd as ComplaintDate from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and  g.ulbid='" . $_SESSION['ulbid'] . "' and
		    g.app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.disposal_status!='5' and gt.dept_id='" . $_REQUEST['dept_id'] . "' and g.grievance_status_id IN('2') and cat3_id !='0'";*/

			$sqlExcel = "SELECT g.grievance_id as ReferenceNo, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,cs_mst c, grievances_transactions gt,grievance_status_mst gsm  where g.grievance_id=gt.grievance_id and g.cat3_id=c.cs_id 
			and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='" . $_REQUEST['app_type_id'] . "' and g.ulbid='" . $_SESSION['ulbid'] . "' and gt.disposal_status!='5' and gt.dept_id='" . $_REQUEST['dept_id'] . "' and g.grievance_status_id IN('2') and cat3_id !='0'";
		} else {
			$sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and g.ulbid='" . $_SESSION['ulbid'] . "' and 
		    g.app_type_id='" . $_REQUEST['app_type_id'] . "' and g.grievance_status_id IN('2') and gt.disposal_status!='5' and gt.dept_id='" . $_REQUEST['dept_id'] . "' and cat3_id !='0'";
	...
	} else if ($_REQUEST['status'] == 4 || $_REQUEST['status'] == 108) {
		//$sql ="select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and g.ulbid='".$_SESSION['ulbid']."' and g.app_type_id='".$_REQUEST['app_type_id']."' and gt.disposal_status!='5' and gt.dept_id='".$_REQUEST['dept_id']."' and g.grievance_status_id IN ('12') ";
		...
		if ($_SESSION['user_type'] == 'E') {
			...
			$sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and g.ulbid='" . $_SESSION['ulbid'] . "' and g.app_type_id='" . $_REQUEST['app_type_id'] . "' 
			and gt.disposal_status!='5' and gt.dept_id='" . $_REQUEST['dept_id'] . "' and g.grievance_status_id IN(3,8,9,6,4,10,13) and cat3_id !='0'";

			/*01-04-24 $sqlExcel = "select g.grievance_id as ReferenceNo,person_name as ApplicantName, mobile as Mobile,address as Address,comp_subject as Description,comp_desc,date_regd as ComplaintDate from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid='" . $_SESSION['ulbid'] . "' and 
		    g.app_type_id='" . $_REQUEST['app_type_id'] . "' and g.grievance_status_id IN(3,8,9,6,4,10,13) and gt.disposal_status !='5' and gt.dept_id='" . $_REQUEST['dept_id'] . "' and cat3_id !='0'";*/

			$sqlExcel = "SELECT g.grievance_id as ReferenceNo, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,cs_mst c, grievances_transactions gt,grievance_status_mst gsm where g.grievance_id=gt.grievance_id and g.cat3_id=c.cs_id 
			and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='" . $_REQUEST['app_type_id'] . "' and g.ulbid='" . $_SESSION['ulbid'] . "' and g.grievance_status_id IN(3,8,9,6,4,10,13) and gt.disposal_status !='5' and gt.dept_id='" . $_REQUEST['dept_id'] . "' and cat3_id !='0'";
		} else {
			$sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and g.ulbid='" . $_SESSION['ulbid'] . "' and g.app_type_id='" . $_REQUEST['app_type_id'] . "' 
			and gt.disposal_status!='5' and gt.dept_id='" . $_REQUEST['dept_id'] . "' and g.grievance_status_id IN(3,8,9,6,4,10,13) and cat3_id !='0'";
	...
	if ($_REQUEST['status'] == 100) {
		if ($_SESSION['user_type'] == 'E') {
			...
			$sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid='" . $_SESSION['ulbid'] . "' and 
		    g.app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.disposal_status IN(2,9,8,4,6,10) and gt.dept_id IN($deptlist) and cat3_id !='0' ";
			...
			gt.disposal_status IN(2,9,8,4,6,10) and g.grievance_status_id IN(2,9,8,4,6,10,13,12,11) and gt.dept_id IN($deptlist) and cat3_id !='0'";
		} else {
			/*01-04-24 $sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid='" . $_SESSION['ulbid'] . "' and 
			...
			$sqlExcel = "SELECT g.grievance_id as ReferenceNo, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,cs_mst c, grievances_transactions gt,grievance_status_mst gsm  where g.grievance_id=gt.grievance_id and g.cat3_id=c.cs_id 
			and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='" . $_REQUEST['app_type_id'] . "' and g.ulbid='" . $_SESSION['ulbid'] . "' and 
			gt.disposal_status IN(2,9,8,4,6,10) and g.grievance_status_id IN(2,9,8,4,6,10,13,12,11) and cat3_id !='0'";
		}
	...
	} else if ($_REQUEST['status'] == 200 || $_REQUEST['status'] == 800) {
		if ($_SESSION['user_type'] == 'E') {
			$sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and g.ulbid='" . $_SESSION['ulbid'] . "' and
			g.app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.dept_id IN( $deptlist ) and grievance_status_id IN('2') and gt.disposal_status IN('2') and cat3_id !='0' ";

			/*01-04-24 $sqlExcel = "select g.grievance_id as ReferenceNo,person_name as ApplicantName, mobile as Mobile,address as Address,comp_subject as Description,comp_desc,date_regd as ComplaintDate from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and  g.ulbid='" . $_SESSION['ulbid'] . "' and
			g.app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.disposal_status!='5' and g.grievance_status_id IN('2') ";*/

			$sqlExcel = "SELECT g.grievance_id as ReferenceNo, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,cs_mst c, grievances_transactions gt,grievance_status_mst gsm  where g.grievance_id=gt.grievance_id and g.cat3_id=c.cs_id 
			and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='" . $_REQUEST['app_type_id'] . "' and g.ulbid='" . $_SESSION['ulbid'] . "' and gt.disposal_status!='5' and g.grievance_status_id IN('2') and cat3_id !='0'";
		} else {
			$sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and g.ulbid='" . $_SESSION['ulbid'] . "' and
			g.app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.disposal_status!='5' and grievance_status_id IN('2') ";
	...
	} else if ($_REQUEST['status'] == 300 || $_REQUEST['status'] == 900) {
		if ($_SESSION['user_type'] == 'E') {
			$sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and g.ulbid='" . $_SESSION['ulbid'] . "' and g.app_type_id='" . $_REQUEST['app_type_id'] . "' 
			and gt.dept_id IN( $deptlist ) and grievance_status_id IN(3,8,9,6,4,10,13) and gt.disposal_status IN(3,8,9,6,4,10,13) and cat3_id !='0' ";

			/*01-04-24 $sqlExcel = "select g.grievance_id as ReferenceNo,person_name as ApplicantName, mobile as Mobile,address as Address,comp_subject as Description,comp_desc,date_regd as ComplaintDate from grievances g, 
			grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid='" . $_SESSION['ulbid'] . "' and g.app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.disposal_status!='5' and g.grievance_status_id IN(3,8,9,6,4,10,13)";*/

			$sqlExcel = "SELECT g.grievance_id as ReferenceNo, person_name as ApplicantName, g.mobile as Mobile,CONCAT(g.hno, ', ', g.address) as Address,c.cs_desc as ComplaintDetails,gsm.grievance_status_desc as Status ,date_regd as ReceivedDate from grievances g,cs_mst c, grievances_transactions gt,grievance_status_mst gsm where g.grievance_id=gt.grievance_id and g.cat3_id=c.cs_id 
			and g.grievance_status_id=gsm.grievance_status_id and g.app_type_id='" . $_REQUEST['app_type_id'] . "' and g.ulbid='" . $_SESSION['ulbid'] . "' and g.grievance_status_id IN(3,8,9,6,4,10,13) and gt.disposal_status !='5' and cat3_id !='0'";
		} else {
			$sql = "select g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  and g.ulbid='" . $_SESSION['ulbid'] . "' and g.app_type_id='" . $_REQUEST['app_type_id'] . "' 
	...
	if ($_REQUEST['status'] != 4 || $_REQUEST['status'] != 108) {
		/*01-04-24 $sql .= " group by gt.grievance_id";
	...
	if ($_REQUEST['status'] == 0 || $_REQUEST['status'] == 1 || $_REQUEST['status'] == 2) {
		if ($_SESSION['user_type'] == 'E') {
			/*01-04-24 $query ="select count(g.grievance_id) as num from grievances g, grievances_transactions gt where 
		...
		if ($_SESSION['user_type'] == 'E') {
			...
			gt.dept_id='" . $_REQUEST['dept_id'] . "'  and g.grievance_status_id IN('2') ";
		} else {
			$query = "select count(DISTINCT g.grievance_id) as num,g.sla_status from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  
			and g.ulbid='" . $_SESSION['ulbid'] . "' and g.app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.disposal_status!='5' and 
			gt.dept_id='" . $_REQUEST['dept_id'] . "'  and g.grievance_status_id IN('2') ";
		...
		if ($_SESSION['user_type'] == 'E') {
			/*01-04-24 $query="select count(DISTINCT g.grievance_id) as num,g.sla_status,g.grievance_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id and
		...
		if ($_SESSION['user_type'] == 'E') {
			/*01-04-24 $query = "select count(DISTINCT g.grievance_id) as num from grievances g, grievances_transactions gt where 
			g.grievance_id=gt.grievance_id  and g.ulbid='" . $_SESSION['ulbid'] . "' and g.app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.dept_id IN($deptlist) and 
			gt.disposal_status IN(2,9,8,4,6,10)";*/
		...
		if ($_SESSION['user_type'] == 'E') {
			$query = "select count(DISTINCT g.grievance_id) as num,g.sla_status from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  
				and g.ulbid='" . $_SESSION['ulbid'] . "' and g.app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.dept_id IN( $deptlist ) and grievance_status_id IN('2') and gt.disposal_status IN('2') and cat3_id !='0' ";
		} else {
			$query = "select count(DISTINCT g.grievance_id) as num,g.sla_status from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id  
		...
		if ($_SESSION['user_type'] == 'E') {
			$query = "select count(DISTINCT g.grievance_id) as num,g.sla_status,g.grievance_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id and
			g.ulbid='" . $_SESSION['ulbid'] . "' and g.app_type_id='" . $_REQUEST['app_type_id'] . "' and gt.dept_id IN( $deptlist ) and g.grievance_status_id IN(3,8,9,6,4,10,13) and gt.disposal_status IN(3,8,9,6,4,10,13) and cat3_id !='0'";
			// $query ="select count(g.grievance_id) as num,g.*,gt.emp_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid='055' and g.app_type_id='2' and gt.disposal_status!='5' and gt.dept_id='98' and gt.emp_id='2110' and grievance_status_id IN('3','9','6','10')";	
		} else {
			$query = "select count(DISTINCT g.grievance_id) as num,g.sla_status,g.grievance_id from grievances g, grievances_transactions gt where g.grievance_id=gt.grievance_id and
	...
	/*19-03-24 $targetpage = "inner_pendancy_report.php"; 	//your file name  (the name of this file)
	...
	/*21-05-2024 $tpl->assign('fdate', $_REQUEST['f_date']);

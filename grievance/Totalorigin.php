...
if (isset($_SESSION['uid'])) {
	...
	if ($_REQUEST['originid'] !== '') {
		...
		$sql = "select g.* from grievances g,". $grievances_trns ." gt where g.grievance_id=gt.grievance_id and g.app_type_id = '1' and g.ulbid = '" . $_REQUEST['ulbid'] . "' ";

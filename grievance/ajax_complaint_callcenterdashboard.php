<?php
		...
		if($_SESSION['user_type']=='A')
				...
				else if($_SESSION['user_type']=='C')
				{
				 ...
				 //$sql="SELECT count(grievance_id) as date_regd,app_type_id FROM grievances g,ulbmst u ,cs_mst c where g.ulbid=u.ulbid and g.cat3_id=c.cs_id and app_type_id='1'";
				$sql="SELECT count(grievance_id) as date_regd,app_type_id FROM grievances  where app_type_id='1' and cat3_id !='0' and grievance_origin_id IN(8)";
					...
					else if($_SESSION['user_type']=='C')
				{
				 ...
				 $sql="SELECT count(grievance_id) as date_regd,app_type_id FROM grievances  where  app_type_id='1' and grievance_status_id IN('3','8','9') and sla_status=1 and cat3_id !='0' and grievance_origin_id IN(8) ";
				}
				else if($_SESSION['user_type']=='U')
				{
					...
					else if($_SESSION['user_type']=='C')
				{
				 ...
				 $sql="SELECT count(grievance_id) as date_regd,app_type_id FROM grievances where app_type_id='1' and grievance_status_id IN('3','8','9') and sla_status=2 and cat3_id !='0' and grievance_origin_id IN(8) ";
				}
				else if($_SESSION['user_type']=='U')
				{
				  if($_SESSION['ulbid']==(int)$mergedulbs)
				...
				else if($_SESSION['user_type']=='C')
				{
				 ...
				 $sql="SELECT count(grievance_id) as date_regd,app_type_id FROM grievances  where  app_type_id='1' and grievance_status_id IN('2') and sla_status=1 and cat3_id !='0' and grievance_origin_id IN(8)";
				}
				else if($_SESSION['user_type']=='U')
				{
    				if($_SESSION['ulbid']==(int)$mergedulbs)
				...
				else if($_SESSION['user_type']=='C')
				{
				 ...
				 $sql="SELECT count(grievance_id) as date_regd,app_type_id FROM grievances  where  app_type_id='1' and grievance_status_id IN('2') and sla_status=2 and cat3_id !='0' and grievance_origin_id IN(8) ";
				}
				else if($_SESSION['user_type']=='U')
				{
				    	if($_SESSION['ulbid']==(int)$mergedulbs)
				...
				$sql="select count(grievance_id) as pendingforapproval,app_type_id from grievances  where  grievance_status_id='1' and app_type_id='1' and cat3_id !='0' and grievance_origin_id IN(8)";
	...
	ulbid='".$_SESSION['ulbid']."' and grievance_status_id='1' and app_type_id='1' and cat3_id !='0'";
			...
			/********Financial implications**********/	
				...
				$sql="select count(grievance_id) as fin,app_type_id from grievances where  grievance_status_id='6' and app_type_id='1' and cat3_id !='0' and grievance_origin_id IN(8) ";
		...
		$sql="select count(g.grievance_id) as fin,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id='".$_SESSION['emp_id']."' and grievance_status_id='6' and app_type_id='1' and gt.disposal_status !=5 and cat3_id !='0'";
			...
			/********end pending approval****/	
				...
				$sql="select count(grievance_id) as unresolved,app_type_id from grievances where grievance_status_id='4' and app_type_id='1' and cat3_id !='0' and grievance_origin_id IN(8) ";
		...
		$sql="select count(g.grievance_id) as unresolved,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.emp_id='".$_SESSION['emp_id']."' and grievance_status_id='4' and app_type_id='1' and gt.disposal_status !=5 and cat3_id !='0'";
			...
			/********end pending approval****/
				...
				$sql="select count(grievance_id) as rejected,app_type_id from grievances where grievance_status_id='10' and app_type_id='1' and cat3_id !='0' and grievance_origin_id IN(8) ";
			...
			/** re-opened applicatons **/
				...
				if($_SESSION['user_type']=='A')
		            ...
		            else if($_SESSION['user_type']=='C')
		          {
		                ...
		                $sql3="select count(grievance_id) as count,app_type_id,grievance_status_id from grievances where grievance_status_id IN('11','12','13') and grievance_origin_id IN(8) group by app_type_id,grievance_status_id";

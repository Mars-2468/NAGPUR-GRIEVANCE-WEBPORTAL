<?php
	...
	if(isset($_SESSION['uid']))
	{
		...
		$sql ="SELECT count(`grievance_id`) as count , cat3_id,description,cm.cat_id,c.sub_cat_id,ward_id FROM `grievances` g, cs_mst c, category_mst cm where g.cat3_id=c.cs_id and c.cat_id=cm.cat_id and  `grievance_status_id` = 9 and ward_id=".$ward_id."  group by cat3_id , ward_id order by count DESC";
	...
	$sql ="SELECT * FROM `comp_cutofdays_map`";
		...
		$tpl->display('corp_cat_max_comp_resolved_rep.tpl');
	}
	else
	{

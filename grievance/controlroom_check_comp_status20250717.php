...
//echo"<pre>";print_r($_REQUEST);echo"</pre>";die();
	...
	$rating_num = isset($_GET['rating_num']) ? $_GET['rating_num'] : '';
	$person_name = isset($_GET['person_name']) ? $_GET['person_name'] : '';
	$mobile = isset($_GET['mobile']) ? $_GET['mobile'] : '';
	$grievance_id = isset($_GET['grievance_id']) ? $_GET['grievance_id'] : '';
	$feedback_status = isset($_GET['feedback_status']) ? $_GET['feedback_status'] : '';
	$feedback_sentby = isset($_GET['feedback_sentby']) ? $_GET['feedback_sentby'] : '';
	$grievance_status_id = isset($_GET['grievance_status_id']) ? $_GET['grievance_status_id'] : '';
...
/************************* pagination part end  **************************/
		...
		if(($feedback_status!=-1) && (($feedback_status==0) || ($feedback_status==1))){
			$sql.=" and feedback_status='".$feedback_status_list[$feedback_status]."' ";
		} 	

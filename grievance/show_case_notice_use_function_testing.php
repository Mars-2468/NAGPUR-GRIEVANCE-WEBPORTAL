...
//$base_url = "https://nmcnagpur.gov.in/grievance";
...
function grievance_at_emp_level1($row, $grievances_id, $cs_list)
{
    ...
    if ($disposed_date < $todayDate) {
        ...
        $preveious_employee_allotteddate = mysqli_fetch_assoc($rs2);
		 ...
		 echo "<br>*******************".$preveious_employee_allotteddate['alloted_date']."*************************<br>";;
        ...
        if (mysqli_query($conn, $sql)) {
            $sql = "insert into grievances_transactions(grievance_id,transaction_id,emp_id,dept_id,desg_id,alloted_date,disposed_date,disposal_status,disposal_remarks,update_status,updated_by,origin_id,emp_level)values('" . $row['grievance_id'] . "','" . $trnsid . "','" . $emp2['emp_id2'] . "','" . $emp2['dept_id'] . "','" . $emp2['desg_id'] . "','" . date('Y-m-d H:i:s') . "','0000-00-00 00:00:00','2','Auto Allotted','2','System','1','L2')";
            ...
            if (mysqli_query($conn, $sql)) {
				...
				global $testcon;
				$result=!empty($testcon)?$testcon:($row3['count'] >= 5);
                ...
                if ($result) {
                    ...
                    $mobile = !empty($testmobile) ? $testmobile : $emp1['emp_mobile'];
                    // $mobile = !empty($testmobile) ? $testmobile : '8484972066';
                    ...
                    $mobile = !empty($testmobile) ? $testmobile : $emp2['emp_mobile'];
                    // $mobile = !empty($testmobile) ? $testmobile : '8484972066';
...
function grievance_at_emp_level2($row, $grievances_id, $cs_list) {
    ...
    if ($disposed_date < $todayDate) {
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            desg_id,alloted_date,disposed_date,disposal_status,disposal_remarks,update_status,updated_by,origin_id,emp_level)values('" . $row['grievance_id'] . "','" . $trnsid . "','" . $emp2['emp_id3'] . "','" . $emp2['dept_id'] . "','" . $emp2['desg_id'] . "','" . date('Y-m-d H:i:s') . "','0000-00-00 00:00:00','2','Auto Allotted','2','System','1','L3')";
            echo "<br> check 8 <br>";
            if (mysqli_query($conn, $sql)) {
...
function grievance_at_emp_level3($row, $grievances_id, $cs_list)
{
    ...
    echo $sql = "SELECT * FROM `grievances_transactions` WHERE `grievance_id` = '" . $grievances_id . "' and disposal_status=2 and emp_id='" . $emp1['emp_id3'] . "' order by transaction_id desc limit 1";
    $rs2 = mysqli_query($conn, $sql);
    $preveious_employee_allotteddate = mysqli_fetch_assoc($rs2);
    ...
    if ($disposed_date < $todayDate) {
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            $sql = "insert into grievances_transactions(grievance_id,transaction_id,emp_id,dept_id,desg_id,alloted_date,disposed_date,disposal_status,disposal_remarks,update_status,updated_by,origin_id,emp_level)values('" . $row['grievance_id'] . "','" . $trnsid . "','" . $emp2['emp_id4'] . "','" . $emp2['dept_id'] . "','" . $emp2['desg_id'] . "','" . date('Y-m-d H:i:s') . "','0000-00-00 00:00:00','2','Auto Allotted','2','System','1','L4')";

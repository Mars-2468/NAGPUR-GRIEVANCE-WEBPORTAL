...
//echo "<pre>";print_r($_SESSION['csrf_token']);echo "</pre>";die();
	...
	if (isset($_POST['save']) && ($_POST['token'] === $_SESSION['token'])) {
		...
		$desg_id = sanitize_input($_POST['desg_id']);
		$ward_id = sanitize_input($_POST['ward_id']);
		$street_id = sanitize_input($_POST['street_id']);
		$lat = $_POST['lat'];
		$lang = $_POST['lang'];
		$field_verification_reason = sanitize_input($_POST['field_verification_reason']);
		$field_verification_address = sanitize_input($_POST['field_verification_address']);

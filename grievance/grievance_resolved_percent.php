...
if($query->execute())
	...
	while($row = $rs->fetch_assoc())
	{
		...
		$sql ="SELECT count(grievance_id) as count, grievance_status_id,cat3_id FROM `grievances` where grievance_status_id in(3,8,9) group by grievance_status_id,cat3_id";
		...
		$tpl->display('grievance_resolved_percent.tpl');
	}
	else
	{

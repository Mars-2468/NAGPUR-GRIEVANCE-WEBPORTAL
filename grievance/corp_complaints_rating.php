<?php
	...
	if(isset($_SESSION['uid']))
	{
	   ...
	   // session_regenerate_id();
		...
		/* $sql = $conn->prepare("select count(r.grievance_id) as 4star,c.cs_id from rating_mst r , grievances g , cs_mst c where g.grievance_id = r.grievance_id and 
		c.cs_id = g.cat3_id and rating_no = ? and g.ulbid = ? and date_format(g.date_regd,'%Y-%m-%d') >= ? group by g.cat3_id");
		 */
	...
	//echo "<pre>";print_r($cat_list);echo "</pre>";die();
		...
		$tpl->display('corp_complaints_rating.tpl');
	}
	else
	{

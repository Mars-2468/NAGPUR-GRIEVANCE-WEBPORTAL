 ...
 */
			...
			if(in_array($disposal_status,[13])){
	...
	/*old code 30-09-2024 Dhanraj $sql = "select dept_id,dept_desc from dept_mst where ulbid='" . $_SESSION['ulbid'] . "'";
...
//var_dump($data1['grievance_status_id']);die();
		...
		if ($app_type_id == '1') {
			...
			if ($status == '13' && in_array($data1['grievance_at_emp_level'],['L1','L2','L3','L4'])) {				
//13,11,12
				$sql_status = "select grievance_status_id,grievance_status_desc from grievance_status_mst where grievance_status_id IN('10','11','12')";
			
			}else if ($status == '11' && in_array($data1['grievance_at_emp_level'],['L2','L3','L4'])) {

				$sql_status = "select grievance_status_id,grievance_status_desc from grievance_status_mst where grievance_status_id IN('12','10')";
		...
		/*if($status=='11')

		        {
		            ...
		            $grievance_status_list['11']="Transmitted";

		            $grievance_status_list['12']="Reopened completed";
...
//echo "<pre>";print_r($present_grievance_status_list);echo "</pre>";die();
	...
	$tpl->display('manage_transfered_reopen_comp_sel.tpl');
} else {

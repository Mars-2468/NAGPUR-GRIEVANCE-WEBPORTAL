...
if (isset($_SESSION['uid'])) {
	...
	//echo "<pre>";print_r(isset($_REQUEST['f_date']));echo "</pre>";die();
...
//total recieved
	...
	{
		$sql = "SELECT COUNT(DISTINCT g.grievance_id) as count,street_id ,ward_id  from grievances g, ".$_SESSION['grievances_trns']." gt where g.grievance_id=gt.grievance_id and gt.emp_id='" . $emplist . "' and g.app_type_id='1' ";
	}
...
//completed	
	...
	{
		$sql = "SELECT count(DISTINCT g.grievance_id) as count,street_id  FROM grievances g, " . $grievances_trns . " gt where g.grievance_id=gt.grievance_id and gt.emp_id='" . $emplist . "' and 
    	app_type_id='1' and g.grievance_status_id IN(3,8,9) and sla_status=1 and cat3_id !='0' ";
	}	
...
// completed beyond sla
	...
	{
		$sql = "SELECT count(DISTINCT g.grievance_id) as count,street_id  FROM grievances g, " . $grievances_trns . " gt where g.grievance_id=gt.grievance_id and gt.emp_id='" . $emplist . "' and 
    	app_type_id='1' and g.grievance_status_id IN(3,8,9) and g.sla_status=2 and cat3_id !='0' ";
	}
...
// reopened complaints
	...
	{
		$sql = "SELECT count(DISTINCT g.grievance_id) as count,street_id  FROM grievances g, " . $grievances_trns . " gt where g.grievance_id=gt.grievance_id and gt.emp_id='" . $emplist . "' and 
    	app_type_id='1' and g.grievance_status_id IN('13')  and gt.disposal_status IN('13') and cat3_id !='0' ";
	}
...
// unresolvable complaints
	...
	{
		$sql = "SELECT count(DISTINCT g.grievance_id) as count,street_id  FROM grievances g, " . $grievances_trns . " gt where g.grievance_id=gt.grievance_id and gt.emp_id='" . $emplist . "' and 
    	app_type_id='1' and g.grievance_status_id IN('4') and cat3_id !='0' ";
	}
	...
	{
		$sql = "SELECT count(DISTINCT g.grievance_id) as count,street_id  FROM grievances g, " . $grievances_trns . " gt where g.grievance_id=gt.grievance_id and gt.emp_id='" . $emplist . "' and 
    	app_type_id='1' and g.grievance_status_id IN(6) and cat3_id !='0' ";
	}
	...
	{
		$sql = "SELECT count(DISTINCT g.grievance_id) as count,street_id  FROM grievances g, " . $grievances_trns . " gt where g.grievance_id=gt.grievance_id and gt.emp_id='" . $emplist . "' and 
    	app_type_id='1' and g.grievance_status_id IN('10') and cat3_id !='0' ";
	}
	...
	{
		$sql = "SELECT count(DISTINCT g.grievance_id) as count,street_id  FROM grievances g, " . $grievances_trns . " gt where g.grievance_id=gt.grievance_id and gt.emp_id='" . $emplist . "' and 
    	app_type_id='1' and g.grievance_status_id IN('2') and g.sla_status=1 and cat3_id !='0' ";
	}
	...
	{
		$sql = "SELECT count(DISTINCT g.grievance_id) as count,street_id  FROM grievances g, " . $grievances_trns . " gt where g.grievance_id=gt.grievance_id and gt.emp_id='" . $emplist . "' and 
    	app_type_id='1' and g.grievance_status_id IN('1') and cat3_id !='0' ";
	}
	...
	{
		$sql = "SELECT count(DISTINCT g.grievance_id) as count,street_id  FROM grievances g, " . $grievances_trns . " gt where g.grievance_id=gt.grievance_id and gt.emp_id='" . $emplist . "' and 
    	app_type_id='1' and g.grievance_status_id IN('11') and cat3_id !='0' ";
	}
	...
	{
		$sql = "SELECT count(DISTINCT g.grievance_id) as count,street_id  FROM grievances g, " . $grievances_trns . " gt where g.grievance_id=gt.grievance_id and gt.emp_id='" . $emplist . "' and 
    	app_type_id='1' and g.grievance_status_id IN('12') AND gt.disposal_status IN(12) and cat3_id !='0' ";
	}
	...
	{
		$sql = "SELECT count(DISTINCT g.grievance_id) as count,street_id  FROM grievances g, " . $grievances_trns . " gt where g.grievance_id=gt.grievance_id and gt.emp_id='" . $emplist . "' and 
    	app_type_id='1' and g.grievance_status_id IN(5,10) and cat3_id !='0' ";
	}

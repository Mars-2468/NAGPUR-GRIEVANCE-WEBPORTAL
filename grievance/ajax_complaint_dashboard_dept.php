...
<?php
	...
	if ($_SESSION['user_type'] == 'A') {
		...
		if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
			$sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status != '5' and app_type_id='1' and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";

			$sql_od = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status != '5' and app_type_id='1' and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";

			$esc_sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and app_type_id='1' and cat3_id !='0' and gt.disposal_status NOT IN('5') and gt.is_escalated=1 AND YEAR(date_regd) = '" . $selectedYear . "'";
		} else {
			...
			/*01-03-24 $sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN($deptlist) and gt.disposal_status IN(2,9,8,4,6,10) 
			and g.grievance_status_id IN(2,9,8,4,6,10,13,12,11) and app_type_id='1' and cat3_id !='0'";

			$sql_od = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN($deptlist) and gt.disposal_status IN(2,9,8,4,6,10) 
			and g.grievance_status_id IN(2,9,8,4,6,10,13,12,11) and app_type_id='1' and cat3_id !='0'";

			$esc_sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN($deptlist) and app_type_id='1' and cat3_id !='0' and gt.disposal_status IN(2,9,8,4,6,10) 
			and g.grievance_status_id IN(2,9,8,4,6,10,13,12,11)";*/

			$sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status != '5' and app_type_id='1' and cat3_id !='0'";

			$sql_od = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status != '5' and app_type_id='1' and cat3_id !='0'";

			$esc_sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and app_type_id='1' and cat3_id !='0' and gt.disposal_status NOT IN('5') and gt.is_escalated=1";
		}
	...
	if ($_SESSION['user_type'] == 'A') {
		...
		if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
			$sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where DATE(date_regd) = '" . $date . "' and g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and app_type_id='1' and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";

			$sql_od = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where DATE(date_regd) = '" . $date . "' and g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and app_type_id='1' and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";

			$esc_sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where DATE(date_regd) = '" . $date . "' and g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and app_type_id='1' and cat3_id !='0' and disposal_status NOT IN('5') and gt.is_escalated=1 AND YEAR(date_regd) = '" . $selectedYear . "'";
		} else {
			...
			$sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where DATE(date_regd) = '" . $date . "' and g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and app_type_id='1' and cat3_id !='0'";

			$sql_od = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where DATE(date_regd) = '" . $date . "' and g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and app_type_id='1' and cat3_id !='0'";

			$esc_sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where DATE(date_regd) = '" . $date . "' and g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and app_type_id='1' and cat3_id !='0' and disposal_status NOT IN('5') and gt.is_escalated=1";
		}
	} else if ($_SESSION['user_type'] == 'R') {
	...
	if ($_SESSION['user_type'] == 'A') {
		...
		if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
			$sql = "SELECT  count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.is_escalated='1' AND YEAR(date_regd) = '" . $selectedYear . "'";

			$sql_od = "SELECT count(DISTINCT g.grievance_id) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and  gt.dept_id IN( $deptlist ) and gt.disposal_status != '5' and app_type_id='1' and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
		} else {
			// $sql="SELECT count(DISTINCT(grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g,cs_mst c,ulbmst u where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and g.cat3_id=c.cs_id and emp_id='".$_SESSION['emp_id']."' and gt.disposal_status !=5 and app_type_id='1'";
			$sql = "SELECT  count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.is_escalated='1'";
	...
	if ($_SESSION['user_type'] == 'A') {
		...
		if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
			$sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and app_type_id='1' and g.grievance_status_id IN('3','8','9') and sla_status=1 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
		} else {
			...
			/*$sql = "SELECT count(DISTINCT g.grievance_id) as date_regd,app_type_id FROM grievances g,cs_mst c,ulbmst u,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and 
			...
			//19-03-24 $sql = "SELECT count(DISTINCT(grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and app_type_id='1' and grievance_status_id IN('3','8','9') and sla_status=1 and gt.is_escalated=0 and cat3_id !='0' ";

			//22-04-24 $sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and app_type_id='1' and grievance_status_id IN('3','8','9') and sla_status=1 and gt.is_escalated=0 and cat3_id !='0' ";

			//31-05-24 $sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and app_type_id='1' and g.grievance_status_id IN('3','8','9') and g.sla_status=1 and gt.is_escalated=0 and cat3_id !='0'";

			$sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and app_type_id='1' and g.grievance_status_id IN('3','8','9') and sla_status=1 and cat3_id !='0' ";
		}
	} else if ($_SESSION['user_type'] == 'R') {
	...
	if ($_SESSION['user_type'] == 'A') {
		...
		if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
			$sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and app_type_id='1' and g.grievance_status_id IN('3','8','9') and sla_status=2 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
		} else {
			//19-03-24 $sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and app_type_id='1' and g.grievance_status_id IN('3','9','8') and gt.disposal_status IN('3','9','8') and sla_status=2 and cat3_id !='0' ";

			//31-05-24 $sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and app_type_id='1' and grievance_status_id IN('3','8','9') and sla_status=2 and cat3_id !='0' ";

			$sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and app_type_id='1' and g.grievance_status_id IN('3','8','9') and sla_status=2 and cat3_id !='0'";
		}
	} else if ($_SESSION['user_type'] == 'R') {
	...
	if ($_SESSION['user_type'] == 'A') {
		...
		if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
			$sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status != '5' and app_type_id='1' and grievance_status_id IN('2') and sla_status=1 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
		} else {
			//19-03-24 $sql = "SELECT count(DISTINCT(grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and app_type_id='1' and grievance_status_id IN('2') and gt.disposal_status IN('2') and sla_status=1 and cat3_id !='0'";

			$sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances_transactions gt,grievances g where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and gt.disposal_status != '5' and app_type_id='1' and grievance_status_id IN('2') and sla_status=1 and cat3_id !='0'";
		}
	} else if ($_SESSION['user_type'] == 'R') {
	...
	if ($_SESSION['user_type'] == 'A') {
		...
		if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
			$sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances g,ulbmst u,grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and gt.dept_id IN( $deptlist ) and app_type_id='1' and g.grievance_status_id IN('2') and sla_status=2 and gt.disposal_status !=5 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
		} else {
			//19-03-24 $sql = "SELECT count(DISTINCT(grievance_id)) as date_regd,app_type_id FROM grievances g,ulbmst u,grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and gt.dept_id IN( $deptlist ) and gt.disposal_status !=5 and app_type_id='1' and grievance_status_id IN('2') and sla_status=2 and gt.disposal_status !=5 and cat3_id !='0'";
			$sql = "SELECT count(DISTINCT(g.grievance_id)) as date_regd,app_type_id FROM grievances g,ulbmst u,grievances_transactions gt where g.grievance_id=gt.grievance_id and g.ulbid=u.ulbid and gt.dept_id IN( $deptlist ) and app_type_id='1' and g.grievance_status_id IN('2') and sla_status=2 and gt.disposal_status !=5 and cat3_id !='0'";
		}
	} else if ($_SESSION['user_type'] == 'R') {
	...
	if ($_SESSION['user_type'] == 'E') {
		if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
			$sql = "SELECT count(DISTINCT(g.grievance_id)) as fin,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and g.grievance_status_id='6' and app_type_id='1' and gt.disposal_status !=5 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
		} else {
			//19-03-24 $sql = "SELECT count(DISTINCT(grievance_id)) as fin,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and grievance_status_id='6' and gt.disposal_status IN (6) and app_type_id='1' and gt.disposal_status !=5 and cat3_id !='0'";
	
			$sql = "SELECT count(DISTINCT(g.grievance_id)) as fin,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and g.grievance_status_id='6' and app_type_id='1' and gt.disposal_status !=5 and cat3_id !='0'";
		}
	}
	...
	if ($_SESSION['user_type'] == 'E') {
		if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
			$sql = "SELECT count(DISTINCT(g.grievance_id)) as unresolved,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and g.grievance_status_id='4' and app_type_id='1' and gt.disposal_status !=5 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
		} else {
			//19-03-24 $sql = "SELECT count(DISTINCT(g.grievance_id)) as unresolved,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and grievance_status_id='4' and app_type_id='1' and gt.disposal_status !=5 and cat3_id !='0'";
			$sql = "SELECT count(DISTINCT(g.grievance_id)) as unresolved,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and g.grievance_status_id='4' and app_type_id='1' and gt.disposal_status !=5 and cat3_id !='0'";
		}
	}
	...
	if ($_SESSION['user_type'] == 'E') {
		if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
			$sql = "SELECT count(DISTINCT(g.grievance_id)) as rejected,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and g.grievance_status_id='10' and app_type_id='1' and gt.disposal_status !=5 and cat3_id !='0' AND YEAR(date_regd) = '" . $selectedYear . "'";
		} else {
			//19-03-24 $sql = "SELECT count(DISTINCT(g.grievance_id)) as rejected,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and grievance_status_id IN ('10') and gt.disposal_status IN ('10') and app_type_id='1' and gt.disposal_status !=5 and cat3_id !='0'";
			$sql = "SELECT count(DISTINCT(g.grievance_id)) as rejected,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and g.grievance_status_id='10' and app_type_id='1' and gt.disposal_status !=5 and cat3_id !='0'";
		}
	}
	...
	if ($_SESSION['user_type'] == 'A') {
		...
		if ($selectedYear == '2023' || $selectedYear == '2024' || $selectedYear == '2025') {
			$sql3 = "SELECT count(DISTINCT g.grievance_id) as count,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and  gt.disposal_status !=5 and g.grievance_status_id IN('13') AND YEAR(date_regd) = '" . $selectedYear . "' group by app_type_id";
			$sql4 = "SELECT count(DISTINCT g.grievance_id) as count,disposal_status as grievance_status_id,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.disposal_status !=5 and g.grievance_status_id IN('11') and gt.dept_id IN( $deptlist ) AND YEAR(date_regd) = '" . $selectedYear . "' group by app_type_id, grievance_status_id";
			$sql5 = "SELECT count(DISTINCT g.grievance_id) as count,disposal_status as grievance_status_id,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.disposal_status !=5 and g.grievance_status_id IN('12') and gt.dept_id IN( $deptlist ) AND YEAR(date_regd) = '" . $selectedYear . "' group by app_type_id, grievance_status_id";
		} else {
			//$sql3 = "SELECT count(DISTINCT g.grievance_id) as count,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and  gt.disposal_status IN('11','12') and g.grievance_status_id IN('11','12')";
			/*19-03-14 $sql3 = "SELECT count(DISTINCT g.grievance_id) as count,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and  gt.disposal_status IN('13') and g.grievance_status_id IN('13') group by app_type_id, grievance_status_id";
			$sql4 = "SELECT count(DISTINCT g.grievance_id) as count,disposal_status as grievance_status_id,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and g.grievance_status_id IN('11')  and gt.disposal_status IN('11') and gt.dept_id IN( $deptlist ) group by app_type_id, grievance_status_id";
			$sql5 = "SELECT count(DISTINCT g.grievance_id) as count,disposal_status as grievance_status_id,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.disposal_status NOT IN('5','9','13') and  g.grievance_status_id IN('12') and gt.dept_id IN( $deptlist ) group by app_type_id, grievance_status_id";*/
			//15-03-24 $sql5 = "SELECT count(DISTINCT g.grievance_id) as count,disposal_status as grievance_status_id,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.disposal_status IN('12') and  g.grievance_status_id IN('12') and gt.dept_id IN( $deptlist ) group by app_type_id, grievance_status_id";
			$sql3 = "SELECT count(DISTINCT g.grievance_id) as count,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.dept_id IN( $deptlist ) and  gt.disposal_status !=5 and g.grievance_status_id IN('13') group by app_type_id";
			//This Date 22-04-24 Changed $sql4 = "SELECT count(DISTINCT g.grievance_id) as count,disposal_status as grievance_status_id,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.disposal_status IN('11') and  g.grievance_status_id IN('11') and gt.dept_id IN( $deptlist ) group by app_type_id, grievance_status_id";
			$sql4 = "SELECT count(DISTINCT g.grievance_id) as count,disposal_status as grievance_status_id,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.disposal_status !=5 and g.grievance_status_id IN('11') and gt.dept_id IN( $deptlist ) group by app_type_id, grievance_status_id";
			$sql5 = "SELECT count(DISTINCT g.grievance_id) as count,disposal_status as grievance_status_id,app_type_id from grievances g,grievances_transactions gt where g.grievance_id=gt.grievance_id and gt.disposal_status !=5 and g.grievance_status_id IN('12') and gt.dept_id IN( $deptlist ) group by app_type_id, grievance_status_id";
	...
	<div class="boxed">
		...
		<!--11-07-2024 <div class="bash_heading row m-b20"> Total Number of Grievances </div> -->
		<div class="bash_heading row m-b20">
			<div class="" style="display: flex;justify-content: space-between;align-items: center;">
				<div>TOTAL NUMBER OF <span style="color: red;">DEPARTMENT</span> DASHBOARD</div>
				<div>
						...
						<div class="panel-right panel-icon bg-reverse">
							...
							<p class="size-h1 no-margin countdown_first">
								...
								if ($_SESSION['user_type'] == 'U') {
									...
									/*$data[1]['total_received'] = $total_resolved + $data[1]['total_transferred'] + $reopened_completed_tot[1][13]['count'] + $total_pending + $data[1]['fin'];*/
									//12-04-24 echo "<a href='tot_received_dept.php?aptid=1&status=0&sla=0&user_type=" . $_SESSION['user_type'] . "' >" . $data[1]['total_received'] . "</a>";
									echo "<a href='tot_received_dept.php?aptid=1&status=801&sla=0&user_type=" . $_SESSION['user_type'] . "' >" . $data[1]['total_received'] . "</a>";
								} else {
									if ($_SESSION['user_type'] == 'M') {
						...
						<div class="panel-right panel-icon bg-reverse">
							<p class="size-h1 no-margin countdown_first">
								...
								<?php if ($_SESSION['user_type'] == 'U') {
									echo "<a href='tot_received_dept.php?aptid=1&status=111&sla=0&user_type=" . $_SESSION['user_type'] . "'>" . $data[1]['daily_received'] . "</a>";
								} else if ($_SESSION['user_type'] == 'E') {
									echo "<a href='tot_received_dept.php?aptid=1&status=111&sla=0&user_type=" . $_SESSION['user_type'] . "'>" . $data[1]['daily_received'] . "</a>";
								} else {
						...
						<div class="panel-right panel-icon bg-reverse">
							...
							<p class="size-h1 no-margin countdown_first">
								...
								<?php if ($_SESSION['user_type'] == 'U') {
									...
									//12-04-24 echo "<a href='tot_received_dept.php?aptid=1&status=100&sla=2&user_type=" . $_SESSION['user_type'] . "'>" . $total_resolved . "</a>";
									echo "<a href='tot_received_dept.php?aptid=1&status=802&sla=2&user_type=" . $_SESSION['user_type'] . "'>" . $total_resolved . "</a>";
								} else {
									if ($_SESSION['user_type'] == 'M') {
						...
						<div class="panel-right panel-icon bg-reverse">
							...
							<p class="size-h1 no-margin countdown_first">
								...
								if ($_SESSION['user_type'] == 'U') {
									...
									//12-04-24 echo "<a href='tot_received_dept.php?aptid=1&status=200&sla=2&user_type=" . $_SESSION['user_type'] . "'>" . $total_pending . "</a>";
									echo "<a href='tot_received_dept.php?aptid=1&status=803&sla=2&user_type=" . $_SESSION['user_type'] . "'>" . $total_pending . "</a>";
								} else {
									if ($_SESSION['user_type'] == 'M') {
						...
						<div class="panel-right panel-icon bg-reverse">
							<p class="size-h1 no-margin countdown_first">
								<?php if ($_SESSION['user_type'] == 'U') {
									...
									//echo "<a href='tot_received_dept.php?aptid=1&status=6&sla=2&user_type=" . $_SESSION['user_type'] . "'>" . $data[1]['fin'] . "</a>";
									//12-04-24 echo "<a href='tot_received_dept.php?aptid=1&status=6&user_type=" . $_SESSION['user_type'] . "'>" . $data[1]['fin'] . "</a>";
									echo "<a href='tot_received_dept.php?aptid=1&status=804&user_type=" . $_SESSION['user_type'] . "'>" . $data[1]['fin'] . "</a>";
								} else {
									if ($_SESSION['user_type'] == 'M') {
						...
						<div class="panel-right panel-icon bg-reverse">
							...
							<p class="size-h1 no-margin countdown_first">
								...
								<?php if ($_SESSION['user_type'] == 'U') {
									...
									//12-04-24 echo "<a href='tot_received_dept.php?aptid=1&status=2&sla=1&user_type=" . $_SESSION['user_type'] . "'>" . $data[1]['resolved_within_sla'] . "</a>";
									echo "<a href='tot_received_dept.php?aptid=1&status=805&sla=1&user_type=" . $_SESSION['user_type'] . "'>" . $data[1]['resolved_within_sla'] . "</a>";
								} else {
									if ($_SESSION['user_type'] == 'M') {
						...
						<div class="panel-right panel-icon bg-reverse">
							...
							<p class="size-h1 no-margin countdown_first">
								...
								<?php if ($_SESSION['user_type'] == 'U') {
									...
									//12-04-24 echo "<a href='tot_received_dept.php?aptid=1&status=2&sla=2&user_type=" . $_SESSION['user_type'] . "'>" . $data[1]['resolved_beyond_sla'] . "</a>";
									echo "<a href='tot_received_dept.php?aptid=1&status=806&sla=2&user_type=" . $_SESSION['user_type'] . "'>" . $data[1]['resolved_beyond_sla'] . "</a>";
								} else {
									if ($_SESSION['user_type'] == 'M') {
						...
						<div class="panel-right panel-icon bg-reverse">
							...
							<p class="size-h1 no-margin countdown_first">
								...
								<?php if ($_SESSION['user_type'] == 'U') {
									...
									//12-04-24 echo "<a href='tot_received_dept.php?aptid=1&status=3&sla=1&user_type=" . $_SESSION['user_type'] . "'>" . $data[1]['pending_with_sla'] . "</a>";
									echo "<a href='tot_received_dept.php?aptid=1&status=807&sla=1&user_type=" . $_SESSION['user_type'] . "'>" . $data[1]['pending_with_sla'] . "</a>";
								} else {
									if ($_SESSION['user_type'] == 'M') {
						...
						<div class="panel-right panel-icon bg-reverse">
							...
							<p class="size-h1 no-margin countdown_first">
								...
								<?php if ($_SESSION['user_type'] == 'U') {
									...
									//12-04-24 echo "<a href='tot_received_dept.php?aptid=1&status=3&sla=2&user_type=" . $_SESSION['user_type'] . "'>" . $data[1]['pending_beyond_sla'] . "</a>";
									echo "<a href='tot_received_dept.php?aptid=1&status=808&sla=2&user_type=" . $_SESSION['user_type'] . "'>" . $data[1]['pending_beyond_sla'] . "</a>";
								} else {
									if ($_SESSION['user_type'] == 'M') {
						...
						<div class="panel-right panel-icon bg-reverse">
							<p class="size-h1 no-margin countdown_first">
								...
								<?php if ($_SESSION['user_type'] == 'U') {
									...
									echo "<a href='tot_received_dept.php?aptid=1&status=809&emp_id=" . $_SESSION['emp_id'] . "&f_date=&t_date=&user_type=" . $_SESSION['user_type'] . "'>" . $reopened . "</a>";
									/*07-06-24 if ($reopened_completed_tot[1][13]['count'] > 0) {
										//31-05-24 echo "<a href='comp_det1.php?app_type_id=1&emp_id=" . $_SESSION['emp_id'] . "&status=200&f_date=$fdate&t_date=$tdate&user_type=" . $_SESSION['user_type'] . "'>" . $reopened . "</a>";
										echo "<a href='tot_received_dept.php?aptid=1&status=809&emp_id=" . $_SESSION['emp_id'] . "&f_date=&t_date=&user_type=" . $_SESSION['user_type'] . "'>" . $reopened . "</a>";
									} else {
						...
						<div class="panel-right panel-icon bg-reverse">
							<p class="size-h1 no-margin countdown_first">
								<?php if ($_SESSION['user_type'] == 'U') {
									...
									//12-04-24 echo "<a href='tot_received_dept.php?aptid=1&status=601&emp_id=" . $_SESSION['emp_id'] . "&f_date=&t_date=&user_type=" . $_SESSION['user_type'] . "'>" . $reopened_completed_tot[1][12]['count'] . "</a>";
									echo "<a href='tot_received_dept.php?aptid=1&status=810&emp_id=" . $_SESSION['emp_id'] . "&f_date=&t_date=&user_type=" . $_SESSION['user_type'] . "'>" . $reopened_completed_tot[1][12]['count'] . "</a>";
						...
						<div class="panel-right panel-icon bg-reverse">
							<p class="size-h1 no-margin countdown_first">
								...
								<?php if ($_SESSION['user_type'] == 'U') {
									...
									//12-04-24 echo "<a href='tot_received_dept.php?aptid=1&status=501&emp_id=" . $_SESSION['emp_id'] . "&f_date=&t_date=&user_type=" . $_SESSION['user_type'] . "'>" . $reopened_completed_tot[1][11]['count'] . "</a>";
									echo "<a href='tot_received_dept.php?aptid=1&status=811&emp_id=" . $_SESSION['emp_id'] . "&f_date=&t_date=&user_type=" . $_SESSION['user_type'] . "'>" . $reopened_completed_tot[1][11]['count'] . "</a>";
									...
									<div class="panel-right panel-icon bg-reverse">
										<p class="size-h1 no-margin countdown_first">
											...
											<?php if ($_SESSION['user_type'] == 'U') {
													...
													echo "<a href='tot_received_dept.php?aptid=1&status=300&sla=2&user_type=" . $_SESSION['user_type'] . "'>" . $data[1]['total_transferred'] . "</a>";
												} else {
													echo $data[1]['total_transferred'];
												}

...
class Mylibrary
{
    ...
    public function getMenus($params)
    {
        ...
        $select_array=array('s.page_id','s.menu_id','s.menu_type_id','s.langId','c.page_name','c.controller','c.is_custumlink','c.is_target_blank','c.site_controller');
        ...
        $select_array=array('s.page_id','s.main_menu_id','s.sub_menu_id','s.menu_type_id','s.langId','c.page_name','c.controller','c.is_custumlink','c.is_target_blank','c.site_controller','c.meta_photo');
        $this->CI->db->select($select_array);
       ...
       // $this->CI->db->where('c.ulbid',$params['ulbid']);
        ...
        $select_array=array('s.page_id','s.main_menu_id','s.sub_menu_id','s.sub_sub_menu_id','s.menu_type_id','s.langId','c.page_name','c.controller','c.is_custumlink','c.is_target_blank','c.site_controller','c.meta_photo');
        $this->CI->db->select($select_array);
       ...
       // $this->CI->db->where('c.ulbid',$params['ulbid']);
	    ...
	    foreach($result['sub_menus'] as $key=>$submenuarray)
	    {
	        ...
	        $data2[$submenuarray['main_menu_id']][$submenuarray['sub_menu_id']]['menu_type_id']=$submenuarray['menu_type_id'];
	        $data2[$submenuarray['main_menu_id']][$submenuarray['sub_menu_id']]['langId']=$submenuarray['langId'];
	    ...
	    foreach($result['sub_sub_menus'] as $key=>$submenuarray)
	    {
	        ...
	        $data3[$submenuarray['main_menu_id']][$submenuarray['sub_menu_id']][$submenuarray['sub_sub_menu_id']]['menu_type_id']=$submenuarray['menu_type_id'];
	        $data3[$submenuarray['main_menu_id']][$submenuarray['sub_menu_id']][$submenuarray['sub_sub_menu_id']]['langId']=$submenuarray['langId'];
	    ...
	    foreach($result['main_menus'] as $key=>$mainmenuarray)
	    {
	        ...
	        $data1[$mainmenuarray['menu_id']]['menu_type_id']=$mainmenuarray['menu_type_id'];
	        $data1[$mainmenuarray['menu_id']]['langId']=$mainmenuarray['langId'];

...
<nav id="nav_bar" class="navbar navbar-expand-sm bg-body-tertiary small"  style="background-color:blue1 !important;">
	<div class="container-fluid  p-2">
		<a class="nav-link" style="margin-right:10px;font-size:12px" href="#menu-top"><em>Skip to Main Content</em></a>
...
<div class="parent  " onmouseout="openPage('',this , '')">
	...
	<div class="child2 p-3 pointer" id="inpt">
		...
		<!--		<div>
			...
			<div class="text-shadow custom-class" style="font-size:30px;font-weight:bold;margin-left:2px; font-family:Copperplate Gothic Light;"><?php if($this->session->userdata('lang_Id') == 1){ ?>

...
<head>
  ...
  <link href="assets/nmc/ngmc/cust-style.css" rel="stylesheet">

  <script type="text/javascript" src="assets/nmc/ngmc/cust-js.js"></script><!-- DATATABLE JS -->
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarText">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
		...
		<li class="nav-item">
          <a class="nav-link active1" aria-current="page" href="#">Skip to Main Content</a>
        </li>
		 <li class="nav-item">
		...
		<li class="nav-item">
          <a class="nav-link" href="#"><button id="blue" title="Blue Theme " class="btn4 top_blue" aria-label="true" style="height:20px;width:20px;background-color:red" ></button></a>
        </li>
		<li class="nav-item">
          <a class="nav-link" href="#"><button id="blue" title="Blue Theme " class="btn4 top_blue" aria-label="true" style="height:20px;width:20px;" ></button></a>
        </li>
		<li class="nav-item">
          <a class="nav-link" href="#"><button id="blue" title="Blue Theme " class="btn4 top_blue" aria-label="true" style="height:20px;width:20px;" ></button></a>
        </li>
...
<nav id="nav_bar" class="navbar navbar-expand-sm bg-body-tertiary small"  style="background-color:blue1 !important;">
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarScroll">
		  <ul class="navbar-nav me-auto my-1 my-sm-0">
		   <li class="nav-item1">
			...
			<li class="nav-item text-left"> 
				<a class="nav-link  mybtn" href="javascript:void(0)" id="plus" title="Increase Font Size">
				  <span class="ms">A+</span>
				</a> 
			</li>
			<li class="nav-item text-left">
				<a class="nav-link  mybtn" href="javascript:void(0)" id="actual" title="Actual Font Size">
				  <span class="ms">A</span>
				</a> 
			</li>
			<li class="nav-item text-left">
				<a class="nav-link  mybtn" href="javascript:void(0)" id="minus" title="Decrease Font Size">
				  <span class=" ms">A-</span>
				</a>
			</li>
		...
		<form action="/search" method='post' class="d-flex" id="formid" role="search" >
			<input class="form-control me-0"  type="search" placeholder="Search" aria-label="Search" style="font-style:italian ;border-top:1px solid grey;border-left:1px solid grey;border-bottom:1px solid grey;border-top-right-radius:0px;border-bottom-right-radius:0px;" name="search_keyword" id="search_keyword">
		...
		<!-- <div class="d-flex justify-content-between align-items-center container">
			<div class="input-group">
			  <input type="text" class="form-control1" aria-label="Dollar amount (with dot and two decimal places)" style="border:1px solid #ffffff;">
			  <span class="input-group-text"><i class="fa fa-search"></i></span>
			</div>
			
			<div class="col-mg-4">			 
			  <span class="">Skip to Main Content</span> |<span class=""> Screen Reader Access</span>
			  			
                 | <span style="">Select theme :</span>|
               
				<span>
                  <button id="blue" title="Blue Theme " class="btn4 top_blue" aria-label="true" ></button>
                  <button id="orange" title="Orange Theme" class="btn5  top_orange" aria-label="true" ></button>
                  <button id="red" title="Green Theme" class="btn6 top_green" aria-label="true" ></button>

                </span>|<span class="ms-2">A+</span>|<span class="ms-2">A</span>|<span class="ms-2">A-</span>|
...
<div class="parent  " onmouseout="openPage('',this , '')">
	...
	<div class="child2 p-3 pointer" id="inpt">
		<div class="d-flex justify-content-start align-items-center">
			<!--<div>
				<img src="assets/nmc/ngmc/Nagpur_logo.png" class="custom-logo" style="height:50%;width:50%;object-fit: contain;margin-left:-50px;" />	
			</div> -->
			
			<div class="text-shadow custom-class" style="font-size:30px;font-weight:bold;margin-left:2px; font-family:Copperplate Gothic Light;">Nagpur Municipal Corporation</div>
		</div>
		<div>
			<img src="assets/nmc/ngmc/smart-city.png" class="custom-logo2" style="padding:10px;object-fit: contain;" />	
		
		</div>
		
	<!--	<div>
			<form id="myForm" target="_blank" method="GET">
				<select class="form-select form-select-sm" name="formType" placeholder="Login" onchange="submitForm(this)" aria-label="Small select example">
				  <option value="0" selected>Login</option>
...
<div class="parent2" onmouseout="openPage('',this , '')">
	...
	<div class="child22 pointer pt-2 " id="inpt2" style="background-color:#5c5cd6 !important;">
		<marquee width="100%" direction="left" class="h6 text-white"  onmouseover="this.stop();" onmouseout="this.start();">
		<?php foreach($important_links as $key=>$value){ ?>
			<span style="margin-right:10%;" onclick="window.open('<?php echo $value->url; ?>')"><?php echo $value->des; ?></span>
		<?php } ?>
		</marquee>
	</div>
</div>
...
<div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel" onmouseout="openPage('',this , '')">
	<div class="carousel-inner">
		...
		<div class="carousel-item">
		  <img src="../images/slide2.jpeg" class="d-block w-100" style="width:100%;height:450px; aspect-ratio: 16 / 9;" alt="...">
		</div>-->
...
<div id="menu-top"  class="navbar navbar-expand-lg bg-light1 d-flex justify-content-center" style="background-color:#EEEEEE">
	...
	<?php } ?>
	<!--
	<button class="btn tablink text-shadow" onmouseover="openPage('NMCWings', this, 'green')"   id="defaultOpen2222">NMC Wings</button>
	<button class="btn tablink text-shadow" onmouseover="openPage('ZonalOffices', this, 'blue')">Zonal Offices</button>
	<button class="btn tablink text-shadow" onmouseover="openPage('Departments', this, 'orange')">Departments</button>
	<button class="btn tablink text-shadow" onmouseover="openPage('Services', this, 'pink')">Services</button>
	
	<button class="btn tablink text-shadow" onclick="location.href='index.php?menu_item='" onmouseout="openPage('',this , '')">Grievanes</button>
	<button class="btn tablink text-shadow" onclick="location.href='index.php?menu_item='" onmouseout="openPage('',this , '')">Election 2023</button> 
	<button class="btn tablink text-shadow" onclick="location.href='index.php?menu_item='" onmouseout="openPage('',this , '')">Contact Us</button>
	<button class="btn tablink text-shadow" onclick="location.href='index.php?menu_item='" onmouseout="openPage('',this , '')">Geo NMC</button>-->
</div>

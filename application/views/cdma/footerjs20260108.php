<!--
<section class="bg-logs">
<div id="bottom-images" class="pointer p-2 d-flex justify-content-center align-items-center" >
	
	<?php 
	//foreach($layoutwidgets[9] as $key=>$value){ ?>
	<?php //echo $value; ?>
...
<section class="btm-ull">
<ul>
<?php //foreach($layoutwidgets[10] as $key=>$value){ ?>
...
?>
  ...
  <!-- Social Icons -->
  <div class="social-icons position-fixed d-flex flex-column" style="right: 5px; bottom: 60px;">

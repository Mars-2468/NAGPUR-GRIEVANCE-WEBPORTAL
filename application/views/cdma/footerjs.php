...
/* window.addEventListener('load', function() {
  ...
  <div class="social-icons position-fixed d-flex flex-column" style="right: 5px; bottom: 40px; z-index: 9999;">
	...
	<a href="https://apps.apple.com/in/app/my-nagpur-nmc/id6476917248" target="_blank" class="bg-light text-white">
		<img src="assets/nmc/images/apple-phone.png" style="height:50px;width:50px;border-radius:200px;" />
	</a>   	
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons/font/bootstrap-icons.css" rel="stylesheet">
        ...
        <div class="col-lg-3 col-md-12 footer-links">
         <?php if($language_id==1){ ?>
			...
			<div class="footer-contact pt-1">
				...
				<p><i class="bi bi-chevron-right"></i> <a href="<?php echo base_url().'site-map-marathi';?>" style="text-decoration:none;color:#ffffff">साइट नकाशा</a></p>
	...
	<div class="container copyright text-center mt-1">
	  ...
	  <strong class="px-1 sitename">NMC</strong> 
	  <span>	  
	   <?php if($language_id==1){ ?>
		  ...
		  <a href="https://mars-india.com" target="_blank" style="text-decoration:none;color:#ffffff">
		  <strong>
		  <em>
  ...
  $('.dropdown-menu', this).trigger('hover'); 
    ...
    function fun3(stylesheet)
    {
		...
		if(stylesheet!=''){
			...
			document.getElementById("latest_bar").setAttribute("style", "background-color:"+stylesheet+" !important;");
			document.getElementById("media_bar").setAttribute("style", "background-color:"+stylesheet+" !important;");
			document.getElementById("footer_bar").setAttribute("style", "background-color:"+stylesheet+" !important;");
		}else{
			document.getElementById("nav_bar").setAttribute("style", "background-color:"+stylesheet+" !important;");
			document.getElementById("latest_bar").setAttribute("style", "background-color:#5c5cd6 !important;");
			document.getElementById("media_bar").setAttribute("style", "background-color:#5c5cd6 !important;");
...
<!-- <script type="text/javascript" src="assets/nmc/js/jquery-migrate-1.2.1.min.js"></script>

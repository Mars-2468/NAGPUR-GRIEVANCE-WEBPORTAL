...
$conn = getconnection();
 ...
 $sql_list = "SELECT *  FROM  ward_mst ORDER BY SortOrder ASC";
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://114.79.182.180/grievance/api/get_all_zones.php?ulbid=250&access_key=123456789qwerty',

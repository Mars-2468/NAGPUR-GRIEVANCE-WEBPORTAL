...
<div class="sh-pagebody1">
    ...
    <div class="card">
        <div class="card-header bg-primary text-white text-center">
			<div class="d-flex justify-content-between align-items-center">
				<div>
					<?php echo $user_id; ?> Assigned Dept/Zone List
				</div>
				<div>
					<a class="btn btn-warning rounded-5" href="<?= base_url('all-user-list'); ?>">Back</a>
				</div>
			</div>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="datatable12" class="table table-bordered table-hover w-100">
                    <thead class="table-light">
                        <tr>
                            <th>Sl No</th>
                            <th>Zone/Dept Mapped</th>    
                            <th>Action</th>                  
                                          
                        </tr>
                    </thead>
                    <tbody>
                        <?php $i = 1; foreach($user_zone_dept_list as $key=>$value) { ?>
                        <tr>
                            <td><?= $i; ?></td>
                        
                            <td><?= $user_zone_dept_list[$key]??$key; ?></td>
                           
                            <td>                              
                                                       
								<a class="btn btn-danger btn-sm rounded-5"
								   onclick="return confirm('Are you sure?')"
								   href="<?= base_url('UserController/removeZoneDept/'.$user_id.'/'.$key); ?>">
								   Delete
								</a>                             

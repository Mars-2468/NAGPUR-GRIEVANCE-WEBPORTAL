...
<div class="sh-pagebody">
    ...
    <?php } ?>
          ...
          <div class="mypagetitile">Posts</div>    
            <a href="<?php echo base_url(); ?>create-post" class="btn btn-primary btn-sm mg-b-10">Add New</a>
           </div>   
...
<div style="margin-bottom:10px;">Pages in Draft(<?php foreach($count_isdraft->result() as $key=>$val){  echo $val->count;  } ?>) | pages in Publish (<?php foreach($count_ispublish->result() as $key=>$val){  echo $val->count;  } ?>) </div>
  <div class="mytable">
              <table id="datatable1" class="table table-hover table-bordered table-striped mg-b-0">
                ...
                <tbody>
                    ...
                    <td>
                        ...
                        <!--<div style="font-size:13px;"> <strong><?php echo substr($val['content'],0,15); ?></strong> </div> -->
                        <div> <a class="modify_option" href="<?php echo $val['controller']?>"> Edit </a> | <a class="modify_option pointer text-danger" href="#" onclick="delete_rec(<?php echo $key; ?>)"> Delete </a> | <a class="modify_option" onclick="update_status('<?php echo $key; ?>','<?php echo $status; ?>')"> <?php echo $status_string; ?> </a> </div>
                        <?php if(!in_array($key,$pageids)){ ?>
						<div style="margin-top:8px; width: 500px; word-wrap: break-word;">Permanent Link: <span class="permlinks"><a href="<?php echo $ulb_base_url[$val['ulbid']]['base_url'];?><?php echo $val['site_controller']?>" target="_blank"><?php echo $ulb_base_url[$val['ulbid']]['base_url'];?><?php echo $val['site_controller']?></a></span> </div>
						<?php }  ?>
					</td>
...
<script type="text/javascript">
    ...
    function delete_rec(page_id)
    {
		...
		//var burl="<?php echo base_url() ?>ViewPageController/deleteContent";
		//alert(page_id);

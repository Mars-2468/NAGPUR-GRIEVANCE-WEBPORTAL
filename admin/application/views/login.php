...
<head>
   ...
   <link href="<?php echo base_url(); ?>assets/css/core.min.css" rel="stylesheet">
    ...
    -->
	 ...
	 <script src='assets/js/jquery-tso.min.js'></script>
    ...
    <div class="row no-gutters min-h-fullscreen bg-white">
      ...
      <div class="col-md-6 col-lg-5 col-xl-4 align-self-center">
        ...
        <div class="px-80 py-30">
          ...
          <br>
          <?php $attributes=array('class'=>'form-type-material', 'method'=>'post','id' => 'formLogin1','onsubmit'=>' return validateForm1()'); ?>
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              <input type="password" class="form-control"  name="password" id="password" placeholder='password' onchange="changePassword1()" autocomplete="off">
          ...
          <p id="captImg"><?php echo $captchaImg; ?></p>
            ...
            <div class="form-group">
             <button type="submit" class="btn btn-bold btn-block btn-primary" name="submit" value="Submit" id="form-submit">Login</button>

...
<div class="">
    <div class="col-md-12">
        ...
        <div class="row">
          ...
          <div class="col-md-3">
          <input name="widgetname" id="widgetname" placeholder="Enter Widget Name...." value="<?php echo $this->input->post('widgetname');?>" onkeyup="widgetNameValidation()" class="form-control input-md" type="text"  autocomplete="off">
          </div>
          ...
          <div class="col-md-1"> <input type="submit" class="btn btn-primary" name="next" id="widgetData" value="Next"></div>

				...
				<div class="card bd-primary">
					...
					<div class="card-body pd-sm-30">
						...
						<div class="">
							...
							<textarea id="content_new" name="content_new" style="width:100%; height:400px;" data-type="sptext" onkeyup="funInputFielTypes(this)"><?php echo $content[0]['content'] ?></textarea>
						...
						<div id="publish" class="collapse show" data-bs-parent="#accordion">
							<div class="card-body">
								<center>
									...
									<input type="submit" name="save" value="Publish" id="submitBtn" disabled class="btn btn-success btn-sm">
								</center>
							</div>

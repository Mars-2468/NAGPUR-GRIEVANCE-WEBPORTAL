...
<div class="sh-pagebody">
    <div class="col-md-12" style="padding-left: 0px;">
        <h2 class="text-center">Edit Agenda And Minutes Category Year Details</h2>
                ...
                <div class="row">
                   ...
                   <div class="col-md-12">
                      <div class="form-group">
                        <label class="control-label col-sm-12" for="email">Year: <span class="tx-danger">*</span></label>
                        <input type="text" name="year" class="form-control" value="<?php echo $dtl->year ?>" required>
                      </div>
                   </div>

...
<body>
    ...
    <div class="sh-sideleft-menu">
	  ...
	  <?php if(in_array($_SESSION['userid'],['Zone_01','Zone_02','Zone_03','Zone_04','Zone_05','Zone_06','Zone_07','Zone_08','Zone_09','Zone_10'])){ ?>
	  ...
	  <?php } ?>
		   ...
		   <?php } ?>
		    <?php if(!strcmp($_SESSION['userid'],"superadmin")){ ?>
 		   <li class="nav-item">

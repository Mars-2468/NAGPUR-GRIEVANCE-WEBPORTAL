...
<br>
  ...
  <div class="modal-dialog modal-sm">
    ...
    function addcustumlink()
    {
		...
		//const regexlink=/^[a-zA-Z0-9_ ]+$/;
		const regexlink=/^[a-zA-Z0-9_ \u0900-\u097F]+$/u;
		
		if (!regexlink.test(linktext)) {
			alert('invalid linktext');
			$("#linktext").val('');
			return false;
		}
        if(linktitle=='')
        {
			...
			//const regextitle=/^[a-zA-Z0-9_]+$/;
			const regextitle=/^[a-zA-Z0-9_ \u0900-\u097F]+$/u;
		
		if (!regextitle.test(linktitle)) {
			alert('Invalid title');
			$("#linktitle").val('');
			return false;
		} 

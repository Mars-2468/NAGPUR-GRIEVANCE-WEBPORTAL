...
<div class="sh-pagebody">
    <div class="col-md-12" style="padding-left: 0px;">
        <div class="text-center">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal1">Add About Slider</button>
        </div>
            <?php
        ...
        <div class="card bd-primary ">
            <div class="card-header bg-primary tx-white">All About Slider</div>
              ...
              <table id="datatable1" class="table table-hover table-bordered table-defulat mg-b-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img height="80px" src="<?php echo base_url() ?>../assets/cdma/testimonials/<?php echo $row->img; ?>" alt="img"></td>
                        <td>
                            <div><a href="<?php echo base_url() ?>edit_about_slider/<?php echo $row->id; ?>" class="modify_option">Edit </a> </div>
                            <div><a href="<?php echo base_url() ?>AboutSliderController/delete/<?php echo $row->id; ?>" class="modify_option1" onclick="return confirm('Are you Sure?')"> Delete </a> </div>
                        </td>
                        <td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add New About Slider</h5>

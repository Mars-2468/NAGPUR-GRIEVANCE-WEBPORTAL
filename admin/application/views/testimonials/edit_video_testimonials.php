...
<div class="sh-pagebody">
    <div class="col-md-12" style="padding-left: 0px;">
        <h2 class="text-center">Edit Video Testimonials</h2>
                ...
                <div class="row">
                   ...
                   <div class="col-md-12">
                      <div class="form-group">
                          <label class="control-label col-sm-3" for="email">Path: <span class="tx-danger">*</span></label>
                          <input type="text" name="file" class="form-control" value="<?php echo $dtl->file; ?>">
                      </div>
                   </div>
                   <div class="col-md-12">
                      <div class="form-group">

            ...
            <div class="card-body pd-sm-30">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <span class="tx-danger">*</span></label>
                        <div class="col-sm-12" style="padding-left:0px; padding-right:0px;">
                            <input type="text" name="pagename" class="form-control mytext"  onkeyup="fun1(this.value)" required="required" id="pagename" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12" style="padding-left:0px; padding-right:0px;">
                            <input type="text" name="pagetitle" class="form-control mytext"  onkeyup="fun1(this.value)" required="required" >
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control " placeholder="Hover title" name="hover_title" required="required" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input rows="3" type="text" data-role="tagsinput" class="form-control " placeholder="Related tags" name="ptags"  required="required">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <textarea rows="3" class="form-control" placeholder="Enter Post Related Description here " name="meta_desc" required="required"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <textarea rows="3" class="form-control " placeholder="Enter Post Related Subject here " name="meta_subject" required="required"></textarea>
        ...
        <div class=" " id="accordion">
            ...
            <div class="card" style="margin-bottom:15px;">
                ...
                <div id="publish1" class="collapse show" data-bs-parent="#accordion">
                    <div class="card-body">
                        <center><input type="submit" name="draft" value="Save to Draft"  class="btn btn-primary btn-sm" onclick="go_draft()">	

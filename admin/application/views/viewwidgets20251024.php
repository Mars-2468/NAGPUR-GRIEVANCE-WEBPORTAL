              ...
              <table id="datatable1" class="table table-hover table-bordered table-striped mg-b-0">
                ...
                <tbody>
                    ...
                    <td style="width: 200px;">
                        ...
                        <div>
							<?php if($val['is_edit_permission']=='1'){ ?> <a class="modify_option" href="<?php echo base_url(); ?>edite-widget/<?php echo $key; ?>/<?php echo $val['widget_type']; ?>/<?php echo $val['widget_type_style'] ;?>"> Edit </a><?php } ?> <?php if($val['is_delete_permission']=='1'){ ?> | <a class="modify_option1" class="modify_option1" onclick="delete_rec(<?php echo $key; ?>)"> Delete </a><?php } ?>  
                        </div>

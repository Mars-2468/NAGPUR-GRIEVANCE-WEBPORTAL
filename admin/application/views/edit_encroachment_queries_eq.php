			...
			<form action="<?php echo base_url();?>EncroachmentQueriesController/updateRecord" method="post" name="add" enctype="multipart/form-data" style="padding: 15px; border: 2px solid">
                ...
                <div class="row">
					...
					<div class="col-md-12">
						<div class="form-group">
							...
							<input type="file" name="show_cause_notice" id="show_cause_notice" class="form-control mytext" accept="image/jpeg, image/jpg, image/png, application/pdf" data-type="imfile" onchange="funInputFielTypes(this)"  >
					...
					<div class="col-md-12">
					  <div class="form-group">
						...
						<input type="file" name="applicant_reply" id="applicant_reply" class="form-control mytext" accept="image/jpeg, image/jpg, image/png, application/pdf" data-type="imfile" onchange="funInputFielTypes(this)"  >
					...
					<div class="col-md-12">
					  <div class="form-group">
						...
						<input type="file" name="answer"  id="answer" class="form-control mytext" accept="image/jpeg, image/jpg, image/png, application/pdf" data-type="imfile" onchange="funInputFielTypes(this)" >
					...
					<div class="col-md-12">
					  <div class="form-group">
						...
						<textarea name="description" id="description" rows="3" class="form-control mytext" data-type="text" onkeyup="funInputFielTypes(this)" ><?php echo $dtl->description; ?> </textarea>
                ...
                <div class="row">
                   <div class="col-md-12 text-center">
                      <input type="submit" name="updateencroachmentqueries" id="submitBtn" disabled value="Update" class="btn btn-success">

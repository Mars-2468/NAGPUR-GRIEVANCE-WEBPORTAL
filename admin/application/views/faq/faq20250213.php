...
<div class="sh-pagebody">
    ...
    <?php
              ...
              ?>
    <form name="" action="<?php echo base_url();?>FAQController/add_faqs" method="POST">
        <div class="row">
            ...
            <div class="form-group col-md-12">
                ...
                <div class="">
                    ...
                    <textarea name="question" required="required" class="form-control"><?php echo $edit_faqs->question;?></textarea>
            ...
            <div class="form-group col-md-12">
                ...
                <div class="">
                    <textarea name="answer" required="required" class="form-control"><?php echo $edit_faqs->answer;?></textarea>
                </div>
            </div>
            ...
            <div class="col-md-1">
              <input type="hidden" name="id" value="<?php echo $edit_faqs->id;?>">
                <input type="submit" value="Submit" name="submit" id="butundisab" class="btn btn-sm btn-primary"
                ...
                <div class="mytable">
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?php $yrdata= strtotime($row['created_at']);  echo date('d - M-Y H:i:s', $yrdata); ?>
                                </td>
                                <td><a href="<?php echo base_url();?>faq-details/<?php  echo $row['id']; ?>"> Edit</a>

...
<div class="sh-pagebody">
    ...
    <?php
              ...
              ?>
    <form name="socialForm" action="<?php echo base_url();?>update-links-page" method="POST" >
        <div class="row">
	...
	<input type="hidden" name="form_nonce" value="<?= $form_nonce; ?>">
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control"  name="facebook_link" id="facebook_link" value="<?php echo $edit_social_media->facebook_link;?>" data-type="url" onkeyup="funInputFielTypes(this)">
				<div style="font-size:10px;color:red;" id="facebook_linkX"></div>
                </div>
            </div>
            ...
            <div class="form-group col-md-12">
                ...
                <div class="">
                <input type="text" class="form-control"  name="twitter_link" id="twitter_link" value="<?php echo $edit_social_media->twitter_link;?>"  data-type="url" onkeyup="funInputFielTypes(this)">
                <div style="font-size:10px;color:red;" id="twitter_linkX"></div>
				</div>
            </div>
 	<div class="form-group col-md-12">
                <label class=" control-label" for="textinput">Instagram Link: <span class="tx-danger">*</span></label>
                <div class="">
                <input type="text" class="form-control"  name="instagram_link" id="instagram_link" value="<?php echo $edit_social_media->instagram_link;?>"  data-type="url" onkeyup="funInputFielTypes(this)">
				<div style="font-size:10px;color:red;" id="instagram_linkX"></div>
			   </div>
            </div>

            <div class="col-md-1">
              <input type="hidden" name="id" value="<?php echo $edit_social_media->distid;?>">
                <input type="submit" value="Update" name="submit" id="submitBtn" disabled class="btn btn-sm btn-primary"
...
$(function() {
   ...
   <script>
	...
	//alert(regex.test(facebook_link.value));
	
  if(!regex.test(facebook_link.value)){
	  alert('Invalid Url!');
	  location.reload();
	  return false;
  }
 
   if(!regex.test(twitter_link.value)){
	    alert('Invalid Url!');
		location.reload();
	  return false;
   }

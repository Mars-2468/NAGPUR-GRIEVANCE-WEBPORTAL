	...
	<div class="card bd-primary ">
		<div class="card-header bg-primary tx-white">Upload Images</div>
			<div class="card-body ">
				...
				<?php echo form_open_multipart('UploadMediaController/imageUploadPost'); ?>
					<input type="file" name="file[]" accept="application/pdf,image/png,image/jpg,image/jpeg" multiple />
				...
				<?php echo form_close(); ?>
					  ...
					  <?php  echo form_open('export-media-library'); ?>
					  
					  <div class="row">			  
					  
					  <!--  bulk images uploading -->	
				  
					  <?php $i=1;$flag=1; foreach($media_data as $key=>$val){?>
					  ...
					  <div class="col-md-6">
						<?php 
							...
							$imageExtensions = ['.jpg', '.jpeg', '.png', '.gif', '.bmp', '.webp','.svg','.pdf'];

							if (!in_array(strval($val['file_ext']),$imageExtensions)) {
								echo "<span style='color:#ff0000'><i class='fa fa-close' style='font-size:18px;color:#FF0000'></i> &nbsp;This file is not an image file. Please remove it! </span>";
								$flag=0;
							}else{								
								echo "<span style='color:#00ff00'> <i class='fa fa-check' style='font-size:18px;color:#00FF00'></i> </span>";
							}	
						...
						<label class="mycheckbox">
							<a class="file-manager-icon">
								<div style="overflow:hidden;">
									...
									<?php if(in_array(strval($val['file_ext']),['.png','.jpg','.jpeg'])) {  ?>
										<img src="<?php echo $val['thumbnail_path'];?>" style="width:100px;height:100px;"> 
									<?php }else	if(in_array(strval($val['file_ext']),['.pdf'])) {  ?>
										<img src="<?php echo '/adhikari/assets/img/pdf.png';?>" style="width:100px;height:100px;"> 
									<?php }else{ ?>	
										<img src="<?php echo '/assets/300/2025/02/mediafiles/thumbs/warning-photo.png';?>" style="width:100px;height:100px;"> 
									<?php } ?>	
						...
						<div class="col-md-8" style="padding-left: 15px; padding-right: 15px;">
							...
							<div class="row">
								...
								<div class="form-group">
								  ...
								  <input id="title<?php echo $i; ?>" name="title<?php echo $i; ?>" placeholder="Enter Title here" class="form-control input-md"  type="text" data-type="text" onkeyup="funInputFielTypes(this)"  required="required">
								  <div style="font-size:10px;color:red;" id="title<?php echo $i; ?>X"></div>
								...
								<div class="form-group">
								  ...
								  <input id="alt<?php echo $i; ?>" name="alt<?php echo $i; ?>" placeholder="Enter Alt Text" class="form-control input-md"  type="text" required="required" data-type="text" onkeyup="funInputFielTypes(this)" >
								 <div style="font-size:10px;color:red;" id="alt<?php echo $i; ?>X"></div>
								</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
									  ...
									  <textarea class="form-control" rows="3" id="desc<?php echo $i; ?>" name="desc<?php echo $i; ?>" required="required" data-type="text" onkeyup="funInputFielTypes(this)" ></textarea>
									 <div style="font-size:10px;color:red;" id="desc<?php echo $i; ?>X"></div>
									</div>
								</div>
							</div>
				...
				<!-- images loop close here -->        
				 ...
				 <?php $i++; } ?>
						...
						<br>
						<br>
						<?php if(count($media_data) && $flag){ ?>
						<center>
							<input type="hidden" name="count" value="<?php echo $i; ?>">
							<input type="submit" class="btn btn-success" name="exportdata" value="Upload" id="submitBtn" disabled>
							</center>

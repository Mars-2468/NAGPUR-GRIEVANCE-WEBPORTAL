...
<?php// $attributes=array('method'=>'POST'); echo form_open('edit-site',$attributes);?>
...
<div class="form-group">
  ...
  <div class="col-md-6 "><input type="text" class="form-control" placeholder="Enter ULB name" name="ulbname" id="ulbname" required></div>
...
<div class="form-group">
  ...
  <div class="col-md-6"><input type="text" class="form-control" placeholder="System id of the portal" name="systemid" id="systemid" required></div>
</div>

<div class="form-group">
  <label for="usr" class="col-md-4 control-label"> Department web portal url <span class="tx-danger">*</span></label>
  <div class="col-md-6"><input type="text" class="form-control" placeholder="Department web portal url" name="base_url" id="base_url" required></div>
</div>
...
<div class="form-group">
 ...
 <div class="col-md-6"> <input type="text" class="form-control" placeholder="Admin concerned person name" name="admin_concerned_person" id="admin_concerned_person" required> </div>
</div>
...
<div class="form-group">
 ...
 <div class="form-group">
  ...
  <div  class="col-md-6"><input type="text" class="form-control" placeholder="Mobile number " name="mobile" id="mobile" required></div>
</div>
...
<div class="form-group">
 ...
 <div  class="col-md-6"> <input type="text" class="form-control" placeholder="concerned person name " name="tech_concerned_person_name" id="tech_concerned_person_name" required></div>
</div>
...
<div class="form-group">
  <label for="usr" class="col-md-4 control-label"> Mobile number   <span class="tx-danger">*</span></label>
  <div  class="col-md-6"><input type="text" class="form-control" placeholder="Mobile number" name="tech_concerned_person_mobile" id="tech_concerned_person_mobile" required></div>
</div>

<div class="form-group">
  <label for="usr" class="col-md-4 control-label"> Email id   <span class="tx-danger">*</span></label>
  <div  class="col-md-6"><input type="text" class="form-control" placeholder="Email id" name="tech_concerned_person_email" id="tech_concerned_person_email" required></div>
</div>

    
<div class="form-group">
  <label for="usr" class="col-md-4 control-label"> Admin username <span class="tx-danger">*</span></label>
  <div class="col-md-6"><input type="text" class="form-control" placeholder="Enter admin user id" name="user_id" required></div>
</div>

<div class="form-group" >
  <label for="usr" class="col-md-4 control-label"> Admin password <span class="tx-danger">*</span></label>
 <div class="col-md-6"><input type="password" class="form-control" placeholder="Enter admin password" name="password" required></div> 
</div>
...
<div class="card bd-primary ">
         ...
         <div class="card-body ">
            ...
            <div class="form-group" style="margin-top:15px;">
             ...
             <div class="col-md-6">
                 <input rows="3" data-role="tagsinput"  type="text"class="form-control" placeholder=" Tags separate by 'Space' " name="keywords" >
             </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <textarea rows="3" class="form-control" placeholder="Enter Site Related Description here " name="meta_desc" required="required"></textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <textarea rows="3" class="form-control " placeholder="Enter Site Related Subject here " name="meta_subject" required="required"></textarea>

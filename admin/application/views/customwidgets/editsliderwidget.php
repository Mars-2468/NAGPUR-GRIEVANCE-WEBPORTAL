...
<div class="sh-pagebody">
    <div class="card bd-primary ">
        <div class="card-header bg-primary tx-white">Edit Slider Widget</div>
        <div class="card-body pd-sm-30">
<?php $attributes=array('onsubmit'=>'return validateForm();'); echo form_open('ViewWidgetsController/editsliderWidget',$attributes);?>

<input type="hidden" name="widgetname" value="<?php echo $widget_det['widget_id']; ?>">
<input type="hidden" name="widgettype" value="<?php echo $widget_det['widget_type']; ?>">
...
<?php //print_r($result); ?>
  <div class="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="text" class="form-control" name="widget_name" id="widgetname"  value="<?php echo $value['widget_name']; ?>" <?php if(($this->session->userdata('user_type')) != 'A'){ echo 'readonly'; }?>>
                    </div>
                </div>
                <?php }?>
            </div>
        ...
        <div class="card-body pd-sm-10">
            ...
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <!--<input type="checkbox" value="<?php echo $val2['page_id']; ?>" name="check_list[]" <?php echo $string; ?>> <?php echo $val2['page_name']; ?>-->
                    
                    <div class="col-md-3">
                        <label class="ckbox" style="width:100%;">
                            <input class="chkcat checkList" id="check_list" type="checkbox" value="<?php echo $val['page_id']; ?>" name="check_list[]" <?php echo $string; ?> onclick="radioUlbNameCheckFun()"> <span><?php echo $val['page_name']; ?></span>
                        </label>
                   </div>
                    <?php }?>
                    </div>

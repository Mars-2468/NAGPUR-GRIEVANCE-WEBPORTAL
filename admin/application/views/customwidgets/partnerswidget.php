...
<hr>
    ...
    <div class="card bd-teal ">
        <div class="card-header bg-teal tx-white">Startup</div>
        <div class="card-body ">
              ...
              <div class="panel with-nav-tabs  ">
                <div class="panel-heading " style="background-color: #CCC;">
                        <ul class="nav nav-tabs"  role="tablist">
                            <li class="nav-item">
                              <a class="nav-link active" data-bs-toggle="tab" href="#tab1success">Testimonials</a>
                            </li>
                            <!--<li class="active"><a href="#tab1success" data-toggle="tab">Testimonials</a></li>-->
                            <!--<li><a href="#tab2success" data-toggle="tab">Details</a></li>-->
                            <!--<li><a href="#tab3success" data-toggle="tab">Tab 1</a></li>-->
                            <!--<li><a href="#tab4success" data-toggle="tab">Tab 2</a></li>-->
                            <!--<li><a href="#tab5success" data-toggle="tab">Tab 3</a></li>-->
                        </ul>
                </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane container active" id="tab1success">
                            ...
                            <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-4 control-label" for="textinput">Event heading </label>  
                                        <div class="col-md-4">
                                            <input id="title" name="title" placeholder="Enter event heading" class="form-control input-md mytext1" type="text" maxlength="20" required autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input id="" name="eventDate"  class="form-control input-md mytext1" type="date" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input id="" name="eventTime"  class="form-control input-md mytext1" type="time">
                                        </div>
                                    </div>
                            </div>

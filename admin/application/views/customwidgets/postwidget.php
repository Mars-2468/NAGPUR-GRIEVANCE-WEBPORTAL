...
<?php $attributes=array('onsubmit'=>'return validateForm'); echo form_open('CreateWidgetController/savepostWidget',$attributes);?>
...
<hr>
    ...
    <div class="card bd-teal ">
        <div class="card-header bg-teal tx-white">Post Categories</div>
                    ...
                    <div class="">
                        ...
                        <div class="col-md-3">
                            <label class="ckbox" style="width:100%;">
                                <input type="checkbox" value="<?php echo $val['page_id']; ?>" class="chkcat" name="check_list[]" onclick="fun1();"><span><?php echo $val['page_name']; ?></span><br>
                            </label>
                        </div>
                        <?php }?>
                    </div>
    ...
    <br>
    <center>
    <div class=""><input type='submit' value='Save' name="save" class='btn btn-success'> </div>
    </center>

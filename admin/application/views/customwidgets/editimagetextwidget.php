    ...
    <div class="card bd-primary ">
		...
		<div class="card-body ">
			...
			<div class="form-horizontal">
				...
				<?php $url="edite-widget/" . encrypt_data($widget_det['widget_id']) . "/" . encrypt_data($widget_det['widget_type']) . "/" . encrypt_data($widget_det['widget_type_style']); ?>
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input id="userfile" name="userfile" class="input-file" type="file" onchange="form_submit()">
				...
				<?php foreach($result['widgetName'] as $val){  ?>
					...
					<div class="form-group">
						...
						<div id="widget_nameX" style="color:red;font-size:10px"></div>
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4">						
						<img src="<?php echo  str_replace("/admin/","",base_url()).substr($filepath,2); ?>" class="img-responsive"  style="width:100%;height:100%;">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div id="titleX" style="color:red;font-size:10px"></div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div id="descriptionX" style="color:red;font-size:10px"></div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<input id="page_url" name="page_url" placeholder="Enter url here" class="form-control input-md" type="text"  data-type="localurl" onkeyup="funInputFielTypes(this)" value="<?php echo $result['widgetContent'][0]['url_link']; ?>">
					<div id="page_urlX" style="color:red;font-size:10px"></div>
					</div>
				</div>
			...
			<div class="form-horizontal">
				...
				<div class="form-group">
					<label class="col-md-4 control-label" for="textinput">Present image</label>  
					<div class="col-md-4">
						<img src="<?php echo  $this->session->userdata('base_url').substr($filepath,2); ?>" class="img-responsive" style="width:100%;height:100%;">
					</div>
				</div>
				...
				<div class="form-group">
					<label class="col-md-4 control-label" for="textinput">Description</label>  
					<div class="col-md-4">
						<textarea rows="5" id="description" name="description" placeholder="Enter Description" class="form-control input-md mytext1" type="text"  data-type="sptext" onkeyup="funInputFielTypes(this)"  required><?php echo $result['widgetContent'][0]['description']; ?>
						</textarea>
						<div id="descriptionX" style="color:red;font-size:10px"></div>
					</div>
				</div>
			...
			<div class="form-horizontal">
				...
				<div class="form-group">
					<label class="col-md-4 control-label" for="textinput">Description</label>  
					<div class="col-md-4">
						<textarea rows="5" id="description" name="description" placeholder="Enter Description" class="form-control input-md mytext1" type="text" maxlength="240"  data-type="text" onkeyup="funInputFielTypes(this)" required><?php echo $result['widgetContent'][0]['description']; ?></textarea>
					<div id="descriptionX" style="color:red;font-size:10px"></div>
					</div>
				</div>
				<!--<div id="descriptionCheckValidationError" style="display:;" class="alert alert-danger">-->
...
<script>
    ...
    {
		var type = <?php echo decrypt_data($this->uri->segment('4')); ?>;
		var widget = <?php echo decrypt_data($this->uri->segment('3')); ?>;

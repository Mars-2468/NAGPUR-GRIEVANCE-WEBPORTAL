...
<div class="sh-pagebody">
    ...
    <div class="card bd-primary ">
         ...
         <div class="card-body ">
              ...
              <?php $attributes= array('class'=>'dropzone','id'=>'imageUpload'); echo form_open_multipart('UploadPhotoGalleryController/imageUploadPost',$attributes);?>
              ...
              <img src="<?php echo base_url()?>assets/img/icn-upload.png">
               <?php // foreach($defaultalbum as $key=>$row){?>
              ...
              <?php echo form_open('UploadPhotoGalleryController/exportDatatomedialibrary'); ?>
              <div class="row">
              <?php $i=1; foreach($media_data as $key=>$row){?>
              ...
              <div class="col-md-6">
               ...
               <a class="file-manager-icon">
                 <div style="overflow:hidden;">
                                    ...
                                    <img src="<?php echo $this->session->userdata('base_url').$row['thumbnail_path'];?>"> 
                ...
                <div class="overlay">
                <?php if($row['id'] != ''){   ?>
                    <a onclick="photo_delete_rec(<?php echo $row['id']; ?>)"><i class="fa fa-trash icon_style1" ></i></a>
               <?php }?>
                ...
                <div class="col-md-8" style="padding-left: 15px; padding-right: 15px;">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                          ...
                          <input id="title<?php echo $i; ?>" name="title<?php echo $i; ?>" placeholder="Enter Title here" class="form-control input-md" required="required" type="text" >
                        ...
                        <div class="form-group">
                          ...
                          <input id="alt<?php echo $i; ?>" name="alt<?php echo $i; ?>" placeholder="Enter Alt Text" class="form-control input-md" required="required" type="text" >
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <textarea class="form-control" rows="3" id="desc<?php echo $i; ?>" required="required" name="desc<?php echo $i; ?>" ></textarea>
                            </div>
                        </div>
                    </div>
        ...
        <!-- images loop close here -->        
         ...
         <?php $i++; } ?>
                ...
                <center>
                    ...
                    <!--<input type="hidden" name="album_id" value="<?php //echo $defaultalbum[0]['album_id']; ?>">-->
              ...
              <!--    <div class="thumbnail img_height" style="overflow:hidden;" onclick="edit_rec(<?php echo $val['id']; ?>)">-->
              ...
              <div class="col-6 col-sm-4 col-lg-3 col-xl-2 media_style" style="position:relative;">
               ...
               <a  class="file-manager-icon">
                 <div style="overflow:hidden;">
                  ...
                  <!--<input type="text" id="media_"/>-->
                  <?php }else{ ?>
                  <input class="inputClassImage"   type="checkbox" name="image[]" value="<?php echo $val['id'].'_photo'; ?>" />
                  <!--<input type="hidden" id="<?php echo $val['id'].'_photo_thumb'; ?>" value="<?php  echo $val['thumbnail_path']; ?>" />
                  <input type="hidden" id="<?php echo $val['id'].'_photo_imagepath'; ?>" value="<?php  echo $val['image_path']; ?>" />-->
                  <?php } ?>
                <i class="fa fa-check hidden"></i>
                 </div>
               ...
               <div class="overlay">
                <?php if($val['slide_id'] != ''){   ?>
                    <a onclick="photo_edit_rec(<?php echo $val['slide_id']; ?>,'medialibrary')" data-toggle="modal" data-target="#myModalEdit"><i class="fa fa-edit icon_style1" ></i></a>
                    <a onclick="photo_delete_recd(<?php echo $val['slide_id']; ?>,'medialibrary')"><i class="fa fa-trash icon_style1" ></i></a>
                <?php }else{ ?>
                    <a onclick="photo_edit_rec(<?php echo $val['id']; ?>,'album_image_map')" data-toggle="modal" data-target="#myModalEdit"><i class="fa fa-edit icon_style1" ></i></a>
                    <a onclick="photo_delete_recd(<?php echo $val['id']; ?>,'album_image_map')"><i class="fa fa-trash icon_style1" ></i></a>
                <?php } ?>
             </div>
    ...
    <div class="modal-content" style="background-color:#FFF;">
      ...
      <div class="modal-body">
       ...
       <div class="col-md-8">
         ...
         <img src="https://municipalservices.in/sites/admin/assets/img/loading.gif" class="img-responsive" style=" margin:0 auto;" id="cpg_model_img">
         </div>
       </div>
       <div class="col-md-4 ">
...
<script type="text/javascript">
  ...
  Dropzone.options.imageUpload = {
            ...
            if(confirm('Are sure you want to delete this record')){
                for(var i=0;i<len;i++){
                    ...
                    if(res[1] == 'photo'){
                        var id = res[0];
                        //alert(res[0]+' '+res[1]);
                        $.post('<?php echo base_url()?>CreatePhotogalleryController/deleteContent',{id:id},function(data) {
                            if(data==1){
    ...
    function photo_edit_rec(id,album_name){
        //alert(id+" "+album_name);
        ...
        if(album_name == 'album_image_map'){
            $.post('<?php echo base_url()?>UploadPhotoGalleryController/getContent',{id:id},function(data){
               //alert(data);
            ...
            $.post('<?php echo base_url()?>CreatePhotogalleryController/getContentMedia',{slide_id:slide_id},function(data){
                //alert(data);
                var obj = JSON.parse(data);
      ...
      function photo_delete_rec(id){
      if(confirm('Are sure you want to delete this record')) {
            //alert(id); return;
            $.post('<?php echo base_url()?>UploadPhotoGalleryController/deleteContent',{id:id},function(data){
               //alert(data);
                if(data=='1'){
    ...
    $("#cpg_status").change(function(){
       ...
       // var heading = $("#cpg_heading").val();
        ...
        if(album_name == 'album_image_map'){
            $.post('<?php echo base_url()?>UploadPhotoGalleryController/updateImgInfo',{id:id,description:description,title:title,alttext:alttext},function(data){
               // alert(data);
                if(data=='1'){
            ...
            $.post('<?php echo base_url()?>CreatePhotogalleryController/updateMediaImgInfo',{slide_id:id,heading:heading,description:description,title:title,alttext:alttext,album_id:album_id},function(data){
                //alert(data);
                if(data=='1'){
                    alert('Updated successfully');
                    location.reload();
...
function photo_delete_recd(id,album_name)
    {
      // var album_id = $("#album_id").val();
        if(album_name == 'album_image_map'){
            //alert(album_name);
            if(confirm('Are sure you want to delete this record'))
            {
                ...
                $.post('<?php echo base_url()?>UploadPhotoGalleryController/deleteimg',{id:id},function(data)
                {
                    //alert(data);
                    if(data==1)
                    {
            ...
            {
                //alert(slide_id); 
                $.post('<?php echo base_url()?>CreatePhotogalleryController/deleteContentMedia',{slide_id:slide_id,album_id:album_id},function(data)
                {
                    //alert(data);
                    if(data==1)
                    {

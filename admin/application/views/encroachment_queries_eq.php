                ...
                <tbody>
                    ...
                    foreach($all as $row)
                    {
						...
						<tr>
							...
							<td>
								<?php echo $page_departments_list[$row->page_id]; ?>
							</td>
							<td>							
								<?php  
							...
							<td>
								<div><a href="<?php echo base_url() ?>edit-encroachment-queries-eq/<?php echo $row->id; ?>" class="modify_option">Edit </a> </div>
								<div><a href="<?php echo base_url() ?>delete-encroachment-queries-eq/<?php echo $row->id; ?>" class="modify_option1" onclick="return confirm('Are you Sure?')"> Delete </a> </div>
							</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
       ...
       <div class="modal-body">
        <form action="<?php echo base_url();?>EncroachmentQueriesController/saveRecord" method="post" name="add" enctype="multipart/form-data" style="padding: 15px;">
            ...
            <div class="row">
               <div class="col-md-12 text-center">
                  <input type="submit" name="submitencroachmentqueries" id="submitBtn" value="Submit" class="btn btn-success" disabled>
               </div>
            </div>

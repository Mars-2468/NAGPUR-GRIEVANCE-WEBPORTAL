...
class AgendaMinutesController extends CI_Controller {
	...
	public function index()
	{
	   if($this->session->userdata('session_id')==session_id())
	    {
	        ...
	        {
	            $category = $this->security->xss_clean(trim(htmlspecialchars(strip_tags($this->input->post('category')))));
                ...
                $run = $this->CreatePostModel->insert('tbl_agenda_category_mst', $Array);
                if ($run) 
			     {
			       $this->session->set_flashdata('success', 'Added Successfully !!');
			       redirect ('schemes-category');
			     }
	        }
	        ...
	        {
	            $category = $this->security->xss_clean(trim(htmlspecialchars(strip_tags($this->input->post('category')))));
	            $link = $this->security->xss_clean(trim(htmlspecialchars(strip_tags($this->input->post('link')))));
	        ...
	        if($this->input->post('submitnewspaper'))
	        {
	            $category = $this->security->xss_clean(trim(htmlspecialchars(strip_tags($this->input->post('category')))));
	            $des = $this->security->xss_clean(trim(htmlspecialchars(strip_tags($this->input->post('des')))));
	            $text1 = $this->security->xss_clean(trim(htmlspecialchars(strip_tags($this->input->post('text1')))));
	            $text2 = NULL;
	        ...
	        if($this->input->post('save') || $this->input->post('is_draft'))
	        {
	            ...
	            $inputCaptcha = $this->security->xss_clean(trim(htmlspecialchars(strip_tags($this->input->post('captcha')))));
                  $sessCaptcha = $this->security->xss_clean(trim(htmlspecialchars(strip_tags($this->session->userdata('captchaCode')))));
    	        ...
    	        if($this->session->userdata('langId')==1)
    	        {
    	            ...
    	            $pagename=substr(strtolower($this->security->xss_clean(trim(htmlspecialchars(strip_tags($this->input->post('pagename')))))),0,60);
    	        }
    	        else
    	        {
                ...
                else
                {
                   ...
                   if($this->input->post('fromDate')==='1970-01-01' || $this->input->post('fromDate')==='0000-00-00')
	                ...
	                else
	                {
	                 ...
	                 $from=date('Y-m-d H:i',strtotime($this->security->xss_clean(trim(htmlspecialchars(strip_tags($this->input->post('fromDate')))))));
	                 $to=date('Y-m-d H:i',strtotime($this->security->xss_clean(trim(htmlspecialchars(strip_tags($this->input->post('toDate'))))))); 
        	       ...
        	       if($data1['result']=='1')
        	       {
        				...
        				if(!empty($this->input->post('categories')))
        				{
    				        ...
    				        /*** updating slider thumbnail image ****/
    				                        if($code==1) 
            				                    {
    				                              $this->CreatePostModel->updateSliderThumbnailimage($data1['pageId'],substr(htmlspecialchars(strip_tags($this->session->userdata('pathimagesaveurl'))),2));
            				                    }
	  ...
	  $submenudata=array();
	   ...
	   // print_r($forms);
	    ...
	    $data['all']= $this->CreatePostModel->all('tbl_agenda_category_mst', $params);
	    //print_r($data['all_startups_partners']);exit;
	    $this->load->view('header',$data);
		$this->load->view('agendaminutes/category',$data);
	...
	public function delete()
	{
	    ...
	    $del = $this->CreatePostModel->delete('tbl_agenda_category_mst', array('id' => $delid));
	    if ($del) 
	     {
	...
	{
	    $delid = $this->uri->segment('3');
	    $del = $this->CreatePostModel->delete('tbl_agenda_category_year_mst', array('id' => $delid));
	    if ($del) 
	     {
	   	  $this->session->set_flashdata('success', 'Deleted Successfully !! ');
	      redirect('agenda_and_minutes_category_year');
	     }
	}
	public function deleteAgenda()
	{
	    $delid = $this->uri->segment('3');
	    $del = $this->CreatePostModel->delete('tbl_agenda_mst', array('id' => $delid));
	    if ($del) 
	     {
	   	  $this->session->set_flashdata('success', 'Deleted Successfully !! ');
	      redirect('schemes-sub-category');
	     }
	}
	public function deleteAgenda1()
	{
	    $delid = $this->uri->segment('3');
	    $del = $this->CreatePostModel->delete('tbl_agenda_category_mst', array('id' => $delid));
	    if ($del) 
	...
	public function edit_agenda_and_minutes_category()
	{
	    
	   if($this->session->userdata('session_id')==session_id())
	    {
	        $editid = $this->uri->segment('2');
	        $data['dtl'] = $this->CreatePostModel->get_row('tbl_agenda_category_mst', array('id' => $editid));
	        ...
	        if($this->input->post('update'))
	        {
                ...
                $run = $this->CreatePostModel->update('tbl_agenda_category_mst', $Array, array('id' => $editid));
                 if ($run) 
				   {
				     $this->session->set_flashdata('success', 'Updated Successfully !!');
				     redirect ('agenda_and_minutes_category');
				   }
	        }
	  ...
	  $submenudata=array();
	   ...
	   // print_r($forms);
	    ...
	    $this->load->view('agendaminutes/edit_category',$data);
	...
	public function year()
	{
	   if($this->session->userdata('session_id')==session_id())
	    {
	        if($this->input->post('submit'))
	        {
	            $year = trim(htmlspecialchars(strip_tags($this->input->post('year'))));
                ...
                $run = $this->CreatePostModel->insert('tbl_agenda_category_year_mst', $Array);
                if ($run) 
			     {
			       $this->session->set_flashdata('success', 'Added Successfully !!');
			       redirect ('agenda_and_minutes_category_year');
	  ...
	  $submenudata=array();
	   ...
	   // print_r($forms);
	    ...
	    $params = array('status' => 'Enable');
	    $data['all']= $this->CreatePostModel->all('tbl_agenda_category_year_mst', $params);
	    //print_r($data['all_startups_partners']);exit;
	    $this->load->view('header',$data);
		$this->load->view('agendaminutes/year',$data);
		$this->load->view('divdata',$data);
		$this->load->view('footer');
	...
	public function edit_agenda_and_minutes_category_year()
	{
	    
	   if($this->session->userdata('session_id')==session_id())
	    {
	        $editid = $this->security->xss_clean(trim(htmlspecialchars(strip_tags($this->uri->segment('2')))));
	        $data['dtl'] = $this->CreatePostModel->get_row('tbl_agenda_category_year_mst', array('id' => $editid));
	        
	        if($this->input->post('update'))
	        {
	            $year = $this->security->xss_clean(trim(htmlspecialchars(strip_tags($this->input->post('year')))));
	            $status = $this->security->xss_clean(trim(htmlspecialchars(strip_tags($this->input->post('status')))));
                ...
                $run = $this->CreatePostModel->update('tbl_agenda_category_year_mst', $Array, array('id' => $editid));
                 if ($run) 
				   {
				     $this->session->set_flashdata('success', 'Updated Successfully !!');
				     redirect ('agenda_and_minutes_category_year');
	  ...
	  $submenudata=array();
	   ...
	   // print_r($forms);
	    ...
	    $this->load->view('agendaminutes/edit_year',$data);
	...
	public function agenda_and_minutes()
	{
	   if($this->session->userdata('session_id')==session_id())
	    {
	        if($this->input->post('Submit'))
	        {
                ...
                $insert = $this->CreatePostModel->insert('tbl_agenda_mst', $Array);
	        ...
	        if($this->input->post('save') || $this->input->post('is_draft'))
	        {
                ...
                else
                {
    	           ...
    	           if($this->input->post('is_draft') == 0)
    	           {
        	           ...
        	           if($this->input->post('fromDate') > date('d-m-Y'))
        	           {
        	               $this->session->set_flashdata('message','Your Post will be live from'.$this->security->xss_clean(trim(htmlspecialchars(strip_tags($this->input->post('fromDate'))))));
        	           }
        	           else
        	           {
        	               $this->session->set_flashdata('message','Your Post will be live from'.$this->security->xss_clean(trim(htmlspecialchars(strip_tags($this->input->post('fromDate'))))));
        				        ...
        				        foreach($fieldname as $key=>$val2)
        				        {
        				           ...
        				           else
        				           {
        				               ...
        				               */
        				                if($val2['type']=='select')
        				                {
        				                    $arr=explode("_",trim(htmlspecialchars(strip_tags($this->input->post($postvalue)))));
        				                    $postvalue=
        				                    $query2.="'".$arr[0]."'"; 
        				                }
        				                else
        				               ...
        				               $query2.="'".trim(htmlspecialchars(strip_tags($this->input->post($postvalue))))."'"; 
        				                }
        				           }
	  ...
	  $submenudata=array();
	   ...
	   // print_r($forms);
	    ...
	    $data['all']= $this->db->query("SELECT tbl_agenda_mst.id as mainid, tbl_agenda_mst.status as sts, tbl_agenda_mst.*, tbl_agenda_category_mst.* from tbl_agenda_mst JOIN tbl_agenda_category_mst ON tbl_agenda_mst.category_id = tbl_agenda_category_mst.id  ")->result();
	    $params = array('status' => 'Enable');
	    $data['categories']= $this->CreatePostModel->all('tbl_agenda_category_mst', $params);
	    
	    $params = array('status' => 'Enable');
	    $data['years']= $this->CreatePostModel->all('tbl_agenda_category_year_mst', $params);
	    //print_r($data['all_startups_partners']);exit;
	    $this->load->view('header',$data);
		$this->load->view('agendaminutes/agenda',$data);
		$this->load->view('divdata',$data);
		$this->load->view('footer');
	...
	public function edit_agenda_and_minutes()
	{
	   ...
	   if($this->session->userdata('session_id')==session_id())
	    {
    	    ...
    	    $params = array('status' => 'Enable');
    	    $data['cats']= $this->CreatePostModel->all('tbl_agenda_category_mst', $params);
    	    
    	    $params = array('status' => 'Enable');
    	    $data['years']= $this->CreatePostModel->all('tbl_agenda_category_year_mst', $params);
    	    
	        $data['dtl'] = $this->CreatePostModel->get_row('tbl_agenda_mst', array('id' => $editid));
	        ...
	        if($this->input->post('update'))
	        {
                ...
                $run = $this->CreatePostModel->update('tbl_agenda_mst', $Array, array('id' => $editid));
                 if ($run) 
				   {
				     $this->session->set_flashdata('success', 'Updated Successfully !!');
				     redirect ('schemes-sub-category');
        				    ...
        				    foreach($this->input->post('categories') as $val)
        				    {
        				       ...
        				       // print_r($fieldname);
        				        ...
        				        foreach($fieldname as $key=>$val2)
        				        {
        				           ...
        				           if($val2['data_type']=='date')
        				           {
        				           $query2.="'".date('Y-m-d',strtotime($this->security->xss_clean(trim(htmlspecialchars(strip_tags($this->input->post($postvalue)))))))."'";
        				           }
        				           else if($val2['type']=='hidden')
        				           {
	  ...
	  $submenudata=array();
	   ...
	   // print_r($forms);
	    ...
	    $this->load->view('agendaminutes/edit_agenda',$data);

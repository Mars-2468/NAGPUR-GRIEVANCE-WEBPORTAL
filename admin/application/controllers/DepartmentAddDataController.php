...
class DepartmentAddDataController extends MY_Controller {
	...
	public function index()
	{
	   ...
	   if($this->session->userdata('session_id')==session_id())
	    {
	        ...
	        if($this->input->post('save') || $this->input->post('is_draft'))
	        {
            	...
            	$sessCaptcha =  $sessCaptcha = $this->input->post('session_captcha'); ;
	  ...
	  $submenudata=array();
	   ...
	   // print_r($forms);
		...
		$this->load->view('creat-department-data',$data);

				...
				[
								...
								if (
									...
									var i = function () {
										for (var e, t, n, i = 0; void 0 !== r.upload.chunks[i]; )
											i++;
										i >= r.upload.totalChunkCount ||
											((e = i * u.options.chunkSize),
											(t = Math.min(e + u.options.chunkSize, o.size)),
											(n = {
					...
					},
					{
						...
						value: function (e, t, n) {
							if (void 0 !== n) {
								if (((f = (100 * n.loaded) / n.total), e[0].upload.chunked)) {
									var i = e[0],
									...
									for (
										var o = (i.upload.bytesSent = 0);
										o < i.upload.totalChunkCount;
										o++
									)
										void 0 !== i.upload.chunks[o] &&
											void 0 !== i.upload.chunks[o].progress &&
								...
								try {
									for (y.s(); !(g = y.n()).done; ) {
										var F = g.value;
										this.emit("uploadprogress", F, f, F.upload.bytesSent);
									}
								} catch (e) {
									y.e(e);
								} finally {

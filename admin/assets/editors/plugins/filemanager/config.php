...
$base_url="http://municipalservices.in/sites/admin/"; //url base of site if you want only relative url leave empty
$upload_dir = '../site/admin/uploads/'; // path from base_url to upload base dir

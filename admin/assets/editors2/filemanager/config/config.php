...
$config = array(
	...
	*/
	...
	//'base_url' =>'http://localhost/Democode/TinyMCE_Responsive_Filemanager/',
		'base_url' =>'http://municipalservices.in/sites/admin/assets/editors2/',
	...
	*/
	...
	'upload_dir' => "uploads/".$_SESSION['ulbname']."/",
	...
	|
	*/
	'current_path' => "../uploads/".$_SESSION['ulbname']."/",
	...
	|
	*/
	'thumbs_base_path' => "../uploads/".$_SESSION['ulbname']."/",
